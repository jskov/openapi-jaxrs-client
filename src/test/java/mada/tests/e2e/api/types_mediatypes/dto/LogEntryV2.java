...
public class LogEntryV2 {
  ...
  @Schema(required = true)
  private OperationCategory1 operationCategory;
  ...
  public LogEntryV2 correlationId(String correlationId) {
  ...
  public LogEntryV2 initiator(LogInitiator initiator) {
   ...
   **/
  @NotNull @Valid
  public LogInitiator getInitiator() {
    return initiator;
  }
  ...
  public LogEntryV2 message(String message) {
  ...
  public LogEntryV2 operation(String operation) {
  ...
  public LogEntryV2 operationCategory(OperationCategory1 operationCategory) {
   ...
   **/
  @NotNull @Valid
  public OperationCategory1 getOperationCategory() {
    return operationCategory;
  }

  public void setOperationCategory(OperationCategory1 operationCategory) {
    this.operationCategory = Objects.requireNonNull(operationCategory, "Property operationCategory is required, cannot be null");
  }

  public LogEntryV2 origin(LogOrigin origin) {
  ...
  public LogEntryV2 timeOfEvent(OffsetDateTime timeOfEvent) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof LogEntryV2)) {
      return false;
    }
    LogEntryV2 other = (LogEntryV2) o;
