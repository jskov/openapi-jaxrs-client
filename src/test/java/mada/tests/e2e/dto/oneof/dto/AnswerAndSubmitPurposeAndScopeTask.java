...
/**
 * A task that will exist if the room has the Purpose and Scope extension and a selected Purpose and Scope which is visible to the customer. Will be completed when the Purpose and Scope state is set to anything else than PENDING_ANSWER. The assignee will always be CUSTOMER. The deadlineDate is calculated from the deadlineDate of the Purpose and Scope. The functionality is PURPOSE_AND_SCOPE.
 */
@JsonbPropertyOrder({
  AnswerAndSubmitPurposeAndScopeTask.JSON_PROPERTY_TYPE,
  AnswerAndSubmitPurposeAndScopeTask.JSON_PROPERTY_ASSIGNEE,
  AnswerAndSubmitPurposeAndScopeTask.JSON_PROPERTY_COMPLETED,
  AnswerAndSubmitPurposeAndScopeTask.JSON_PROPERTY_DEADLINE_DATE,
  AnswerAndSubmitPurposeAndScopeTask.JSON_PROPERTY_FUNCTIONALITY,
  AnswerAndSubmitPurposeAndScopeTask.JSON_PROPERTY_ROOM_ID,
  AnswerAndSubmitPurposeAndScopeTask.JSON_PROPERTY_TASK_ID
})
...
public class AnswerAndSubmitPurposeAndScopeTask {
  ...
  public enum TypeEnum {
    ANSWER_AND_SUBMIT_PURPOSE_AND_SCOPE("ANSWER_AND_SUBMIT_PURPOSE_AND_SCOPE");
  ...
  @JsonbTypeAdapter(mada.tests.e2e.dto.oneof.dto.AnswerAndSubmitPurposeAndScopeTask.TypeEnum.TypeEnumAdapter.class)
  @Schema(required = true)
  private TypeEnum type;

  public AnswerAndSubmitPurposeAndScopeTask assignee(TaskAssignee assignee) {
  ...
  public AnswerAndSubmitPurposeAndScopeTask completed(Boolean completed) {
  ...
  public AnswerAndSubmitPurposeAndScopeTask deadlineDate(LocalDate deadlineDate) {
  ...
  public AnswerAndSubmitPurposeAndScopeTask functionality(TaskFunctionality functionality) {
  ...
  public AnswerAndSubmitPurposeAndScopeTask roomId(UUID roomId) {
  ...
  public AnswerAndSubmitPurposeAndScopeTask taskId(UUID taskId) {
    this.taskId = taskId;
    return this;
  }
  ...
  public AnswerAndSubmitPurposeAndScopeTask type(TypeEnum type) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof AnswerAndSubmitPurposeAndScopeTask)) {
      return false;
    }
    AnswerAndSubmitPurposeAndScopeTask other = (AnswerAndSubmitPurposeAndScopeTask) o;
  ...
  public String toString() {
    ...
    sb.append("class AnswerAndSubmitPurposeAndScopeTask {");
