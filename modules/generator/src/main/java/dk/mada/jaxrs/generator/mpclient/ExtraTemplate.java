...
public enum ExtraTemplate {
    ...
    LOCAL_DATE_JACKSON_DESERIALIZER(
            ...
            Set.of(
                    JavaIo.IO_EXCEPTION,
                    JavaTime.DATE_TIME_FORMATTER,
                    JavaTime.LOCAL_DATE,
                    Jackson.JSON_PARSER,
                    Jackson.DESERIALIZATION_CONTEXT,
                    Jackson.JSON_DESERIALIZER)),
    ...
    LOCAL_DATE_JACKSON_SERIALIZER(
            ...
            Set.of(
                    ...
                    JavaTime.DATE_TIME_FORMATTER,
                    JavaTime.LOCAL_DATE,
                    Jackson.JSON_GENERATOR,
                    Jackson.JSON_PROCESSING_EXCEPTION,
                    Jackson.SERIALIZER_PROVIDER,
                    Jackson.JSON_SERIALIZER)),

    /** LocalDateTime Jackson deserializer template. */
    LOCAL_DATE_TIME_JACKSON_DESERIALIZER(
            "_LocalDateTimeJacksonDeserializer",
            true,
            Set.of(
                    JavaIo.IO_EXCEPTION,
                    JavaTime.DATE_TIME_FORMATTER,
                    JavaTime.LOCAL_DATE_TIME,
                    Jackson.JSON_PARSER,
                    Jackson.JSON_PROCESSING_EXCEPTION,
                    Jackson.DESERIALIZATION_CONTEXT,
                    Jackson.JSON_DESERIALIZER)),
    ...
    LOCAL_DATE_TIME_JACKSON_SERIALIZER(
            "_LocalDateTimeJacksonSerializer",
            false,
            Set.of(
                    JavaIo.IO_EXCEPTION,
                    JavaTime.DATE_TIME_FORMATTER,
    ...
    OFFSET_DATE_TIME_JACKSON_DESERIALIZER(
            ...
            Set.of(
                    JavaIo.IO_EXCEPTION,
                    JavaTime.DATE_TIME_FORMATTER,
                    JavaTime.DATE_TIME_PARSE_EXCEPTION,
                    JavaTime.LOCAL_DATE_TIME,
                    JavaTime.OFFSET_DATE_TIME,
                    JavaTime.ZONE_ID,
                    Jackson.JSON_PARSER,
                    Jackson.DESERIALIZATION_CONTEXT,
                    Jackson.JSON_DESERIALIZER,
