...
public class RestLabelableOrigin {
    ...
    private RestLabelableOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestLabelableOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestLabelableOrigin archived(Boolean archived) {
    ...
    public RestLabelableOrigin defaultBranch(String defaultBranch) {
    ...
    public RestLabelableOrigin description(String description) {
    ...
    public RestLabelableOrigin forkable(Boolean forkable) {
    ...
    public RestLabelableOrigin hierarchyId(String hierarchyId) {
    ...
    public RestLabelableOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestLabelableOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestLabelableOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestLabelableOrigin partition(Integer partition) {
    ...
    public RestLabelableOrigin project(RestLabelableOriginProject project) {
     ...
     **/
    @Valid
    public RestLabelableOriginProject getProject() {
        return project;
    }

    public void setProject(RestLabelableOriginProject project) {
        this.project = project;
    }

    public RestLabelableOrigin public_(Boolean public_) {
    ...
    public RestLabelableOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestLabelableOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestLabelableOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestLabelableOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestLabelableOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestLabelableOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestLabelableOrigin)) {
            return false;
        }
        RestLabelableOrigin other = (RestLabelableOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestLabelableOrigin {");
