...
public class _ResponseGitLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdRebase_401 {
    ...
    public _ResponseGitLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdRebase_401 errors(
            List<RestErrorMessage> errors) {
        this.errors = errors;
        return this;
    }

    public _ResponseGitLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdRebase_401 addErrorsItem(
