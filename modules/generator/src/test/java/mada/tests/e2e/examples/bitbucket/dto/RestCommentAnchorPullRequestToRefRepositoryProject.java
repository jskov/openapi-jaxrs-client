...
public class RestCommentAnchorPullRequestToRefRepositoryProject {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequestToRefRepositoryProject.TypeEnum.TypeEnumAdapter.class)
  @Schema(readOnly = true)
  private TypeEnum type;

  public RestCommentAnchorPullRequestToRefRepositoryProject avatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public RestCommentAnchorPullRequestToRefRepositoryProject avatarUrl(String avatarUrl) {
  ...
  public RestCommentAnchorPullRequestToRefRepositoryProject description(String description) {
  ...
  public RestCommentAnchorPullRequestToRefRepositoryProject id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestCommentAnchorPullRequestToRefRepositoryProject key(String key) {
  ...
  public RestCommentAnchorPullRequestToRefRepositoryProject links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestCommentAnchorPullRequestToRefRepositoryProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCommentAnchorPullRequestToRefRepositoryProject namespace(String namespace) {
  ...
  public RestCommentAnchorPullRequestToRefRepositoryProject public_(Boolean public_) {
  ...
  public RestCommentAnchorPullRequestToRefRepositoryProject scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestCommentAnchorPullRequestToRefRepositoryProject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestCommentAnchorPullRequestToRefRepositoryProject)) {
      return false;
    }
    RestCommentAnchorPullRequestToRefRepositoryProject other = (RestCommentAnchorPullRequestToRefRepositoryProject) o;
  ...
  public String toString() {
    ...
    sb.append("class RestCommentAnchorPullRequestToRefRepositoryProject {");
