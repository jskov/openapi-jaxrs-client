...
public class RestUserRateLimitSettingsUser {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserRateLimitSettingsUser.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestUserRateLimitSettingsUser active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestUserRateLimitSettingsUser avatarUrl(String avatarUrl) {
  ...
  public RestUserRateLimitSettingsUser displayName(String displayName) {
  ...
  public RestUserRateLimitSettingsUser emailAddress(String emailAddress) {
  ...
  public RestUserRateLimitSettingsUser id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestUserRateLimitSettingsUser links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestUserRateLimitSettingsUser name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestUserRateLimitSettingsUser slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestUserRateLimitSettingsUser type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestUserRateLimitSettingsUser)) {
      return false;
    }
    RestUserRateLimitSettingsUser other = (RestUserRateLimitSettingsUser) o;
  ...
  public String toString() {
    ...
    sb.append("class RestUserRateLimitSettingsUser {");
