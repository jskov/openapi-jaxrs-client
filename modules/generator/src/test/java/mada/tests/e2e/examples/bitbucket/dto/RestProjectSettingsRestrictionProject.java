...
public class RestProjectSettingsRestrictionProject {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestProjectSettingsRestrictionProject.TypeEnum.TypeEnumAdapter.class)
  @Schema(readOnly = true)
  private TypeEnum type;

  public RestProjectSettingsRestrictionProject avatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public RestProjectSettingsRestrictionProject avatarUrl(String avatarUrl) {
  ...
  public RestProjectSettingsRestrictionProject description(String description) {
  ...
  public RestProjectSettingsRestrictionProject id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestProjectSettingsRestrictionProject key(String key) {
  ...
  public RestProjectSettingsRestrictionProject links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestProjectSettingsRestrictionProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestProjectSettingsRestrictionProject namespace(String namespace) {
  ...
  public RestProjectSettingsRestrictionProject public_(Boolean public_) {
  ...
  public RestProjectSettingsRestrictionProject scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestProjectSettingsRestrictionProject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestProjectSettingsRestrictionProject)) {
      return false;
    }
    RestProjectSettingsRestrictionProject other = (RestProjectSettingsRestrictionProject) o;
  ...
  public String toString() {
    ...
    sb.append("class RestProjectSettingsRestrictionProject {");
