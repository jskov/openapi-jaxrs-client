...
public class RestPullRequestConditionScope {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestConditionScope.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestPullRequestConditionScope resourceId(Integer resourceId) {
    ...
    public RestPullRequestConditionScope type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestConditionScope {");
