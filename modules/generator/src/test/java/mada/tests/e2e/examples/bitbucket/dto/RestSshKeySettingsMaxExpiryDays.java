...
/**
 * RestSshKeySettingsMaxExpiryDays
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class RestSshKeySettingsMaxExpiryDays {
    ...
    public RestSshKeySettingsMaxExpiryDays asInt(Integer asInt) {
        this.asInt = asInt;
        return this;
    }
    ...
    public RestSshKeySettingsMaxExpiryDays present(Boolean present) {
    ...
    public String toString() {
        ...
        sb.append("class RestSshKeySettingsMaxExpiryDays {");
