...
public class RestMigrationRepositoryRepository {
  ...
  @Schema(readOnly = true)
  private RestMigrationRepositoryRepositoryOrigin origin;
  ...
  private RestMigrationRepositoryRepositoryProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestMigrationRepositoryRepository.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestMigrationRepositoryRepository archived(Boolean archived) {
  ...
  public RestMigrationRepositoryRepository defaultBranch(String defaultBranch) {
  ...
  public RestMigrationRepositoryRepository description(String description) {
  ...
  public RestMigrationRepositoryRepository forkable(Boolean forkable) {
  ...
  public RestMigrationRepositoryRepository hierarchyId(String hierarchyId) {
  ...
  public RestMigrationRepositoryRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestMigrationRepositoryRepository links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestMigrationRepositoryRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestMigrationRepositoryRepository origin(RestMigrationRepositoryRepositoryOrigin origin) {
    this.origin = origin;
    return this;
  }
   ...
   **/
  @Valid
  public RestMigrationRepositoryRepositoryOrigin getOrigin() {
    return origin;
  }

  public void setOrigin(RestMigrationRepositoryRepositoryOrigin origin) {
    this.origin = origin;
  }

  public RestMigrationRepositoryRepository partition(Integer partition) {
  ...
  public RestMigrationRepositoryRepository project(RestMigrationRepositoryRepositoryProject project) {
   ...
   **/
  @Valid
  public RestMigrationRepositoryRepositoryProject getProject() {
    return project;
  }

  public void setProject(RestMigrationRepositoryRepositoryProject project) {
    this.project = project;
  }

  public RestMigrationRepositoryRepository public_(Boolean public_) {
  ...
  public RestMigrationRepositoryRepository relatedLinks(Object relatedLinks) {
  ...
  public RestMigrationRepositoryRepository scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestMigrationRepositoryRepository scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestMigrationRepositoryRepository slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestMigrationRepositoryRepository state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestMigrationRepositoryRepository statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestMigrationRepositoryRepository)) {
      return false;
    }
    RestMigrationRepositoryRepository other = (RestMigrationRepositoryRepository) o;
  ...
  public String toString() {
    ...
    sb.append("class RestMigrationRepositoryRepository {");
