...
public class RestChangesetToCommit {
    public static final String JSON_PROPERTY_AUTHOR = "author";
    @JsonbProperty(JSON_PROPERTY_AUTHOR)
    private RestChangesetToCommitAuthor author;
    ...
    public RestChangesetToCommit author(RestChangesetToCommitAuthor author) {
        this.author = author;
        return this;
    }
     ...
     * @return author
     **/
    public @Valid RestChangesetToCommitAuthor getAuthor() {
        return author;
    }

    public void setAuthor(RestChangesetToCommitAuthor author) {
        this.author = author;
    }

    public RestChangesetToCommit authorTimestamp(Long authorTimestamp) {
    ...
    public RestChangesetToCommit committer(RestChangesetToCommitCommitter committer) {
     ...
     * @return committer
     **/
    public @Valid RestChangesetToCommitCommitter getCommitter() {
        return committer;
    }

    public void setCommitter(RestChangesetToCommitCommitter committer) {
        this.committer = committer;
    }

    public RestChangesetToCommit committerTimestamp(Long committerTimestamp) {
    ...
    public RestChangesetToCommit displayId(String displayId) {
    ...
    public RestChangesetToCommit id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestChangesetToCommit message(String message) {
    ...
    public RestChangesetToCommit parents(List<RestMinimalCommit> parents) {
