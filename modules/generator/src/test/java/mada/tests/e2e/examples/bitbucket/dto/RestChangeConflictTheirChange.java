...
public class RestChangeConflictTheirChange {
   ...
   **/
  @Valid
  public RestChangeConflictTheirChangePath getPath() {
    return path;
  }
   ...
   **/
  @Valid
  public RestChangeConflictTheirChangeSrcPath getSrcPath() {
    return srcPath;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof RestChangeConflictTheirChange other) {
