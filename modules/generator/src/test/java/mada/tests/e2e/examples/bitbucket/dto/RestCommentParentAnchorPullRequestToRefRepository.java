...
public class RestCommentParentAnchorPullRequestToRefRepository {
    ...
    @Schema(readOnly = true)
    private RestCommentParentAnchorPullRequestToRefRepositoryOrigin origin;
    ...
    private RestCommentParentAnchorPullRequestToRefRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentAnchorPullRequestToRefRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestCommentParentAnchorPullRequestToRefRepository archived(Boolean archived) {
    ...
    public RestCommentParentAnchorPullRequestToRefRepository defaultBranch(String defaultBranch) {
    ...
    public RestCommentParentAnchorPullRequestToRefRepository description(String description) {
    ...
    public RestCommentParentAnchorPullRequestToRefRepository forkable(Boolean forkable) {
    ...
    public RestCommentParentAnchorPullRequestToRefRepository hierarchyId(String hierarchyId) {
    ...
    public RestCommentParentAnchorPullRequestToRefRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestToRefRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestToRefRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestToRefRepository origin(RestCommentParentAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    public @Valid RestCommentParentAnchorPullRequestToRefRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestCommentParentAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestCommentParentAnchorPullRequestToRefRepository partition(Integer partition) {
    ...
    public RestCommentParentAnchorPullRequestToRefRepository project(RestCommentParentAnchorPullRequestToRefRepositoryProject project) {
     ...
     * @return project
     **/
    public @Valid RestCommentParentAnchorPullRequestToRefRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestCommentParentAnchorPullRequestToRefRepositoryProject project) {
        this.project = project;
    }

    public RestCommentParentAnchorPullRequestToRefRepository public_(Boolean public_) {
    ...
    public RestCommentParentAnchorPullRequestToRefRepository relatedLinks(Object relatedLinks) {
    ...
    public RestCommentParentAnchorPullRequestToRefRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestToRefRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestToRefRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestToRefRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestToRefRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentParentAnchorPullRequestToRefRepository)) {
            return false;
        }
        RestCommentParentAnchorPullRequestToRefRepository other = (RestCommentParentAnchorPullRequestToRefRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentParentAnchorPullRequestToRefRepository {");
