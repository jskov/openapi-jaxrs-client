...
public class RestRepositoryRefChangeActivityUser {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRepositoryRefChangeActivityUser.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestRepositoryRefChangeActivityUser active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityUser avatarUrl(String avatarUrl) {
    ...
    public RestRepositoryRefChangeActivityUser displayName(String displayName) {
    ...
    public RestRepositoryRefChangeActivityUser emailAddress(String emailAddress) {
    ...
    public RestRepositoryRefChangeActivityUser id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityUser links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityUser name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityUser slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityUser type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestRepositoryRefChangeActivityUser)) {
            return false;
        }
        RestRepositoryRefChangeActivityUser other = (RestRepositoryRefChangeActivityUser) o;
    ...
    public String toString() {
        ...
        sb.append("class RestRepositoryRefChangeActivityUser {");
