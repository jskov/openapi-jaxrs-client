...
/**
 * _ResponseApiLatestMigrationMeshSummary_401
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestMigrationMeshSummary_401 {
    public static final String JSON_PROPERTY_ERRORS = "errors";
    @JsonbProperty(JSON_PROPERTY_ERRORS)
    private List<RestErrorMessage> errors;

    public _ResponseApiLatestMigrationMeshSummary_401 errors(List<RestErrorMessage> errors) {
        this.errors = errors;
        return this;
    }

    public _ResponseApiLatestMigrationMeshSummary_401 addErrorsItem(RestErrorMessage errorsItem) {
        if (this.errors == null) {
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestMigrationMeshSummary_401 {");
