...
public class _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdAnnotations_404 {
    ...
    public _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdAnnotations_404 errors(
            List<RestErrorMessage> errors) {
        this.errors = errors;
        return this;
    }

    public _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdAnnotations_404 addErrorsItem(
