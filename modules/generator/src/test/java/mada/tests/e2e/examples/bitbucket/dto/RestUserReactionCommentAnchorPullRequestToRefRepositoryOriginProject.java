...
public class RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
  @Schema(readOnly = true)
  private TypeEnum type;

  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject avatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject avatarUrl(String avatarUrl) {
  ...
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject description(String description) {
  ...
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject key(String key) {
  ...
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject namespace(String namespace) {
  ...
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject public_(Boolean public_) {
  ...
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject)) {
      return false;
    }
    RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject other = (RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject) o;
  ...
  public String toString() {
    ...
    sb.append("class RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject {");
