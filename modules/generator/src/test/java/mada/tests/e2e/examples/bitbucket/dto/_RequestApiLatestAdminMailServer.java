...
/**
 * _RequestApiLatestAdminMailServer
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _RequestApiLatestAdminMailServer {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto._RequestApiLatestAdminMailServer.ProtocolEnum.ProtocolEnumAdapter.class)
  ...
  public _RequestApiLatestAdminMailServer hostname(String hostname) {
  ...
  public _RequestApiLatestAdminMailServer password(String password) {
  ...
  public _RequestApiLatestAdminMailServer port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public _RequestApiLatestAdminMailServer protocol(ProtocolEnum protocol) {
  ...
  public _RequestApiLatestAdminMailServer requireStartTls(Boolean requireStartTls) {
  ...
  public _RequestApiLatestAdminMailServer senderAddress(String senderAddress) {
  ...
  public _RequestApiLatestAdminMailServer username(String username) {
  ...
  public _RequestApiLatestAdminMailServer useStartTls(Boolean useStartTls) {
  ...
  public String toString() {
    ...
    sb.append("class _RequestApiLatestAdminMailServer {");
