...
public class RestRefSyncStatusDivergedRefs {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRefSyncStatusDivergedRefs.StateEnum.StateEnumAdapter.class)
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRefSyncStatusDivergedRefs.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestRefSyncStatusDivergedRefs displayId(String displayId) {
    ...
    public RestRefSyncStatusDivergedRefs id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestRefSyncStatusDivergedRefs state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestRefSyncStatusDivergedRefs tag(Boolean tag) {
        this.tag = tag;
        return this;
    }
    ...
    public RestRefSyncStatusDivergedRefs type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestRefSyncStatusDivergedRefs)) {
            return false;
        }
        RestRefSyncStatusDivergedRefs other = (RestRefSyncStatusDivergedRefs) o;
    ...
    public String toString() {
        ...
        sb.append("class RestRefSyncStatusDivergedRefs {");
