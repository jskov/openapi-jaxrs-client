...
/**
 * _ResponseApiLatestAdminUsers
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestAdminUsers {
    ...
    public _ResponseApiLatestAdminUsers isLastPage(Boolean isLastPage) {
    ...
    public _ResponseApiLatestAdminUsers limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestAdminUsers nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseApiLatestAdminUsers size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestAdminUsers start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseApiLatestAdminUsers values(List<RestDetailedUser> values) {
        this.values = values;
        return this;
    }

    public _ResponseApiLatestAdminUsers addValuesItem(RestDetailedUser valuesItem) {
        if (this.values == null) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseApiLatestAdminUsers)) {
            return false;
        }
        _ResponseApiLatestAdminUsers other = (_ResponseApiLatestAdminUsers) o;
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestAdminUsers {");
