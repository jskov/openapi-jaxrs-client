...
public class RestMeshMigrationRequest {
  ...
  private RestMeshMigrationRequestMaxBytesPerSecond maxBytesPerSecond;
  ...
  public RestMeshMigrationRequest all(Boolean all) {
    this.all = all;
    return this;
  }
  ...
  public RestMeshMigrationRequest maxBytesPerSecond(RestMeshMigrationRequestMaxBytesPerSecond maxBytesPerSecond) {
   ...
   **/
  @Valid
  public RestMeshMigrationRequestMaxBytesPerSecond getMaxBytesPerSecond() {
    return maxBytesPerSecond;
  }

  public void setMaxBytesPerSecond(RestMeshMigrationRequestMaxBytesPerSecond maxBytesPerSecond) {
    this.maxBytesPerSecond = maxBytesPerSecond;
  }

  public RestMeshMigrationRequest projectIds(Set<Integer> projectIds) {
    this.projectIds = projectIds;
    return this;
  }

  public RestMeshMigrationRequest addProjectIdsItem(int projectIdsItem) {
  ...
  public RestMeshMigrationRequest repositoryIds(Set<Integer> repositoryIds) {
    this.repositoryIds = repositoryIds;
    return this;
  }

  public RestMeshMigrationRequest addRepositoryIdsItem(int repositoryIdsItem) {
