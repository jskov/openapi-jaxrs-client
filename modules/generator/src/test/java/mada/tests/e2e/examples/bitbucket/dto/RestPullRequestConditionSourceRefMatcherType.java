...
public class RestPullRequestConditionSourceRefMatcherType {
    public enum IdEnum {
      ANY_REF("ANY_REF"),
      BRANCH("BRANCH"),
      PATTERN("PATTERN"),
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestConditionSourceRefMatcherType.IdEnum.IdEnumAdapter.class)
    private IdEnum id;
    ...
    public RestPullRequestConditionSourceRefMatcherType id(IdEnum id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestConditionSourceRefMatcherType name(String name) {
        this.name = name;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestConditionSourceRefMatcherType {");
