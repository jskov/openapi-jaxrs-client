...
@JsonbPropertyOrder({
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_CREATED,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_AUTHORS,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_URL,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_DOCUMENTATION,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_SOURCE,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_VERSION,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_REVISION,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_VENDOR,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_LICENSES,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_REF_NAME,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_TITLE,
  Annotations.JSON_PROPERTY_ORG_OPENCONTAINERS_IMAGE_DESCRIPTION
})
...
public class Annotations {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.org_opencontainers_image_created, other.org_opencontainers_image_created) &&
        Objects.equals(this.org_opencontainers_image_authors, other.org_opencontainers_image_authors) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(org_opencontainers_image_created, org_opencontainers_image_authors, org_opencontainers_image_url, org_opencontainers_image_documentation, org_opencontainers_image_source, org_opencontainers_image_version, org_opencontainers_image_revision, org_opencontainers_image_vendor, org_opencontainers_image_licenses, org_opencontainers_image_ref_name, org_opencontainers_image_title, org_opencontainers_image_description);
  }
