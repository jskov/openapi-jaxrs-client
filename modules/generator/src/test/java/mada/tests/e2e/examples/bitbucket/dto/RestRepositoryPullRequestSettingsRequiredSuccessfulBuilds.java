...
public class RestRepositoryPullRequestSettingsRequiredSuccessfulBuilds {
    ...
    public RestRepositoryPullRequestSettingsRequiredSuccessfulBuilds count(String count) {
        this.count = count;
        return this;
    }
    ...
    public RestRepositoryPullRequestSettingsRequiredSuccessfulBuilds enabled(Boolean enabled) {
    ...
    public String toString() {
        ...
        sb.append("class RestRepositoryPullRequestSettingsRequiredSuccessfulBuilds {");
