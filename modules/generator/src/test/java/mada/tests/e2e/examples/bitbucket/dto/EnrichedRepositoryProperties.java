...
public class EnrichedRepositoryProperties {
  ...
  public EnrichedRepositoryProperties contentHash(String contentHash) {
  ...
  public EnrichedRepositoryProperties defaultBranchId(String defaultBranchId) {
  ...
  public EnrichedRepositoryProperties metadataHash(String metadataHash) {
