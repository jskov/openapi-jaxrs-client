...
public class RestUserReactionCommentAnchorPullRequest {
    ...
    private RestUserReactionCommentAnchorPullRequestFromRef fromRef;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAnchorPullRequest.StateEnum.StateEnumAdapter.class)
    ...
    private RestUserReactionCommentAnchorPullRequestToRef toRef;
    ...
    public RestUserReactionCommentAnchorPullRequest closed(Boolean closed) {
        this.closed = closed;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequest closedDate(Long closedDate) {
    ...
    public RestUserReactionCommentAnchorPullRequest createdDate(Long createdDate) {
    ...
    public RestUserReactionCommentAnchorPullRequest description(String description) {
    ...
    public RestUserReactionCommentAnchorPullRequest draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequest fromRef(RestUserReactionCommentAnchorPullRequestFromRef fromRef) {
     ...
     * @return fromRef
     **/
    public @Valid RestUserReactionCommentAnchorPullRequestFromRef getFromRef() {
        return fromRef;
    }

    public void setFromRef(RestUserReactionCommentAnchorPullRequestFromRef fromRef) {
        this.fromRef = fromRef;
    }

    public RestUserReactionCommentAnchorPullRequest htmlDescription(String htmlDescription) {
    ...
    public RestUserReactionCommentAnchorPullRequest id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequest links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequest locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequest open(Boolean open) {
        this.open = open;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequest participants(List<RestPullRequestParticipant> participants) {
        this.participants = participants;
        return this;
    }

    public RestUserReactionCommentAnchorPullRequest addParticipantsItem(RestPullRequestParticipant participantsItem) {
    ...
    public RestUserReactionCommentAnchorPullRequest reviewers(List<RestPullRequestParticipant> reviewers) {
        this.reviewers = reviewers;
        return this;
    }

    public RestUserReactionCommentAnchorPullRequest addReviewersItem(RestPullRequestParticipant reviewersItem) {
    ...
    public RestUserReactionCommentAnchorPullRequest state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequest title(String title) {
        this.title = title;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequest toRef(RestUserReactionCommentAnchorPullRequestToRef toRef) {
        this.toRef = toRef;
        return this;
    }
     ...
     * @return toRef
     **/
    public @Valid RestUserReactionCommentAnchorPullRequestToRef getToRef() {
        return toRef;
    }

    public void setToRef(RestUserReactionCommentAnchorPullRequestToRef toRef) {
        this.toRef = toRef;
    }

    public RestUserReactionCommentAnchorPullRequest updatedDate(Long updatedDate) {
    ...
    public RestUserReactionCommentAnchorPullRequest version(Integer version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentAnchorPullRequest)) {
            return false;
        }
        RestUserReactionCommentAnchorPullRequest other = (RestUserReactionCommentAnchorPullRequest) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentAnchorPullRequest {");
