...
public class RestRejectedRef {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRejectedRef.StateEnum.StateEnumAdapter.class)
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRejectedRef.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestRejectedRef displayId(String displayId) {
  ...
  public RestRejectedRef id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestRejectedRef state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestRejectedRef tag(Boolean tag) {
    this.tag = tag;
    return this;
  }
  ...
  public RestRejectedRef type(TypeEnum type) {
    this.type = type;
    return this;
  }
