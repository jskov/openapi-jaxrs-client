...
public class RestRepositoryRefChangeActivityRepositoryOriginProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRepositoryRefChangeActivityRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestRepositoryRefChangeActivityRepositoryOriginProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityRepositoryOriginProject avatarUrl(String avatarUrl) {
    ...
    public RestRepositoryRefChangeActivityRepositoryOriginProject description(String description) {
    ...
    public RestRepositoryRefChangeActivityRepositoryOriginProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityRepositoryOriginProject key(String key) {
    ...
    public RestRepositoryRefChangeActivityRepositoryOriginProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityRepositoryOriginProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityRepositoryOriginProject namespace(String namespace) {
    ...
    public RestRepositoryRefChangeActivityRepositoryOriginProject public_(Boolean public_) {
    ...
    public RestRepositoryRefChangeActivityRepositoryOriginProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityRepositoryOriginProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestRepositoryRefChangeActivityRepositoryOriginProject)) {
            return false;
        }
        RestRepositoryRefChangeActivityRepositoryOriginProject other = (RestRepositoryRefChangeActivityRepositoryOriginProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestRepositoryRefChangeActivityRepositoryOriginProject {");
