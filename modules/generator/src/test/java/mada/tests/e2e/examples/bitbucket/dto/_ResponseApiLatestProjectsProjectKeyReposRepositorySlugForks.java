...
/**
 * _ResponseApiLatestProjectsProjectKeyReposRepositorySlugForks
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestProjectsProjectKeyReposRepositorySlugForks {
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugForks isLastPage(Boolean isLastPage) {
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugForks limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugForks nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugForks size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugForks start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugForks values(List<RestRepository> values) {
        this.values = values;
        return this;
    }

    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugForks addValuesItem(RestRepository valuesItem) {
        if (this.values == null) {
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestProjectsProjectKeyReposRepositorySlugForks {");
