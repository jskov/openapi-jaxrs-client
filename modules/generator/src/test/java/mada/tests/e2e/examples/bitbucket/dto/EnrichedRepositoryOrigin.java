...
public class EnrichedRepositoryOrigin {
  ...
  private EnrichedRepositoryOriginProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.EnrichedRepositoryOrigin.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public EnrichedRepositoryOrigin archived(Boolean archived) {
  ...
  public EnrichedRepositoryOrigin defaultBranch(String defaultBranch) {
  ...
  public EnrichedRepositoryOrigin description(String description) {
  ...
  public EnrichedRepositoryOrigin forkable(Boolean forkable) {
  ...
  public EnrichedRepositoryOrigin hierarchyId(String hierarchyId) {
  ...
  public EnrichedRepositoryOrigin id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public EnrichedRepositoryOrigin links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public EnrichedRepositoryOrigin name(String name) {
    this.name = name;
    return this;
  }
  ...
  public EnrichedRepositoryOrigin partition(Integer partition) {
  ...
  public EnrichedRepositoryOrigin project(EnrichedRepositoryOriginProject project) {
   ...
   **/
  @Valid
  public EnrichedRepositoryOriginProject getProject() {
    return project;
  }

  public void setProject(EnrichedRepositoryOriginProject project) {
    this.project = project;
  }

  public EnrichedRepositoryOrigin public_(Boolean public_) {
  ...
  public EnrichedRepositoryOrigin relatedLinks(Object relatedLinks) {
  ...
  public EnrichedRepositoryOrigin scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public EnrichedRepositoryOrigin scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public EnrichedRepositoryOrigin slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public EnrichedRepositoryOrigin state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public EnrichedRepositoryOrigin statusMessage(String statusMessage) {
  ...
  public String toString() {
    ...
    sb.append("class EnrichedRepositoryOrigin {");
