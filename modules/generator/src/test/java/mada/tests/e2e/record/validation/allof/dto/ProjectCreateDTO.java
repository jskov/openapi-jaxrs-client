...
public record ProjectCreateDTO(
        @JsonbProperty("cluster") @Schema(required = true) @NotNull @Size(min = 1, max = 10) String cluster,

        @JsonbProperty("description") @Schema(required = true) @NotNull @Size(min = 1, max = 300) String description,

        @JsonbProperty("display-name") @Schema(required = true) @NotNull @Size(min = 1, max = 100) String displayName,

        @JsonbProperty("name") @Schema(required = true) @NotNull @Size(min = 1, max = 100) String name,

        @JsonbProperty("owner") @Schema(required = true) @NotNull @Valid OwnerDTO owner,

        @JsonbProperty("product-owner") @Schema(required = true) @NotNull @Valid ProductOwnerDTO productOwner,

        @JsonbProperty("type") @Schema(required = true) @NotNull @Valid ProjectType type) {
