...
public class RestUserReactionCommentParentAnchorPullRequestToRefRepository {
    ...
    @Schema(readOnly = true)
    private RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin origin;
    ...
    private RestUserReactionCommentParentAnchorPullRequestToRefRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentParentAnchorPullRequestToRefRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository archived(Boolean archived) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository defaultBranch(String defaultBranch) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository description(String description) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository forkable(Boolean forkable) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository hierarchyId(String hierarchyId) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository origin(RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    public @Valid RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestUserReactionCommentParentAnchorPullRequestToRefRepository partition(Integer partition) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository project(RestUserReactionCommentParentAnchorPullRequestToRefRepositoryProject project) {
     ...
     * @return project
     **/
    public @Valid RestUserReactionCommentParentAnchorPullRequestToRefRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestUserReactionCommentParentAnchorPullRequestToRefRepositoryProject project) {
        this.project = project;
    }

    public RestUserReactionCommentParentAnchorPullRequestToRefRepository public_(Boolean public_) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository relatedLinks(Object relatedLinks) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentParentAnchorPullRequestToRefRepository)) {
            return false;
        }
        RestUserReactionCommentParentAnchorPullRequestToRefRepository other = (RestUserReactionCommentParentAnchorPullRequestToRefRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentParentAnchorPullRequestToRefRepository {");
