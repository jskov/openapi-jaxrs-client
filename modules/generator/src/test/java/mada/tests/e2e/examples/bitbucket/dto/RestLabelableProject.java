...
public class RestLabelableProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestLabelableProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestLabelableProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestLabelableProject avatarUrl(String avatarUrl) {
    ...
    public RestLabelableProject description(String description) {
    ...
    public RestLabelableProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestLabelableProject key(String key) {
    ...
    public RestLabelableProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestLabelableProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestLabelableProject namespace(String namespace) {
    ...
    public RestLabelableProject public_(Boolean public_) {
    ...
    public RestLabelableProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestLabelableProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestLabelableProject)) {
            return false;
        }
        RestLabelableProject other = (RestLabelableProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestLabelableProject {");
