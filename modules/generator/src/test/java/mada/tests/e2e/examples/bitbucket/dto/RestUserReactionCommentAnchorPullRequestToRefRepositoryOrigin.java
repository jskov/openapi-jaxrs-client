...
public class RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin {
    ...
    private RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin description(String description) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin project(RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    @Valid public RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestUserReactionCommentAnchorPullRequestToRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin)) {
            return false;
        }
        RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin other = (RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin {");
