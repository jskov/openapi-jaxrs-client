...
/**
 * _ResponseCommentLikesLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentIdLikes_401
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseCommentLikesLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentIdLikes_401 {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseCommentLikesLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentIdLikes_401)) {
            return false;
        }
        _ResponseCommentLikesLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentIdLikes_401 other = (_ResponseCommentLikesLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentIdLikes_401) o;
