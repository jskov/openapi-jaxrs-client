...
/**
 * _ResponseApiLatestAdminGroups
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestAdminGroups {
    ...
    public _ResponseApiLatestAdminGroups isLastPage(Boolean isLastPage) {
    ...
    public _ResponseApiLatestAdminGroups limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestAdminGroups nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseApiLatestAdminGroups size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestAdminGroups start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseApiLatestAdminGroups values(List<RestDetailedGroup> values) {
        this.values = values;
        return this;
    }

    public _ResponseApiLatestAdminGroups addValuesItem(RestDetailedGroup valuesItem) {
        if (this.values == null) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseApiLatestAdminGroups)) {
            return false;
        }
        _ResponseApiLatestAdminGroups other = (_ResponseApiLatestAdminGroups) o;
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestAdminGroups {");
