...
public class RestPullRequestMergeRequest {
  ...
  public RestPullRequestMergeRequest autoMerge(Boolean autoMerge) {
  ...
  public RestPullRequestMergeRequest autoSubject(String autoSubject) {
  ...
  public RestPullRequestMergeRequest message(String message) {
  ...
  public RestPullRequestMergeRequest strategyId(String strategyId) {
  ...
  public RestPullRequestMergeRequest version(Integer version) {
  ...
  public String toString() {
    ...
    sb.append("class RestPullRequestMergeRequest {");
