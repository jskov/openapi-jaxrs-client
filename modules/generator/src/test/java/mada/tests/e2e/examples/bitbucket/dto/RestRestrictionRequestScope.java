...
public class RestRestrictionRequestScope {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRestrictionRequestScope.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestRestrictionRequestScope resourceId(Integer resourceId) {
    ...
    public RestRestrictionRequestScope type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestRestrictionRequestScope)) {
            return false;
        }
        RestRestrictionRequestScope other = (RestRestrictionRequestScope) o;
    ...
    public String toString() {
        ...
        sb.append("class RestRestrictionRequestScope {");
