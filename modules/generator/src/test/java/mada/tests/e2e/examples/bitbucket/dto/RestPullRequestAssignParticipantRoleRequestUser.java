...
public class RestPullRequestAssignParticipantRoleRequestUser {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestAssignParticipantRoleRequestUser.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestPullRequestAssignParticipantRoleRequestUser active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public RestPullRequestAssignParticipantRoleRequestUser avatarUrl(String avatarUrl) {
    ...
    public RestPullRequestAssignParticipantRoleRequestUser displayName(String displayName) {
    ...
    public RestPullRequestAssignParticipantRoleRequestUser emailAddress(String emailAddress) {
    ...
    public RestPullRequestAssignParticipantRoleRequestUser id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestAssignParticipantRoleRequestUser links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestAssignParticipantRoleRequestUser name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestAssignParticipantRoleRequestUser slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestPullRequestAssignParticipantRoleRequestUser type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestAssignParticipantRoleRequestUser)) {
            return false;
        }
        RestPullRequestAssignParticipantRoleRequestUser other = (RestPullRequestAssignParticipantRoleRequestUser) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestAssignParticipantRoleRequestUser {");
