...
public interface DashboardApi {
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestDashboardPullRequestSuggestions.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestDashboardPullRequestSuggestions_400.class))),
            @APIResponse(
                    responseCode = "401",
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A page of pull requests that match the search criteria.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestDashboardPullRequests.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestDashboardPullRequests_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The current user is not authenticated",
                    content = @Content(
