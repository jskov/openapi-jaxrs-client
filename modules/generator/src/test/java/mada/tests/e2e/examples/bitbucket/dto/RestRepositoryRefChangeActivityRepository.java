...
public class RestRepositoryRefChangeActivityRepository {
  ...
  @Schema(readOnly = true)
  private RestRepositoryRefChangeActivityRepositoryOrigin origin;
  ...
  private RestRepositoryRefChangeActivityRepositoryProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRepositoryRefChangeActivityRepository.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestRepositoryRefChangeActivityRepository archived(Boolean archived) {
  ...
  public RestRepositoryRefChangeActivityRepository defaultBranch(String defaultBranch) {
  ...
  public RestRepositoryRefChangeActivityRepository description(String description) {
  ...
  public RestRepositoryRefChangeActivityRepository forkable(Boolean forkable) {
  ...
  public RestRepositoryRefChangeActivityRepository hierarchyId(String hierarchyId) {
  ...
  public RestRepositoryRefChangeActivityRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepository links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepository origin(RestRepositoryRefChangeActivityRepositoryOrigin origin) {
    this.origin = origin;
    return this;
  }
   ...
   **/
  @Valid
  public RestRepositoryRefChangeActivityRepositoryOrigin getOrigin() {
    return origin;
  }

  public void setOrigin(RestRepositoryRefChangeActivityRepositoryOrigin origin) {
    this.origin = origin;
  }

  public RestRepositoryRefChangeActivityRepository partition(Integer partition) {
  ...
  public RestRepositoryRefChangeActivityRepository project(RestRepositoryRefChangeActivityRepositoryProject project) {
   ...
   **/
  @Valid
  public RestRepositoryRefChangeActivityRepositoryProject getProject() {
    return project;
  }

  public void setProject(RestRepositoryRefChangeActivityRepositoryProject project) {
    this.project = project;
  }

  public RestRepositoryRefChangeActivityRepository public_(Boolean public_) {
  ...
  public RestRepositoryRefChangeActivityRepository relatedLinks(Object relatedLinks) {
  ...
  public RestRepositoryRefChangeActivityRepository scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepository scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepository slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepository state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepository statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestRepositoryRefChangeActivityRepository)) {
      return false;
    }
    RestRepositoryRefChangeActivityRepository other = (RestRepositoryRefChangeActivityRepository) o;
  ...
  public String toString() {
    ...
    sb.append("class RestRepositoryRefChangeActivityRepository {");
