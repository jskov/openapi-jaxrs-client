...
public class RestDeploymentRepository {
  ...
  @Schema(readOnly = true)
  private RestDeploymentRepositoryOrigin origin;
  ...
  private RestDeploymentRepositoryProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestDeploymentRepository.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestDeploymentRepository archived(Boolean archived) {
  ...
  public RestDeploymentRepository defaultBranch(String defaultBranch) {
  ...
  public RestDeploymentRepository description(String description) {
  ...
  public RestDeploymentRepository forkable(Boolean forkable) {
  ...
  public RestDeploymentRepository hierarchyId(String hierarchyId) {
  ...
  public RestDeploymentRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestDeploymentRepository links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestDeploymentRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestDeploymentRepository origin(RestDeploymentRepositoryOrigin origin) {
    this.origin = origin;
    return this;
  }
   ...
   **/
  @Valid
  public RestDeploymentRepositoryOrigin getOrigin() {
    return origin;
  }

  public void setOrigin(RestDeploymentRepositoryOrigin origin) {
    this.origin = origin;
  }

  public RestDeploymentRepository partition(Integer partition) {
  ...
  public RestDeploymentRepository project(RestDeploymentRepositoryProject project) {
   ...
   **/
  @Valid
  public RestDeploymentRepositoryProject getProject() {
    return project;
  }

  public void setProject(RestDeploymentRepositoryProject project) {
    this.project = project;
  }

  public RestDeploymentRepository public_(Boolean public_) {
  ...
  public RestDeploymentRepository relatedLinks(Object relatedLinks) {
  ...
  public RestDeploymentRepository scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestDeploymentRepository scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestDeploymentRepository slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestDeploymentRepository state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestDeploymentRepository statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestDeploymentRepository)) {
      return false;
    }
    RestDeploymentRepository other = (RestDeploymentRepository) o;
  ...
  public String toString() {
    ...
    sb.append("class RestDeploymentRepository {");
