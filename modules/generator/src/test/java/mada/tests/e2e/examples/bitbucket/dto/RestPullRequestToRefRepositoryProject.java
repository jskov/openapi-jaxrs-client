...
public class RestPullRequestToRefRepositoryProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestToRefRepositoryProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestPullRequestToRefRepositoryProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryProject avatarUrl(String avatarUrl) {
    ...
    public RestPullRequestToRefRepositoryProject description(String description) {
    ...
    public RestPullRequestToRefRepositoryProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryProject key(String key) {
    ...
    public RestPullRequestToRefRepositoryProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryProject namespace(String namespace) {
    ...
    public RestPullRequestToRefRepositoryProject public_(Boolean public_) {
    ...
    public RestPullRequestToRefRepositoryProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestToRefRepositoryProject)) {
            return false;
        }
        RestPullRequestToRefRepositoryProject other = (RestPullRequestToRefRepositoryProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestToRefRepositoryProject {");
