...
/**
 * _ResponseApiLatestSecretScanningRules_400
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestSecretScanningRules_400 {
    public static final String JSON_PROPERTY_ERRORS = "errors";
    @JsonbProperty(JSON_PROPERTY_ERRORS)
    private List<RestErrorMessage> errors;

    public _ResponseApiLatestSecretScanningRules_400 errors(List<RestErrorMessage> errors) {
        this.errors = errors;
        return this;
    }

    public _ResponseApiLatestSecretScanningRules_400 addErrorsItem(RestErrorMessage errorsItem) {
        if (this.errors == null) {
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestSecretScanningRules_400 {");
