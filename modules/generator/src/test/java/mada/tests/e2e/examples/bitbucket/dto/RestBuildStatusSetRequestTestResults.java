...
public class RestBuildStatusSetRequestTestResults {
    ...
    public RestBuildStatusSetRequestTestResults failed(Integer failed) {
        this.failed = failed;
        return this;
    }
    ...
    public RestBuildStatusSetRequestTestResults skipped(Integer skipped) {
    ...
    public RestBuildStatusSetRequestTestResults successful(Integer successful) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestBuildStatusSetRequestTestResults)) {
            return false;
        }
        RestBuildStatusSetRequestTestResults other = (RestBuildStatusSetRequestTestResults) o;
    ...
    public String toString() {
        ...
        sb.append("class RestBuildStatusSetRequestTestResults {");
