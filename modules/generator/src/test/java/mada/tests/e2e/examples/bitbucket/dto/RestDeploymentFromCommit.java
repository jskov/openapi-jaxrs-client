...
public class RestDeploymentFromCommit {
    ...
    public RestDeploymentFromCommit displayId(String displayId) {
    ...
    public RestDeploymentFromCommit id(String id) {
        this.id = id;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestDeploymentFromCommit {");
