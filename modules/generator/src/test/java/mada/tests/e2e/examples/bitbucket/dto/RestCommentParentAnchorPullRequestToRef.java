...
public class RestCommentParentAnchorPullRequestToRef {
    ...
    private RestCommentParentAnchorPullRequestToRefRepository repository;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentAnchorPullRequestToRef.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestCommentParentAnchorPullRequestToRef displayId(String displayId) {
    ...
    public RestCommentParentAnchorPullRequestToRef id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestToRef latestCommit(String latestCommit) {
    ...
    public RestCommentParentAnchorPullRequestToRef repository(RestCommentParentAnchorPullRequestToRefRepository repository) {
     ...
     * @return repository
     **/
    public @Valid RestCommentParentAnchorPullRequestToRefRepository getRepository() {
        return repository;
    }

    public void setRepository(RestCommentParentAnchorPullRequestToRefRepository repository) {
        this.repository = repository;
    }

    public RestCommentParentAnchorPullRequestToRef type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentParentAnchorPullRequestToRef)) {
            return false;
        }
        RestCommentParentAnchorPullRequestToRef other = (RestCommentParentAnchorPullRequestToRef) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentParentAnchorPullRequestToRef {");
