...
public class RestDeploymentToCommit {
    ...
    public RestDeploymentToCommit displayId(String displayId) {
    ...
    public RestDeploymentToCommit id(String id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestDeploymentToCommit)) {
            return false;
        }
        RestDeploymentToCommit other = (RestDeploymentToCommit) o;
    ...
    public String toString() {
        ...
        sb.append("class RestDeploymentToCommit {");
