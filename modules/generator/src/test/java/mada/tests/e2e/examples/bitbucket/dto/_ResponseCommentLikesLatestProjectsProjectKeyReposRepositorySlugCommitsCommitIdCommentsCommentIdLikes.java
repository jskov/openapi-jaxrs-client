...
public class _ResponseCommentLikesLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdCommentsCommentIdLikes {
    ...
    public _ResponseCommentLikesLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdCommentsCommentIdLikes limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseCommentLikesLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdCommentsCommentIdLikes size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseCommentLikesLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdCommentsCommentIdLikes start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class _ResponseCommentLikesLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdCommentsCommentIdLikes {");
