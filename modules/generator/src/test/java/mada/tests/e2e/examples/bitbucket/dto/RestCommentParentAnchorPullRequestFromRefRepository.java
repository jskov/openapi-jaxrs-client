...
public class RestCommentParentAnchorPullRequestFromRefRepository {
   ...
   **/
  @Valid
  public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin getOrigin() {
    return origin;
  }
   ...
   **/
  @Valid
  public RestCommentParentAnchorPullRequestFromRefRepositoryProject getProject() {
    return project;
  }
