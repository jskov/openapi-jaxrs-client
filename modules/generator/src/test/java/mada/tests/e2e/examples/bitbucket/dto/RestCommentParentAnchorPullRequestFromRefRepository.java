...
public class RestCommentParentAnchorPullRequestFromRefRepository {
    ...
    @Schema(readOnly = true)
    private RestCommentParentAnchorPullRequestFromRefRepositoryOrigin origin;
    ...
    private RestCommentParentAnchorPullRequestFromRefRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentAnchorPullRequestFromRefRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository archived(Boolean archived) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository defaultBranch(String defaultBranch) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository description(String description) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository forkable(Boolean forkable) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository hierarchyId(String hierarchyId) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository origin(RestCommentParentAnchorPullRequestFromRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    public @Valid RestCommentParentAnchorPullRequestFromRefRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestCommentParentAnchorPullRequestFromRefRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestCommentParentAnchorPullRequestFromRefRepository partition(Integer partition) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository project(RestCommentParentAnchorPullRequestFromRefRepositoryProject project) {
     ...
     * @return project
     **/
    public @Valid RestCommentParentAnchorPullRequestFromRefRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestCommentParentAnchorPullRequestFromRefRepositoryProject project) {
        this.project = project;
    }

    public RestCommentParentAnchorPullRequestFromRefRepository public_(Boolean public_) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository relatedLinks(Object relatedLinks) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentParentAnchorPullRequestFromRefRepository)) {
            return false;
        }
        RestCommentParentAnchorPullRequestFromRefRepository other = (RestCommentParentAnchorPullRequestFromRefRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentParentAnchorPullRequestFromRefRepository {");
