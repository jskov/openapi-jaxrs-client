...
public class RestRestrictionRequestMatcherType {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRestrictionRequestMatcherType.IdEnum.IdEnumAdapter.class)
    private IdEnum id;
    ...
    public RestRestrictionRequestMatcherType id(IdEnum id) {
        this.id = id;
        return this;
    }
    ...
    public RestRestrictionRequestMatcherType name(String name) {
        this.name = name;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestRestrictionRequestMatcherType {");
