...
public class RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin {
    ...
    private RestCommentThreadDiffAnchorPullRequestToRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin description(String description) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin project(RestCommentThreadDiffAnchorPullRequestToRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    @Valid public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestCommentThreadDiffAnchorPullRequestToRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin)) {
            return false;
        }
        RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin other = (RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin {");
