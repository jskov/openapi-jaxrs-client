...
public class RestUserReactionCommentParent {
    public static final String JSON_PROPERTY_ANCHOR = "anchor";
    @JsonbProperty(JSON_PROPERTY_ANCHOR)
    @Schema(readOnly = true)
    private RestUserReactionCommentParentAnchor anchor;
    ...
    @Schema(readOnly = true)
    private RestUserReactionCommentParentAuthor author;
    ...
    @Schema(readOnly = true)
    private RestUserReactionCommentParentResolver resolver;
    ...
    @Schema(readOnly = true)
    private RestUserReactionCommentParentThreadResolver threadResolver;
    ...
    public RestUserReactionCommentParent anchor(RestUserReactionCommentParentAnchor anchor) {
        this.anchor = anchor;
        return this;
    }
     ...
     * @return anchor
     **/
    public @Valid RestUserReactionCommentParentAnchor getAnchor() {
        return anchor;
    }

    public void setAnchor(RestUserReactionCommentParentAnchor anchor) {
        this.anchor = anchor;
    }

    public RestUserReactionCommentParent anchored(Boolean anchored) {
    ...
    public RestUserReactionCommentParent author(RestUserReactionCommentParentAuthor author) {
        this.author = author;
        return this;
    }
     ...
     * @return author
     **/
    public @Valid RestUserReactionCommentParentAuthor getAuthor() {
        return author;
    }

    public void setAuthor(RestUserReactionCommentParentAuthor author) {
        this.author = author;
    }

    public RestUserReactionCommentParent comments(List<RestComment> comments) {
        this.comments = comments;
        return this;
    }

    public RestUserReactionCommentParent addCommentsItem(RestComment commentsItem) {
    ...
    public RestUserReactionCommentParent createdDate(Long createdDate) {
    ...
    public RestUserReactionCommentParent html(String html) {
        this.html = html;
        return this;
    }
    ...
    public RestUserReactionCommentParent id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentParent pending(Boolean pending) {
    ...
    public RestUserReactionCommentParent properties(Object properties) {
    ...
    public RestUserReactionCommentParent reply(Boolean reply) {
        this.reply = reply;
        return this;
    }
    ...
    public RestUserReactionCommentParent resolvedDate(Long resolvedDate) {
    ...
    public RestUserReactionCommentParent resolver(RestUserReactionCommentParentResolver resolver) {
     ...
     * @return resolver
     **/
    public @Valid RestUserReactionCommentParentResolver getResolver() {
        return resolver;
    }

    public void setResolver(RestUserReactionCommentParentResolver resolver) {
        this.resolver = resolver;
    }

    public RestUserReactionCommentParent severity(String severity) {
    ...
    public RestUserReactionCommentParent state(String state) {
        this.state = state;
        return this;
    }
    ...
    public RestUserReactionCommentParent text(String text) {
        this.text = text;
        return this;
    }
    ...
    public RestUserReactionCommentParent threadResolved(Boolean threadResolved) {
    ...
    public RestUserReactionCommentParent threadResolvedDate(Long threadResolvedDate) {
    ...
    public RestUserReactionCommentParent threadResolver(RestUserReactionCommentParentThreadResolver threadResolver) {
     ...
     **/
    public @Valid RestUserReactionCommentParentThreadResolver getThreadResolver() {
        return threadResolver;
    }

    public void setThreadResolver(RestUserReactionCommentParentThreadResolver threadResolver) {
        this.threadResolver = threadResolver;
    }

    public RestUserReactionCommentParent updatedDate(Long updatedDate) {
    ...
    public RestUserReactionCommentParent version(Integer version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentParent)) {
            return false;
        }
        RestUserReactionCommentParent other = (RestUserReactionCommentParent) o;
