...
public class RestDeploymentRepositoryOriginProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestDeploymentRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestDeploymentRepositoryOriginProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestDeploymentRepositoryOriginProject avatarUrl(String avatarUrl) {
    ...
    public RestDeploymentRepositoryOriginProject description(String description) {
    ...
    public RestDeploymentRepositoryOriginProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestDeploymentRepositoryOriginProject key(String key) {
    ...
    public RestDeploymentRepositoryOriginProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestDeploymentRepositoryOriginProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestDeploymentRepositoryOriginProject namespace(String namespace) {
    ...
    public RestDeploymentRepositoryOriginProject public_(Boolean public_) {
    ...
    public RestDeploymentRepositoryOriginProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestDeploymentRepositoryOriginProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestDeploymentRepositoryOriginProject)) {
            return false;
        }
        RestDeploymentRepositoryOriginProject other = (RestDeploymentRepositoryOriginProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestDeploymentRepositoryOriginProject {");
