...
public class RestRefSyncStatusOrphanedRefs {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRefSyncStatusOrphanedRefs.StateEnum.StateEnumAdapter.class)
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRefSyncStatusOrphanedRefs.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestRefSyncStatusOrphanedRefs displayId(String displayId) {
  ...
  public RestRefSyncStatusOrphanedRefs id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestRefSyncStatusOrphanedRefs state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestRefSyncStatusOrphanedRefs tag(Boolean tag) {
    this.tag = tag;
    return this;
  }
  ...
  public RestRefSyncStatusOrphanedRefs type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RestRefSyncStatusOrphanedRefs {");
