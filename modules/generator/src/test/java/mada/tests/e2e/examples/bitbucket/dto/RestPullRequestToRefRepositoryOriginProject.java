...
public class RestPullRequestToRefRepositoryOriginProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestToRefRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestPullRequestToRefRepositoryOriginProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOriginProject avatarUrl(String avatarUrl) {
    ...
    public RestPullRequestToRefRepositoryOriginProject description(String description) {
    ...
    public RestPullRequestToRefRepositoryOriginProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOriginProject key(String key) {
    ...
    public RestPullRequestToRefRepositoryOriginProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOriginProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOriginProject namespace(String namespace) {
    ...
    public RestPullRequestToRefRepositoryOriginProject public_(Boolean public_) {
    ...
    public RestPullRequestToRefRepositoryOriginProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOriginProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestToRefRepositoryOriginProject)) {
            return false;
        }
        RestPullRequestToRefRepositoryOriginProject other = (RestPullRequestToRefRepositoryOriginProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestToRefRepositoryOriginProject {");
