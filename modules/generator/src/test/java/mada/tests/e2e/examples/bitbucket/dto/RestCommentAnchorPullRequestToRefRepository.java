...
public class RestCommentAnchorPullRequestToRefRepository {
    ...
    @Schema(readOnly = true)
    private RestCommentAnchorPullRequestToRefRepositoryOrigin origin;
    ...
    private RestCommentAnchorPullRequestToRefRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequestToRefRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestCommentAnchorPullRequestToRefRepository archived(Boolean archived) {
    ...
    public RestCommentAnchorPullRequestToRefRepository defaultBranch(String defaultBranch) {
    ...
    public RestCommentAnchorPullRequestToRefRepository description(String description) {
    ...
    public RestCommentAnchorPullRequestToRefRepository forkable(Boolean forkable) {
    ...
    public RestCommentAnchorPullRequestToRefRepository hierarchyId(String hierarchyId) {
    ...
    public RestCommentAnchorPullRequestToRefRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepository origin(RestCommentAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    public @Valid RestCommentAnchorPullRequestToRefRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestCommentAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestCommentAnchorPullRequestToRefRepository partition(Integer partition) {
    ...
    public RestCommentAnchorPullRequestToRefRepository project(RestCommentAnchorPullRequestToRefRepositoryProject project) {
     ...
     * @return project
     **/
    public @Valid RestCommentAnchorPullRequestToRefRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestCommentAnchorPullRequestToRefRepositoryProject project) {
        this.project = project;
    }

    public RestCommentAnchorPullRequestToRefRepository public_(Boolean public_) {
    ...
    public RestCommentAnchorPullRequestToRefRepository relatedLinks(Object relatedLinks) {
    ...
    public RestCommentAnchorPullRequestToRefRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentAnchorPullRequestToRefRepository)) {
            return false;
        }
        RestCommentAnchorPullRequestToRefRepository other = (RestCommentAnchorPullRequestToRefRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorPullRequestToRefRepository {");
