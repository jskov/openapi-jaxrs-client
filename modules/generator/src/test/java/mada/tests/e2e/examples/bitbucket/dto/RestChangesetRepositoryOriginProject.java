...
public class RestChangesetRepositoryOriginProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestChangesetRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestChangesetRepositoryOriginProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestChangesetRepositoryOriginProject avatarUrl(String avatarUrl) {
    ...
    public RestChangesetRepositoryOriginProject description(String description) {
    ...
    public RestChangesetRepositoryOriginProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestChangesetRepositoryOriginProject key(String key) {
    ...
    public RestChangesetRepositoryOriginProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestChangesetRepositoryOriginProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestChangesetRepositoryOriginProject namespace(String namespace) {
    ...
    public RestChangesetRepositoryOriginProject public_(Boolean public_) {
    ...
    public RestChangesetRepositoryOriginProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestChangesetRepositoryOriginProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestChangesetRepositoryOriginProject)) {
            return false;
        }
        RestChangesetRepositoryOriginProject other = (RestChangesetRepositoryOriginProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestChangesetRepositoryOriginProject {");
