...
public class RestCommentAnchorPullRequestFromRefRepositoryProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequestFromRefRepositoryProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestCommentAnchorPullRequestFromRefRepositoryProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryProject avatarUrl(String avatarUrl) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryProject description(String description) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryProject key(String key) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryProject namespace(String namespace) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryProject public_(Boolean public_) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentAnchorPullRequestFromRefRepositoryProject)) {
            return false;
        }
        RestCommentAnchorPullRequestFromRefRepositoryProject other = (RestCommentAnchorPullRequestFromRefRepositoryProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorPullRequestFromRefRepositoryProject {");
