...
public class ExampleJsonLastModifiedCallbackReadmeMd {
  public static final String JSON_PROPERTY_AUTHOR = "author";
  @JsonbProperty(JSON_PROPERTY_AUTHOR)
  private ExampleJsonLastModifiedCallbackReadmeMdAuthor author;
  ...
  private ExampleJsonLastModifiedCallbackReadmeMdCommitter committer;
  ...
  public ExampleJsonLastModifiedCallbackReadmeMd author(ExampleJsonLastModifiedCallbackReadmeMdAuthor author) {
    this.author = author;
    return this;
  }
   ...
   **/
  @Valid
  public ExampleJsonLastModifiedCallbackReadmeMdAuthor getAuthor() {
    return author;
  }

  public void setAuthor(ExampleJsonLastModifiedCallbackReadmeMdAuthor author) {
    this.author = author;
  }

  public ExampleJsonLastModifiedCallbackReadmeMd authorTimestamp(Long authorTimestamp) {
  ...
  public ExampleJsonLastModifiedCallbackReadmeMd committer(ExampleJsonLastModifiedCallbackReadmeMdCommitter committer) {
   ...
   **/
  @Valid
  public ExampleJsonLastModifiedCallbackReadmeMdCommitter getCommitter() {
    return committer;
  }

  public void setCommitter(ExampleJsonLastModifiedCallbackReadmeMdCommitter committer) {
    this.committer = committer;
  }

  public ExampleJsonLastModifiedCallbackReadmeMd committerTimestamp(Long committerTimestamp) {
  ...
  public ExampleJsonLastModifiedCallbackReadmeMd displayId(String displayId) {
  ...
  public ExampleJsonLastModifiedCallbackReadmeMd id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ExampleJsonLastModifiedCallbackReadmeMd message(String message) {
  ...
  public ExampleJsonLastModifiedCallbackReadmeMd parents(List<RestMinimalCommit> parents) {
    this.parents = parents;
    return this;
  }

  public ExampleJsonLastModifiedCallbackReadmeMd addParentsItem(RestMinimalCommit parentsItem) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ExampleJsonLastModifiedCallbackReadmeMd)) {
      return false;
    }
    ExampleJsonLastModifiedCallbackReadmeMd other = (ExampleJsonLastModifiedCallbackReadmeMd) o;
  ...
  public String toString() {
    ...
    sb.append("class ExampleJsonLastModifiedCallbackReadmeMd {");
