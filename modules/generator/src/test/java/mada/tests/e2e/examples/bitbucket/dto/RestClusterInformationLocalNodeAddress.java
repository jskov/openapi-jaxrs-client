...
public class RestClusterInformationLocalNodeAddress {
  ...
  public RestClusterInformationLocalNodeAddress address(String address) {
  ...
  public RestClusterInformationLocalNodeAddress port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RestClusterInformationLocalNodeAddress {");
