...
public interface LayerApi {
    ...
    void Blob_Mount(@HeaderParam("Authorization") String auth, @PathParam("name") @NotNull String name,
            @QueryParam("from") @NotNull String from, @QueryParam("mount") @NotNull String mount);
    ...
    InputStream Blob_Get(@HeaderParam("Authorization") String auth, @PathParam("name") @NotNull String name,
            @PathParam("digest") @NotNull String digest);
    ...
    AcrErrors Blob_Check(@HeaderParam("Authorization") String auth, @PathParam("name") @NotNull String name,
            @PathParam("digest") @NotNull String digest);
    ...
    AcrErrors Blob_Delete(@HeaderParam("Authorization") String auth, @PathParam("name") @NotNull String name,
            @PathParam("digest") @NotNull String digest);
     ...
     *
     * @param auth             (not null)
     * @param nextBlobUuidLink Link acquired from upload start or previous chunk. Note, do not include initial / (must do
     *                         substring(1) ) (not null)
     * @return AcrErrors
     */
    @GET
    ...
    /**
     * Complete the upload, providing all the data in the body, if necessary. A request without a body will just complete
     * the upload with previously uploaded content.
     *
     * @param auth             (not null)
     * @param digest           Digest of a BLOB (not null)
     * @param nextBlobUuidLink Link acquired from upload start or previous chunk. Note, do not include initial / (must do
    ...
    void Blob_EndUpload(@HeaderParam("Authorization") String auth, @QueryParam("digest") @NotNull String digest,
            @PathParam("nextBlobUuidLink") @NotNull String nextBlobUuidLink, Object dto);
    ...
    AcrErrors Blob_Upload(@HeaderParam("Authorization") String auth, @PathParam("nextBlobUuidLink") @NotNull String nextBlobUuidLink,
            @NotNull Object dto);
}
