...
public class RestCommentAnchorPullRequestFromRef {
    ...
    private RestCommentAnchorPullRequestFromRefRepository repository;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequestFromRef.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestCommentAnchorPullRequestFromRef displayId(String displayId) {
    ...
    public RestCommentAnchorPullRequestFromRef id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRef latestCommit(String latestCommit) {
    ...
    public RestCommentAnchorPullRequestFromRef repository(RestCommentAnchorPullRequestFromRefRepository repository) {
     ...
     * @return repository
     **/
    public @Valid RestCommentAnchorPullRequestFromRefRepository getRepository() {
        return repository;
    }

    public void setRepository(RestCommentAnchorPullRequestFromRefRepository repository) {
        this.repository = repository;
    }

    public RestCommentAnchorPullRequestFromRef type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentAnchorPullRequestFromRef)) {
            return false;
        }
        RestCommentAnchorPullRequestFromRef other = (RestCommentAnchorPullRequestFromRef) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorPullRequestFromRef {");
