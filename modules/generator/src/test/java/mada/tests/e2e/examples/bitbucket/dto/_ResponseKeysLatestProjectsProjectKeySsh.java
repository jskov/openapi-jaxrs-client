...
/**
 * _ResponseKeysLatestProjectsProjectKeySsh
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseKeysLatestProjectsProjectKeySsh {
    ...
    public _ResponseKeysLatestProjectsProjectKeySsh isLastPage(Boolean isLastPage) {
    ...
    public _ResponseKeysLatestProjectsProjectKeySsh limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseKeysLatestProjectsProjectKeySsh nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseKeysLatestProjectsProjectKeySsh size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseKeysLatestProjectsProjectKeySsh start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseKeysLatestProjectsProjectKeySsh values(List<RestSshAccessKey> values) {
        this.values = values;
        return this;
    }

    public _ResponseKeysLatestProjectsProjectKeySsh addValuesItem(RestSshAccessKey valuesItem) {
        if (this.values == null) {
    ...
    public String toString() {
        ...
        sb.append("class _ResponseKeysLatestProjectsProjectKeySsh {");
