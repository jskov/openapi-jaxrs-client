...
public class RestPullRequestToRefRepository {
  ...
  @Schema(readOnly = true)
  private RestPullRequestToRefRepositoryOrigin origin;
  ...
  private RestPullRequestToRefRepositoryProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestToRefRepository.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestPullRequestToRefRepository archived(Boolean archived) {
  ...
  public RestPullRequestToRefRepository defaultBranch(String defaultBranch) {
  ...
  public RestPullRequestToRefRepository description(String description) {
  ...
  public RestPullRequestToRefRepository forkable(Boolean forkable) {
  ...
  public RestPullRequestToRefRepository hierarchyId(String hierarchyId) {
  ...
  public RestPullRequestToRefRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestPullRequestToRefRepository links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestPullRequestToRefRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestPullRequestToRefRepository origin(RestPullRequestToRefRepositoryOrigin origin) {
    this.origin = origin;
    return this;
  }
   ...
   **/
  @Valid
  public RestPullRequestToRefRepositoryOrigin getOrigin() {
    return origin;
  }

  public void setOrigin(RestPullRequestToRefRepositoryOrigin origin) {
    this.origin = origin;
  }

  public RestPullRequestToRefRepository partition(Integer partition) {
  ...
  public RestPullRequestToRefRepository project(RestPullRequestToRefRepositoryProject project) {
   ...
   **/
  @Valid
  public RestPullRequestToRefRepositoryProject getProject() {
    return project;
  }

  public void setProject(RestPullRequestToRefRepositoryProject project) {
    this.project = project;
  }

  public RestPullRequestToRefRepository public_(Boolean public_) {
  ...
  public RestPullRequestToRefRepository relatedLinks(Object relatedLinks) {
  ...
  public RestPullRequestToRefRepository scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestPullRequestToRefRepository scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestPullRequestToRefRepository slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestPullRequestToRefRepository state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestPullRequestToRefRepository statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestPullRequestToRefRepository)) {
      return false;
    }
    RestPullRequestToRefRepository other = (RestPullRequestToRefRepository) o;
  ...
  public String toString() {
    ...
    sb.append("class RestPullRequestToRefRepository {");
