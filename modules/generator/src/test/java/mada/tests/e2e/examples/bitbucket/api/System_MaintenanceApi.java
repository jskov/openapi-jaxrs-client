...
public interface System_MaintenanceApi {
    ...
    /**
     * Get global SSH key settings. Gets the global settings that enforce the maximum expiry of SSH keys and restrictions on
     * SSH key types.
     *
    ...
    /**
     * Update global SSH key settings. Updates the global settings that enforces the maximum expiry of SSH keys and
     * restrictions on SSH key types.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseAdmin_400.class),
    ...
    /**
     * Get supported SSH key algorithms and lengths. Retrieves a list of all supported SSH key algorithms and lengths.
     */
    @GET
    ...
    /**
     * Get announcement banner. Gets the announcement banner, if one exists and is available to the user
     *
    ...
    /**
     * Update/Set announcement banner. Sets the announcement banner with the provided JSON. Only users authenticated as
     * Admins may call this resource
     *
     * @param dto (optional)
     */
    @PUT
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminBanner_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
                    description = "The user does not have permission to access the banner service through this endpoint",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminBanner_401.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Delete announcement banner. Deletes a banner, if one is present in the database.
     */
    @DELETE
    @Path("api/latest/admin/banner")
    @APIResponses({
    ...
    /**
     * Get cluster node information. Gets information about the nodes that currently make up the stash cluster.
     * 
    ...
    /**
     * Get the default branch. Retrieves the configured global default branch, which is used when creating new repositories
     * if an explicit default branch is not specified.
     * 
    ...
    /**
     * Update/Set default branch. Configures the global default branch, which is used when creating new repositories if an
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminDefaultBranch_401.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Clear default branch. Clears the global default branch, which is used when creating new repositories if an explicit
    ...
    /**
     * Get the control plane PEM. Obtain the control plane PEM.
     * 
    ...
    /**
     * Generate Mesh connectivity report. Generates a connectivity report between the Bitbucket node(s) and the Mesh
     * node(s).
     * 
     * The authenticated user must have **SYS_ADMIN** permission.
     *
    ...
    /**
     * Get all registered Mesh nodes. Get all the registered Mesh nodes.
     * 
     * The authenticated user must have **SYS_ADMIN** permission.
     *
     * @return RestMeshNode
    ...
    /**
     * Register new Mesh node. Register a new Mesh node.
     * 
     * The authenticated user must have **SYS_ADMIN** permission.
     *
    ...
    /**
     * Get Mesh node. Get the registered Mesh node that matches the supplied ID.
     * 
     * The authenticated user must have **SYS_ADMIN** permission.
     *
    ...
    /**
     * Update Mesh node. Update a Mesh node.
     * 
     * The authenticated user must have **SYS_ADMIN** permission.
     *
    ...
    /**
     * Delete Mesh node. Delete a Mesh node
     * 
     * The authenticated user must have **SYS_ADMIN** permission.
     *
    ...
    /**
     * Get support zips for all Mesh nodes. Get the support zips for all the Mesh nodes.
     * 
     * The authenticated user must have **SYS_ADMIN** permission.
     */
    @GET
    ...
    /**
     * Get support zip for node. Get the support zip for the Mesh node that matches the specified ID.
     * 
     * The authenticated user must have **SYS_ADMIN** permission.
     *
     * @param id The ID of the Mesh node. (not null)
    ...
    /**
     * Get license details. Retrieves details about the current license, as well as the current status of the system with
     * regards to the installed license. The status includes the current number of users applied toward the license limit,
     * as well as any status messages about the license (warnings about expiry or user counts exceeding license limits).
     * 
    ...
    /**
     * Update license. Decodes the provided encoded license and sets it as the active license. If no license was provided, a
     * 400 is returned. If the license cannot be decoded, or cannot be applied, a 409 is returned. Some possible reasons a
     ...
     * 
     * The authenticated user must have <b>SYS_ADMIN</b> permission. <b>ADMIN</b> users may <i>view</i> the current license
     * details, but they may not <i>update</i> the license.
     *
    ...
    /**
     * Get mail configuration. Retrieves the current mail configuration.
     * 
     * The authenticated user must have the <strong>SYS_ADMIN</strong> permission to call this resource.
     *
    ...
    /**
     * Update mail configuration. Updates the mail configuration.
     * 
     * The authenticated user must have the <strong>SYS_ADMIN</strong> permission to call this resource.
     *
     * @param dto (optional)
    ...
    /**
     * Delete mail configuration. Deletes the current mail configuration.
     * 
     * The authenticated user must have the <strong>SYS_ADMIN</strong> permission to call this resource.
     */
    @DELETE
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminMailServer_401.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Get server mail address. Retrieves the server email address
     */
    @GET
    ...
    /**
     * Update server mail address. Updates the server email address
     * 
    ...
    /**
     * Update mail configuration. Clears the server email address.
     * 
     * The authenticated user must have the <strong>ADMIN</strong> permission to call this resource.
     */
    @DELETE
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminMailServerSenderAddress_401.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    @Operation(summary = "Update mail configuration")
    ...
    /**
     * Get rate limit history. Retrieves the recent rate limit history for the instance.
     * 
     * The authenticated user must have the <strong>ADMIN</strong> permission to call this resource.
     *
    ...
    _ResponseApiLatestAdminRateLimitHistory getHistory(@QueryParam("order") String order, @QueryParam("start") BigDecimal start,
            @QueryParam("limit") BigDecimal limit);

    /**
     * Get rate limit settings. Retrieves the rate limit settings for the instance.
     * 
     * The user must be authenticated to call this resource.
     *
    ...
    /**
     * Set rate limit. Sets the rate limit settings for the instance.
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission to call this resource.
     *
    ...
    /**
     * Get rate limit settings for user. Retrieves the user-specific rate limit settings for the given user.
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission to call this resource.
     *
    ...
    /**
     * Set rate limit settings for users. Sets the given rate limit settings for the given users.
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission to call this resource.
     *
     * @param dto (optional)
    ...
    /**
     * Get user specific rate limit settings. Retrieves the user-specific rate limit settings for the given user.
     * 
    ...
    /**
     * Set rate limit settings for user. Sets the given rate limit settings for the given user.
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission to call this resource.
     *
     * @param userSlug The user slug. (not null)
    ...
    /**
     * Delete user specific rate limit settings. Deletes the user-specific rate limit settings for the given user.
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission to call this resource.
     *
     * @param userSlug The user slug. (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to retrieve rate limit settings.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminRateLimitSettingsUsersUserSlug_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified user does not exist, or has no settings.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminRateLimitSettingsUsersUserSlug_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Get application properties. Retrieve version information and other application properties.
     * 
    ...
    /**
     * Create a new hook script. Create a new hook script.
     * 
    ...
    /**
     * Get a hook script. Retrieves a hook script by ID.
     *
    ...
    /**
     * Update a hook script. Updates a hook script.
     * 
     * This endpoint requires **SYS_ADMIN** permission.
     *
    ...
    /**
     * Delete a hook script. Deletes a registered hook script.
     * 
     * This endpoint requires **SYS_ADMIN** permission.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestHookScriptsScriptId_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "Unable to find the supplied hook script ID.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestHookScriptsScriptId_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Get hook script content. Retrieves the hook script content.
     * 
     * This endpoint requires **SYS_ADMIN** permission.
     *
     * @param scriptId The ID of the hook script (not null)
    ...
    /**
     * Get all labels. Returns a paged response of all the labels in the system.
     * 
    ...
    _ResponseApiLatestLabels getLabels(@QueryParam("prefix") String prefix, @QueryParam("start") BigDecimal start,
            @QueryParam("limit") BigDecimal limit);

    /**
     * Get label. Returns a label.
     * 
     * The user needs to be authenticated to use this resource.
     *
    ...
    /**
     * Get labelables for label. Returns a page of labelables for a given label.
     * 
    ...
    /**
     * Get current log level. Retrieve the current log level for a given logger.
     * 
    ...
    /**
     * Set log level. Set the current log level for a given logger.
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission or higher to call this resource.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLogsLoggerLoggerNameLevelName_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to set the log level.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLogsLoggerLoggerNameLevelName_401.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Get root log level. Retrieve the current log level for the root logger.
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission or higher to call this resource.
     *
     * @return RestLogLevel
    ...
    /**
     * Set root log level. Set the current log level for the root logger.
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission or higher to call this resource.
     *
     * @param levelName the level to set the logger to. Either TRACE, DEBUG, INFO, WARN or ERROR (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The log level was invalid.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLogsRootLoggerLevelName_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to set the log level.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLogsRootLoggerLevelName_401.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Start export job. Starts a background job that exports the selected repositories.
     * 
     * Only 2 concurrent exports are supported _per cluster node_. If a request ends up on a node that is already running
     * that many export jobs, the request will be rejected and an error returned.
     * 
     * The response includes a description of the job that has been started, and its ID can be used to query these details
     * again, including the current progress, warnings and errors that occurred while processing the job, and to interrupt
     ...
     * parameter, `exportLocation`, which can be used to specify a _relative_ path within `data/migration/export` in the
     * shared home directory. No locations outside of that directory will be accepted for exports.
     * 
     * There are essentially three ways to select repositories for export. Regardless of which you use, a few general rules
     * apply:
     * 
     * - You can supply a list of selectors. The selection will be additive. - Repositories that are selected more than once
     * due to overlapping selectors will be de-duplicated and effectively exported only once. - For every selected
     * repository, its full fork hierarchy will be considered selected, even if parts of that hierarchy would otherwise not
     * be matched by the provided selectors. For example, when you explicitly select a single repository only, but that
     * repository is a fork, then its origin will be exported (and eventually imported), too.
     * 
    ...
    /**
     * Preview export. Enumerates the projects and repositories that would be exported for a given export request.
     * 
     ...
     * selection. This is why the server is streaming the response while it is being generated (as opposed to creating it in
     * memory and then sending it all at once) and it can be consumed in a streaming way, too.
     * 
    ...
    /**
     * Get export job details. Gets the details, including the current status and progress, of the export job identified by
     * the given ID.
     * 
     * The authenticated user must have **ADMIN** permission or higher to call this resource.
     *
    ...
    /**
     * Cancel export job. Requests the cancellation of an export job.
     * 
     * The request to cancel a job will be processed successfully if the job is actually still running. If it has already
     * finished (successfully or with errors) or if it has already been canceled before, then an error will be returned.
     * 
     * There might be a small delay between accepting the request and actually cancelling the job. In most cases, the delay
     * will be close to instantaneously. In the unlikely case of communication issues across a cluster, it can however take
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExportsJobIdCancel_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified job does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExportsJobIdCancel_404.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "409",
                    description = "The job was in a state that does not allow cancellation, e.g. it has already finished.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExportsJobIdCancel_409.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Get job messages. Gets the messages generated by the job.
     * 
    ...
    /**
     * Start import job. Starts a background job that imports the specified archive.
     * 
     * Only 1 import at a time is supported _per cluster_. If another request is made while an import is already running,
     * the request will be rejected and an error returned.
     * 
    ...
    /**
     * Get import job status. Gets the details, including the current status and progress, of the import job identified by
     * the given ID.
     * 
     * The authenticated user must have **ADMIN** permission or higher to call this resource.
     *
    ...
    /**
     * Cancel import job. Requests the cancellation of an import job.
     * 
     * The request to cancel a job will be processed successfully if the job is actually still running. If it has already
     * finished (successfully or with errors) or if it has already been canceled before, then an error will be returned.
     * 
     * Note that import jobs are not canceled as instantaneously as export jobs. Rather, once the request has been accepted,
     * there are a number of checkpoints at which the job will actually apply it and stop. This is to keep the system in a
     * reasonably consistent state:
     * 
     * - After the current fork hierarchy has been imported and verified. - Before the next repository is imported. - Before
     * the next pull request is imported.
     * 
     * A client should always actively query the job status to confirm that a job has been successfully canceled.
     * 
     * The authenticated user must have **ADMIN** permission or higher to call this resource.
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to cancel this job.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationImportsJobIdCancel_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified job does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationImportsJobIdCancel_404.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "409",
                    description = "The job was in a state that does not allow cancellation, e.g. it has already finished.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationImportsJobIdCancel_409.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Get import job messages. Gets the messages generated by the job.
     * 
     * Without any filter, all messages will be returned, but the response can optionally be filtered for the following
     * severities. The severity parameter can be repeated to include multiple severities in one response.
     * 
    ...
    /**
     * Start Mesh migration job. Starts a background job that migrates selected projects/repositories to Mesh.
     * 
     * Only 1 job is supported _per cluster_.
     * 
     * The response includes a description of the job that has been started, and its ID can be used to query these details
     * again, including the current progress, and to interrupt and cancel the execution of this job.
     * 
     ...
     * rules apply:
     * 
     * - You can supply a list of repository IDs and project IDs. The selection will be additive. All repositories in the
     * system are migrated if both lists are empty. - Repositories that are selected more than once due to overlapping IDs
     * will be de-duplicated and effectively migrated only once. - For every selected repository, its full fork hierarchy
     * will be considered selected, even if parts of that hierarchy would otherwise not be matched by the provided IDs. For
     * example, when you explicitly select a single repository only, but that repository is a fork, then its origin will be
     * migrated too.
     * 
     * Now, a single repository can be selected like this:
     * 
    ...
    /**
     * Preview Mesh migration. Enumerates the projects and repositories that would be migrated for a given request.
     * 
     * All affected repositories will be enumerated explicitly, and while projects are listed as individual items in
     * responses from this endpoint, their presence does not imply that all their repositories are included.
     * 
    ...
    /**
     * Find repositories by Mesh migration state. Searches for repositories in the system matching the specified criteria
     * and enriches their MeshMigrationQueueState migration state if a migration is currently in progress.
     * 
     * The currently active migration can optionally be specified by passing a migrationId, if known. If this isn't passed,
     * an attempt is made to locate the active migration and its ID is used.
     * 
     ...
     * 
     * Filtering by state is ignored when no migration is currently in progress. In such a case, results are not enriched
     * with their MeshMigrationQueueState migration state.
     * 
     * The authenticated user must have **SYS_ADMIN** permission to call this resource.
     *
    ...
    /**
     * Get all Mesh migration job summaries. Retrieve a page of Mesh migration job summaries. Jobs are ordered by when they
     * were started, newest first.
     * 
     * The authenticated user must have **SYS_ADMIN** permission to call this resource.
     *
     * @param start Start number for the page (inclusive). If not passed, first page is assumed. (optional)
    ...
    /**
     * Get summary for Mesh migration job. Gets the summary, including the queue status and progress, of the currently
     * active Mesh migration job.
     * 
     * The authenticated user must have **SYS_ADMIN** permission to call this resource.
     *
    ...
    /**
     * Get Mesh migration job details. Gets the details, including the current status and progress, of the job identified by
     * the given ID.
     * 
     * The authenticated user must have **SYS_ADMIN** permission to call this resource.
     *
    ...
    /**
     * Cancel Mesh migration job. Requests the cancellation of a migration job.
     * 
     * The request to cancel a job will be processed successfully if the job is actually still running. If it has already
     * finished (successfully or with errors) or if it has already been canceled before, then an error will be returned.
     * 
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobIdCancel_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified job ID does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobIdCancel_404.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "409",
                    description = "The migration job has already been canceled or finished.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobIdCancel_409.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Get Mesh migration job messages. Gets the messages generated by the job.
     * 
     * Without any filter, all messages will be returned, but the response can optionally be filtered for the following
     * severities. The severity parameter can be repeated to include multiple severities in one response.
     * 
    ...
    /**
     * Get Mesh migration job summary. Gets the summary, including the queue status and progress, of a Mesh migration job.
     * 
     * The authenticated user must have **SYS_ADMIN** permission to call this resource.
     *
     * @param jobId The ID of the job (not null)
    ...
    /**
     * Get all users. Retrieve a page of users, optionally run through provided filters.
     * 
     * 
     * Only authenticated users may call this resource. ### Permission Filters
     * 
     * 
     * The following three sub-sections list parameters supported for permission filters (where <code>[root]</code> is the
     * root permission filter name, e.g. <code>permission</code>, <code>permission.1</code> etc.) depending on the
     * permission resource. The system determines which filter to apply (Global, Project or Repository permission) based on
     * the `[root]` permission value. E.g. <code>ADMIN</code> is a global permission, <code>PROJECT_ADMIN</code> is a
     ...
     * <code>projectId</code> and <code>projectKey</code> are provided, the system will use <code>projectId</code> for the
     * lookup.
     * <h4>Global permissions</h4>
     * 
     * 
     * The permission value under <code>[root]</code> is the only required and recognized parameter, as global permissions
     * do not apply to a specific resource.
     * 
     * 
     ...
     * 
     * 
     * - <code>[root]</code>- specifies the project permission - <code>[root].projectId</code> - specifies the project ID to
     * lookup the project by - <code>[root].projectKey</code> - specifies the project key to lookup the project by
     * 
     * 
    ...
    RestApplicationUser getUsers_2(@QueryParam("filter") String filter, @QueryParam("permission.N") String permission_N,
            @QueryParam("permission") String permission, @QueryParam("group") String group);

    /**
     * Update user details. Update the currently authenticated user's details. The update will always be applied to the
    ...
    /**
     * Set password. Update the currently authenticated user's password.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestUsersCredentials_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
                    description = "Authentication failed or was not attempted.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestUsersCredentials_401.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Get user. Retrieve the user matching the supplied <strong>userSlug</strong>.
     *
     * @param userSlug The user slug (not null)
     * @return RestApplicationUser
     */
    ...
    /**
     * Update user avatar. Update the avatar for the user with the supplied <strong>slug</strong>.
     * 
     * 
     * This resource accepts POST multipart form data, containing a single image in a form-field named 'avatar'.
     * 
     * 
     * There are configurable server limits on both the dimensions (1024x1024 pixels by default) and uploaded file size (1MB
     * by default). Several different image formats are supported, but <strong>PNG</strong> and <strong>JPEG</strong> are
     * preferred due to the file size limit.
     * 
     * 
     ...
     * 
     * 
     * An example <a href="http://curl.haxx.se/">curl</a> request to upload an image name 'avatar.png' would be: ``` curl -X
     * POST -u username:password -H "X-Atlassian-Token: no-check" http://example.com/rest/api/latest/users/jdoe/avatar.png
     * -F avatar=@avatar.png ```
     * 
     * 
     * Users are always allowed to update their own avatar. To update someone else's avatar the authenticated user must have
     * global <strong>ADMIN</strong> permission, or global <strong>SYS_ADMIN</strong> permission to update a
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestUsersUserSlugAvatar_png_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified user does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestUsersUserSlugAvatar_png_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Delete user avatar. Delete the avatar associated to a user.
     * 
     * 
     * Users are always allowed to delete their own avatar. To delete someone else's avatar the authenticated user must have
     * global <strong>ADMIN</strong> permission, or global <strong>SYS_ADMIN</strong> permission to update a
     * <strong>SYS_ADMIN</strong> user's avatar.
     *
     * @param userSlug The user slug (not null)
    ...
    /**
     * Get user settings. Retrieve a map of user setting key values for a specific user identified by the user slug.
     *
     * @param userSlug The user slug. (not null)
    ...
    /**
     * Update user settings. Update the entries of a map of user setting key/values for a specific user identified by the
     * user slug.
     *
     * @param userSlug The user slug. (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestUsersUserSlugSettings_401.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Dismiss retention config notification. Dismisses the retention config review notification displayed by the audit
     * plugin for the user that's currently logged in.
     */
    @DELETE
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseAuditLatestNotificationSettingsRetentionConfigReview_401.class)))
    })
    @Operation(summary = "Dismiss retention config notification")
    void dismissRetentionConfigReviewNotification();

    /**
     * Get repository archive policy. Retrieves the repository archive policy for the instance.
     * 
    ...
    /**
     * Update repository archive policy. Sets the repository archive policy for the instance.
     * 
    ...
    /**
     * Get repository delete policy. Retrieves the repository delete policy for the instance.
     * 
     * The user must be authenticated to access this resource.
     *
     * @return RestRepositoryPolicy
    ...
    /**
     * Update the repository delete policy. Sets the repository delete policy for the instance.
     * 
     * The authenticated user must have <b>SYS_ADMIN</b> permission.
     *
     * @param dto The request containing the details of the policy. (optional)
