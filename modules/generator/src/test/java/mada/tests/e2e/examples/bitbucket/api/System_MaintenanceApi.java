...
public interface System_MaintenanceApi {
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestSshKeySettings.class))),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseAdmin_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseAdminSupportedKeyTypes_401.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestAnnouncementBanner.class))),
            @APIResponse(
                    responseCode = "204",
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestClusterInformation.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to retrieve the cluster information.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminCluster_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminDefaultBranch_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestMeshConnectivityReport.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGitMeshDiagnosticsConnectivity_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGitMeshNodes_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGitMeshNodes_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGitMeshNodesId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The Mesh node does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGitMeshNodesId_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGitMeshNodesId_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestBitbucketLicense.class))),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminLicense_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "No license has been installed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminLicense_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminLicense_400.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminLicense_409.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestMailConfiguration.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminMailServer_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminMailServer_400.class))),
            @APIResponse(
                    responseCode = "401",
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminMailServerSenderAddress_400.class))),
            @APIResponse(
                    responseCode = "401",
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminRateLimitHistory.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The sort query parameter is invalid.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminRateLimitHistory_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to retrieve rate limit history.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminRateLimitHistory_401.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestRateLimitSettings.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to retrieve rate limit settings.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminRateLimitSettings_401.class)))
    })
...
The authenticated user must have <strong>ADMIN</strong> permission to call this resource. (optional)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminRateLimitSettings_400.class))),
            @APIResponse(
                    responseCode = "401",
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminRateLimitSettingsUsers.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to retrieve rate limit settings.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestUserRateLimitSettings.class))),
            @APIResponse(
                    responseCode = "400",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminRateLimitSettingsUsers_400.class))),
            @APIResponse(
                    responseCode = "401",
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "One of the following valid state error cases occurred (check the error message for more details):\n\n- The request is empty\n- Whitelisted is false or not provided, and no settings are provided either\n- Whitelisted is false or not provided, settings are provided,   but do not contain both capacity and fillRate\n- Whitelisted is false or not provided, settings are provided,   but capacity and fillRate are not positive integers\n- Whitelisted is true, and settings are provided (only one must be provided)\n\n\n",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminRateLimitSettingsUsersUserSlug_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to set user settings.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestHookScript.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The hook script was not created due to a validation error.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestHookScripts_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestHookScripts_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestHookScriptsScriptId_409.class))),
            @APIResponse(
                    responseCode = "422",
                    description = "One or more fields to update must be specified: content, description and/or name.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestHookScriptsScriptId_422.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestHookScriptsScriptIdContent_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The hook script ID supplied does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestHookScriptsScriptIdContent_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLabels.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The user is currently not authenticated.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLabels_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The user is currently not authenticated.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLabelsLabelName_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified label does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLabelsLabelName_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLabelsLabelNameLabeled.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The type of labelable is incorrect, correct values are REPOSITORY.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLabelsLabelNameLabeled_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to retrieve the labelables",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLabelsLabelNameLabeled_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified label does not exist.",
                    content = @Content(
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLogsLoggerLoggerName_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to retrieve the log level.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestLogsRootLogger_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExports_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to start anexport",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExports_401.class))),
            @APIResponse(
                    responseCode = "503",
                    description = "The export could not be started because the limit of concurrent migration jobs has been reached.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExports_503.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestScopesExample.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExportsPreview_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to generate a preview.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExportsPreview_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExportsJobId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified job does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExportsJobId_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExportsJobIdMessages.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to retrieve information about this job.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationExportsJobIdMessages_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified job does not exist.",
                    content = @Content(
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationImports_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to start an import.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationImports_401.class))),
            @APIResponse(
                    responseCode = "503",
                    description = "The import could not be started because the limit of concurrent migration jobs has been reached.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationImports_503.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to retrieve information about this job.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationImportsJobId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified job does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationImportsJobId_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "The messages generated by this job.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationImportsJobIdMessages.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to retrieve information about this job.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationImportsJobIdMessages_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified job does not exist.",
                    content = @Content(
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMesh_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMesh_401.class))),
            @APIResponse(
                    responseCode = "503",
                    description = "A migration job is already in progress",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMesh_503.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = ExamplePreviewMigration.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request was invalid or missing.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshPreview_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshPreview_401.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshRepos.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshRepos_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshRepos_401.class))),
            @APIResponse(
                    responseCode = "404",
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshSummaries.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestMeshMigrationSummary.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshSummary_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "No active migration job found.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshSummary_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobId_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified job ID does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobId_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "The details of the migration job.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobIdMessages.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The job ID parameter was not supplied.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobIdMessages_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobIdMessages_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified job ID does not exist.",
                    content = @Content(
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The job ID parameter was not supplied.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobIdSummary_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to call this resource.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobIdSummary_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified job ID does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestMigrationMeshJobIdSummary_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestApplicationUser.class))),
            @APIResponse(
                    responseCode = "400",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestUsers_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "Authentication failed or was not attempted.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestUsers_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestUsersUserSlug_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified user does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestUsersUserSlug_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = ExampleSettingsMap.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestUsersUserSlugSettings_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestRepositoryPolicy.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to retrieve the repository archive policy",
                    content = @Content(
                            schema = @Schema(implementation = _ResponsePoliciesLatestAdminReposArchive_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponsePoliciesLatestAdminReposArchive_400.class))),
            @APIResponse(
                    responseCode = "401",
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponsePoliciesLatestAdminReposDelete_401.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The permission was invalid or does not exist",
                    content = @Content(
                            schema = @Schema(implementation = _ResponsePoliciesLatestAdminReposDelete_400.class))),
            @APIResponse(
                    responseCode = "401",
