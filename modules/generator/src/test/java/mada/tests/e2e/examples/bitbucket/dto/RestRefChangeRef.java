...
public class RestRefChangeRef {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRefChangeRef.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestRefChangeRef displayId(String displayId) {
    ...
    public RestRefChangeRef id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestRefChangeRef type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestRefChangeRef {");
