...
/**
 * _ResponseGpgLatestKeys
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseGpgLatestKeys {
  ...
  private List<RestGpgKey> values;

  public _ResponseGpgLatestKeys isLastPage(Boolean isLastPage) {
  ...
  public _ResponseGpgLatestKeys limit(BigDecimal limit) {
    this.limit = limit;
    return this;
  }
  ...
  public _ResponseGpgLatestKeys nextPageStart(Integer nextPageStart) {
  ...
  public _ResponseGpgLatestKeys size(BigDecimal size) {
    this.size = size;
    return this;
  }
  ...
  public _ResponseGpgLatestKeys start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public _ResponseGpgLatestKeys values(List<RestGpgKey> values) {
    this.values = values;
    return this;
  }

  public _ResponseGpgLatestKeys addValuesItem(RestGpgKey valuesItem) {
    if (this.values == null) {
   ...
   * @return values
   **/
  public List<@Valid RestGpgKey> getValues() {
    return values;
  }

  public void setValues(List<RestGpgKey> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof _ResponseGpgLatestKeys)) {
      return false;
    }
    _ResponseGpgLatestKeys other = (_ResponseGpgLatestKeys) o;
  ...
  public String toString() {
    ...
    sb.append("class _ResponseGpgLatestKeys {");
