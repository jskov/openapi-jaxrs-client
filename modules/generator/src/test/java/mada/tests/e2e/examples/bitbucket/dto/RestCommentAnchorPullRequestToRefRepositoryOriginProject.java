...
public class RestCommentAnchorPullRequestToRefRepositoryOriginProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequestToRefRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestCommentAnchorPullRequestToRefRepositoryOriginProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOriginProject avatarUrl(String avatarUrl) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOriginProject description(String description) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOriginProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOriginProject key(String key) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOriginProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOriginProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOriginProject namespace(String namespace) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOriginProject public_(Boolean public_) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOriginProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOriginProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentAnchorPullRequestToRefRepositoryOriginProject)) {
            return false;
        }
        RestCommentAnchorPullRequestToRefRepositoryOriginProject other = (RestCommentAnchorPullRequestToRefRepositoryOriginProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorPullRequestToRefRepositoryOriginProject {");
