...
public class RestSshAccessKeyKey {
    ...
    public RestSshAccessKeyKey algorithmType(String algorithmType) {
    ...
    public RestSshAccessKeyKey bitLength(Integer bitLength) {
    ...
    public RestSshAccessKeyKey createdDate(OffsetDateTime createdDate) {
    ...
    public RestSshAccessKeyKey expiryDays(Integer expiryDays) {
    ...
    public RestSshAccessKeyKey fingerprint(String fingerprint) {
    ...
    public RestSshAccessKeyKey id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestSshAccessKeyKey label(String label) {
        this.label = label;
        return this;
    }
    ...
    public RestSshAccessKeyKey lastAuthenticated(String lastAuthenticated) {
    ...
    public RestSshAccessKeyKey text(String text) {
        this.text = text;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestSshAccessKeyKey)) {
            return false;
        }
        RestSshAccessKeyKey other = (RestSshAccessKeyKey) o;
