...
public class RestUserReactionCommentParentAuthor {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentParentAuthor.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestUserReactionCommentParentAuthor active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestUserReactionCommentParentAuthor avatarUrl(String avatarUrl) {
  ...
  public RestUserReactionCommentParentAuthor displayName(String displayName) {
  ...
  public RestUserReactionCommentParentAuthor emailAddress(String emailAddress) {
  ...
  public RestUserReactionCommentParentAuthor id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestUserReactionCommentParentAuthor links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestUserReactionCommentParentAuthor name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestUserReactionCommentParentAuthor slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestUserReactionCommentParentAuthor type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestUserReactionCommentParentAuthor)) {
      return false;
    }
    RestUserReactionCommentParentAuthor other = (RestUserReactionCommentParentAuthor) o;
  ...
  public String toString() {
    ...
    sb.append("class RestUserReactionCommentParentAuthor {");
