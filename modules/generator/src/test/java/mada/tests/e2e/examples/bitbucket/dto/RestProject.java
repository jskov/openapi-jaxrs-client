...
public class RestProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestProject avatarUrl(String avatarUrl) {
    ...
    public RestProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestProject namespace(String namespace) {
    ...
    public RestProject public_(Boolean public_) {
    ...
    public RestProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestProject)) {
            return false;
        }
        RestProject other = (RestProject) o;
