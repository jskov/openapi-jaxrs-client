...
public class RestRepositoryRefChangeActivityRepositoryOrigin {
  ...
  private RestRepositoryRefChangeActivityRepositoryOriginProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRepositoryRefChangeActivityRepositoryOrigin.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin archived(Boolean archived) {
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin defaultBranch(String defaultBranch) {
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin description(String description) {
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin forkable(Boolean forkable) {
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin hierarchyId(String hierarchyId) {
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin partition(Integer partition) {
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin project(RestRepositoryRefChangeActivityRepositoryOriginProject project) {
   ...
   **/
  @Valid
  public RestRepositoryRefChangeActivityRepositoryOriginProject getProject() {
    return project;
  }

  public void setProject(RestRepositoryRefChangeActivityRepositoryOriginProject project) {
    this.project = project;
  }

  public RestRepositoryRefChangeActivityRepositoryOrigin public_(Boolean public_) {
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin relatedLinks(Object relatedLinks) {
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryOrigin statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestRepositoryRefChangeActivityRepositoryOrigin)) {
      return false;
    }
    RestRepositoryRefChangeActivityRepositoryOrigin other = (RestRepositoryRefChangeActivityRepositoryOrigin) o;
  ...
  public String toString() {
    ...
    sb.append("class RestRepositoryRefChangeActivityRepositoryOrigin {");
