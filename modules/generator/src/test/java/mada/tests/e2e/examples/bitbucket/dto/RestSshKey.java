...
public class RestSshKey {
    ...
    public RestSshKey algorithmType(String algorithmType) {
    ...
    public RestSshKey bitLength(Integer bitLength) {
    ...
    public RestSshKey createdDate(OffsetDateTime createdDate) {
    ...
    public RestSshKey expiryDays(Integer expiryDays) {
    ...
    public RestSshKey fingerprint(String fingerprint) {
    ...
    public RestSshKey id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestSshKey label(String label) {
        this.label = label;
        return this;
    }
    ...
    public RestSshKey lastAuthenticated(String lastAuthenticated) {
    ...
    public RestSshKey text(String text) {
        this.text = text;
        return this;
    }
