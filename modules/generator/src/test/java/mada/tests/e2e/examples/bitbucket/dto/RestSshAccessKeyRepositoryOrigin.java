...
public class RestSshAccessKeyRepositoryOrigin {
    ...
    private RestSshAccessKeyRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestSshAccessKeyRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestSshAccessKeyRepositoryOrigin archived(Boolean archived) {
    ...
    public RestSshAccessKeyRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestSshAccessKeyRepositoryOrigin description(String description) {
    ...
    public RestSshAccessKeyRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestSshAccessKeyRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestSshAccessKeyRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOrigin partition(Integer partition) {
    ...
    public RestSshAccessKeyRepositoryOrigin project(RestSshAccessKeyRepositoryOriginProject project) {
     ...
     **/
    @Valid
    public RestSshAccessKeyRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestSshAccessKeyRepositoryOriginProject project) {
        this.project = project;
    }

    public RestSshAccessKeyRepositoryOrigin public_(Boolean public_) {
    ...
    public RestSshAccessKeyRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestSshAccessKeyRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestSshAccessKeyRepositoryOrigin)) {
            return false;
        }
        RestSshAccessKeyRepositoryOrigin other = (RestSshAccessKeyRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestSshAccessKeyRepositoryOrigin {");
