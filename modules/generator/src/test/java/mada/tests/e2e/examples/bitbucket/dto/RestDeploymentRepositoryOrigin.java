...
public class RestDeploymentRepositoryOrigin {
    ...
    private RestDeploymentRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestDeploymentRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestDeploymentRepositoryOrigin archived(Boolean archived) {
    ...
    public RestDeploymentRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestDeploymentRepositoryOrigin description(String description) {
    ...
    public RestDeploymentRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestDeploymentRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestDeploymentRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestDeploymentRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestDeploymentRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestDeploymentRepositoryOrigin partition(Integer partition) {
    ...
    public RestDeploymentRepositoryOrigin project(RestDeploymentRepositoryOriginProject project) {
     ...
     **/
    @Valid
    public RestDeploymentRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestDeploymentRepositoryOriginProject project) {
        this.project = project;
    }

    public RestDeploymentRepositoryOrigin public_(Boolean public_) {
    ...
    public RestDeploymentRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestDeploymentRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestDeploymentRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestDeploymentRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestDeploymentRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestDeploymentRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestDeploymentRepositoryOrigin)) {
            return false;
        }
        RestDeploymentRepositoryOrigin other = (RestDeploymentRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestDeploymentRepositoryOrigin {");
