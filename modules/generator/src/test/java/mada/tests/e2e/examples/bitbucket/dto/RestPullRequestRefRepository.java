...
public class RestPullRequestRefRepository {
    ...
    @Schema(readOnly = true)
    private RestPullRequestRefRepositoryOrigin origin;
    ...
    private RestPullRequestRefRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestRefRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestPullRequestRefRepository archived(Boolean archived) {
    ...
    public RestPullRequestRefRepository defaultBranch(String defaultBranch) {
    ...
    public RestPullRequestRefRepository description(String description) {
    ...
    public RestPullRequestRefRepository forkable(Boolean forkable) {
    ...
    public RestPullRequestRefRepository hierarchyId(String hierarchyId) {
    ...
    public RestPullRequestRefRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestRefRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestRefRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestRefRepository origin(RestPullRequestRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    public @Valid RestPullRequestRefRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestPullRequestRefRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestPullRequestRefRepository partition(Integer partition) {
    ...
    public RestPullRequestRefRepository project(RestPullRequestRefRepositoryProject project) {
     ...
     * @return project
     **/
    public @Valid RestPullRequestRefRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestPullRequestRefRepositoryProject project) {
        this.project = project;
    }

    public RestPullRequestRefRepository public_(Boolean public_) {
    ...
    public RestPullRequestRefRepository relatedLinks(Object relatedLinks) {
    ...
    public RestPullRequestRefRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestPullRequestRefRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestPullRequestRefRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestPullRequestRefRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestPullRequestRefRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestRefRepository)) {
            return false;
        }
        RestPullRequestRefRepository other = (RestPullRequestRefRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestRefRepository {");
