...
/**
 * _ResponseSshLatestKeys
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseSshLatestKeys {
    ...
    private List<RestSshKey> values;

    public _ResponseSshLatestKeys isLastPage(Boolean isLastPage) {
    ...
    public _ResponseSshLatestKeys limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseSshLatestKeys nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseSshLatestKeys size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseSshLatestKeys start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseSshLatestKeys values(List<RestSshKey> values) {
        this.values = values;
        return this;
    }

    public _ResponseSshLatestKeys addValuesItem(RestSshKey valuesItem) {
        if (this.values == null) {
     ...
     * @return values
     **/
    public @Valid List<RestSshKey> getValues() {
        return values;
    }

    public void setValues(List<RestSshKey> values) {
        this.values = values;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseSshLatestKeys)) {
            return false;
        }
        _ResponseSshLatestKeys other = (_ResponseSshLatestKeys) o;
    ...
    public String toString() {
        ...
        sb.append("class _ResponseSshLatestKeys {");
