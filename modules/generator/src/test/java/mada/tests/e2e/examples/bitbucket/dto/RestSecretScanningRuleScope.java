...
public class RestSecretScanningRuleScope {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestSecretScanningRuleScope.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestSecretScanningRuleScope resourceId(Integer resourceId) {
    ...
    public RestSecretScanningRuleScope type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestSecretScanningRuleScope {");
