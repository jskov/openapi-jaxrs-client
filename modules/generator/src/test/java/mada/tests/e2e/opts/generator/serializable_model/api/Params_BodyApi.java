...
package mada.tests.e2e.opts.generator.serializable_model.api;
...
import mada.tests.e2e.opts.generator.serializable_model.dto.Simple;
...
public interface Params_BodyApi {
  ...
  @Produces(MediaType.TEXT_PLAIN)
  @APIResponseSchema(String.class)
  String apiParamsBodyListSimpleGet(List<@Valid Simple> dto);
