...
public class RestPullRequestSuggestionFromRef {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestSuggestionFromRef.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestPullRequestSuggestionFromRef displayId(String displayId) {
    ...
    public RestPullRequestSuggestionFromRef id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestSuggestionFromRef type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestSuggestionFromRef {");
