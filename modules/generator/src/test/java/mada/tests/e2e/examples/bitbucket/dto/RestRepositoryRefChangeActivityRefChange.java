...
public class RestRepositoryRefChangeActivityRefChange {
    ...
    private RestRepositoryRefChangeActivityRefChangeRef ref;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRepositoryRefChangeActivityRefChange.TypeEnum.TypeEnumAdapter.class)
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRepositoryRefChangeActivityRefChange.UpdatedTypeEnum.UpdatedTypeEnumAdapter.class)
    private UpdatedTypeEnum updatedType;

    public RestRepositoryRefChangeActivityRefChange fromHash(String fromHash) {
    ...
    public RestRepositoryRefChangeActivityRefChange ref(RestRepositoryRefChangeActivityRefChangeRef ref) {
        this.ref = ref;
        return this;
    }
     ...
     **/
    @Valid
    public RestRepositoryRefChangeActivityRefChangeRef getRef() {
        return ref;
    }

    public void setRef(RestRepositoryRefChangeActivityRefChangeRef ref) {
        this.ref = ref;
    }

    public RestRepositoryRefChangeActivityRefChange refId(String refId) {
        this.refId = refId;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityRefChange toHash(String toHash) {
        this.toHash = toHash;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityRefChange type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityRefChange updatedType(UpdatedTypeEnum updatedType) {
    ...
    public String toString() {
        ...
        sb.append("class RestRepositoryRefChangeActivityRefChange {");
