...
public class ExampleJsonLastModifiedCallbackLatestCommitCommitter {
  ...
  public ExampleJsonLastModifiedCallbackLatestCommitCommitter avatarUrl(String avatarUrl) {
  ...
  public ExampleJsonLastModifiedCallbackLatestCommitCommitter emailAddress(String emailAddress) {
  ...
  public ExampleJsonLastModifiedCallbackLatestCommitCommitter name(String name) {
    this.name = name;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class ExampleJsonLastModifiedCallbackLatestCommitCommitter {");
