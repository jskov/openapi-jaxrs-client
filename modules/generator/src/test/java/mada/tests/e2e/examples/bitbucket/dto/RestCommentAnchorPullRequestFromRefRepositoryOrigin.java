...
public class RestCommentAnchorPullRequestFromRefRepositoryOrigin {
    ...
    private RestCommentAnchorPullRequestFromRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequestFromRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin description(String description) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin project(RestCommentAnchorPullRequestFromRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    @Valid public RestCommentAnchorPullRequestFromRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestCommentAnchorPullRequestFromRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestCommentAnchorPullRequestFromRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentAnchorPullRequestFromRefRepositoryOrigin)) {
            return false;
        }
        RestCommentAnchorPullRequestFromRefRepositoryOrigin other = (RestCommentAnchorPullRequestFromRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorPullRequestFromRefRepositoryOrigin {");
