...
public class RestConflictChangeSrcPath {
  ...
  public RestConflictChangeSrcPath components(List<String> components) {
    this.components = components;
    return this;
  }

  public RestConflictChangeSrcPath addComponentsItem(String componentsItem) {
  ...
  public RestConflictChangeSrcPath extension(String extension) {
  ...
  public RestConflictChangeSrcPath name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestConflictChangeSrcPath parent(String parent) {
    this.parent = parent;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RestConflictChangeSrcPath {");
