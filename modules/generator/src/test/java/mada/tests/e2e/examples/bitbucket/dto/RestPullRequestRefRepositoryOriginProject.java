...
public class RestPullRequestRefRepositoryOriginProject {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestRefRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
  @Schema(readOnly = true)
  private TypeEnum type;

  public RestPullRequestRefRepositoryOriginProject avatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public RestPullRequestRefRepositoryOriginProject avatarUrl(String avatarUrl) {
  ...
  public RestPullRequestRefRepositoryOriginProject description(String description) {
  ...
  public RestPullRequestRefRepositoryOriginProject id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestPullRequestRefRepositoryOriginProject key(String key) {
  ...
  public RestPullRequestRefRepositoryOriginProject links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestPullRequestRefRepositoryOriginProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestPullRequestRefRepositoryOriginProject namespace(String namespace) {
  ...
  public RestPullRequestRefRepositoryOriginProject public_(Boolean public_) {
  ...
  public RestPullRequestRefRepositoryOriginProject scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestPullRequestRefRepositoryOriginProject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestPullRequestRefRepositoryOriginProject)) {
      return false;
    }
    RestPullRequestRefRepositoryOriginProject other = (RestPullRequestRefRepositoryOriginProject) o;
  ...
  public String toString() {
    ...
    sb.append("class RestPullRequestRefRepositoryOriginProject {");
