...
public class RestSshAccessKeyRepository {
    ...
    @Schema(readOnly = true)
    private RestSshAccessKeyRepositoryOrigin origin;
    ...
    private RestSshAccessKeyRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestSshAccessKeyRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestSshAccessKeyRepository archived(Boolean archived) {
    ...
    public RestSshAccessKeyRepository defaultBranch(String defaultBranch) {
    ...
    public RestSshAccessKeyRepository description(String description) {
    ...
    public RestSshAccessKeyRepository forkable(Boolean forkable) {
    ...
    public RestSshAccessKeyRepository hierarchyId(String hierarchyId) {
    ...
    public RestSshAccessKeyRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestSshAccessKeyRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestSshAccessKeyRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestSshAccessKeyRepository origin(RestSshAccessKeyRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    public @Valid RestSshAccessKeyRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestSshAccessKeyRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestSshAccessKeyRepository partition(Integer partition) {
    ...
    public RestSshAccessKeyRepository project(RestSshAccessKeyRepositoryProject project) {
     ...
     * @return project
     **/
    public @Valid RestSshAccessKeyRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestSshAccessKeyRepositoryProject project) {
        this.project = project;
    }

    public RestSshAccessKeyRepository public_(Boolean public_) {
    ...
    public RestSshAccessKeyRepository relatedLinks(Object relatedLinks) {
    ...
    public RestSshAccessKeyRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestSshAccessKeyRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestSshAccessKeyRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestSshAccessKeyRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestSshAccessKeyRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestSshAccessKeyRepository)) {
            return false;
        }
        RestSshAccessKeyRepository other = (RestSshAccessKeyRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestSshAccessKeyRepository {");
