...
public class RestUserReactionCommentAuthor {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAuthor.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestUserReactionCommentAuthor active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public RestUserReactionCommentAuthor avatarUrl(String avatarUrl) {
    ...
    public RestUserReactionCommentAuthor displayName(String displayName) {
    ...
    public RestUserReactionCommentAuthor emailAddress(String emailAddress) {
    ...
    public RestUserReactionCommentAuthor id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentAuthor links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentAuthor name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentAuthor slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestUserReactionCommentAuthor type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentAuthor)) {
            return false;
        }
        RestUserReactionCommentAuthor other = (RestUserReactionCommentAuthor) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentAuthor {");
