...
public class RestAutoMergeProcessingResultPullRequest {
  ...
  private RestAutoMergeProcessingResultPullRequestFromRef fromRef;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestAutoMergeProcessingResultPullRequest.StateEnum.StateEnumAdapter.class)
  ...
  private RestAutoMergeProcessingResultPullRequestToRef toRef;
  ...
  public RestAutoMergeProcessingResultPullRequest closed(Boolean closed) {
    this.closed = closed;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequest closedDate(Long closedDate) {
  ...
  public RestAutoMergeProcessingResultPullRequest createdDate(Long createdDate) {
  ...
  public RestAutoMergeProcessingResultPullRequest description(String description) {
  ...
  public RestAutoMergeProcessingResultPullRequest draft(Boolean draft) {
    this.draft = draft;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequest fromRef(RestAutoMergeProcessingResultPullRequestFromRef fromRef) {
   ...
   **/
  @Valid
  public RestAutoMergeProcessingResultPullRequestFromRef getFromRef() {
    return fromRef;
  }

  public void setFromRef(RestAutoMergeProcessingResultPullRequestFromRef fromRef) {
    this.fromRef = fromRef;
  }

  public RestAutoMergeProcessingResultPullRequest htmlDescription(String htmlDescription) {
  ...
  public RestAutoMergeProcessingResultPullRequest id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequest links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequest locked(Boolean locked) {
    this.locked = locked;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequest open(Boolean open) {
    this.open = open;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequest participants(List<RestPullRequestParticipant> participants) {
    this.participants = participants;
    return this;
  }

  public RestAutoMergeProcessingResultPullRequest addParticipantsItem(RestPullRequestParticipant participantsItem) {
  ...
  public RestAutoMergeProcessingResultPullRequest reviewers(List<RestPullRequestParticipant> reviewers) {
    this.reviewers = reviewers;
    return this;
  }

  public RestAutoMergeProcessingResultPullRequest addReviewersItem(RestPullRequestParticipant reviewersItem) {
  ...
  public RestAutoMergeProcessingResultPullRequest state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequest toRef(RestAutoMergeProcessingResultPullRequestToRef toRef) {
    this.toRef = toRef;
    return this;
  }
   ...
   **/
  @Valid
  public RestAutoMergeProcessingResultPullRequestToRef getToRef() {
    return toRef;
  }

  public void setToRef(RestAutoMergeProcessingResultPullRequestToRef toRef) {
    this.toRef = toRef;
  }

  public RestAutoMergeProcessingResultPullRequest updatedDate(Long updatedDate) {
  ...
  public RestAutoMergeProcessingResultPullRequest version(Integer version) {
  ...
  public String toString() {
    ...
    sb.append("class RestAutoMergeProcessingResultPullRequest {");
