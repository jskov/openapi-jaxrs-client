...
public class RestPullRequestSuggestionRepositoryOrigin {
    ...
    private RestPullRequestSuggestionRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestSuggestionRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestPullRequestSuggestionRepositoryOrigin archived(Boolean archived) {
    ...
    public RestPullRequestSuggestionRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestPullRequestSuggestionRepositoryOrigin description(String description) {
    ...
    public RestPullRequestSuggestionRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestPullRequestSuggestionRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestPullRequestSuggestionRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryOrigin partition(Integer partition) {
    ...
    public RestPullRequestSuggestionRepositoryOrigin project(RestPullRequestSuggestionRepositoryOriginProject project) {
     ...
     * @return project
     **/
    public @Valid RestPullRequestSuggestionRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestPullRequestSuggestionRepositoryOriginProject project) {
        this.project = project;
    }

    public RestPullRequestSuggestionRepositoryOrigin public_(Boolean public_) {
    ...
    public RestPullRequestSuggestionRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestPullRequestSuggestionRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestSuggestionRepositoryOrigin)) {
            return false;
        }
        RestPullRequestSuggestionRepositoryOrigin other = (RestPullRequestSuggestionRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestSuggestionRepositoryOrigin {");
