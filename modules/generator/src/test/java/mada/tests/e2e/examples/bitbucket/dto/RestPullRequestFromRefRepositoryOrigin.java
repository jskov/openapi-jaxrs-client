...
public class RestPullRequestFromRefRepositoryOrigin {
    ...
    private RestPullRequestFromRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestFromRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestPullRequestFromRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestPullRequestFromRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestPullRequestFromRefRepositoryOrigin description(String description) {
    ...
    public RestPullRequestFromRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestPullRequestFromRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestPullRequestFromRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestPullRequestFromRefRepositoryOrigin project(RestPullRequestFromRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    public @Valid RestPullRequestFromRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestPullRequestFromRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestPullRequestFromRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestPullRequestFromRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestPullRequestFromRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestFromRefRepositoryOrigin)) {
            return false;
        }
        RestPullRequestFromRefRepositoryOrigin other = (RestPullRequestFromRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestFromRefRepositoryOrigin {");
