...
/**
 * _ResponseApiLatestProjects
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestProjects {
    ...
    private List<RestProject> values;

    public _ResponseApiLatestProjects isLastPage(Boolean isLastPage) {
    ...
    public _ResponseApiLatestProjects limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestProjects nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseApiLatestProjects size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestProjects start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseApiLatestProjects values(List<RestProject> values) {
        this.values = values;
        return this;
    }

    public _ResponseApiLatestProjects addValuesItem(RestProject valuesItem) {
        if (this.values == null) {
     ...
     * @return values
     **/
    @Valid public List<RestProject> getValues() {
        return values;
    }

    public void setValues(List<RestProject> values) {
        this.values = values;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseApiLatestProjects)) {
            return false;
        }
        _ResponseApiLatestProjects other = (_ResponseApiLatestProjects) o;
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestProjects {");
