...
public class RestRefRestrictionMatcherType {
  public enum IdEnum {
    ANY_REF("ANY_REF"),
    BRANCH("BRANCH"),
    PATTERN("PATTERN"),
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRefRestrictionMatcherType.IdEnum.IdEnumAdapter.class)
  private IdEnum id;
  ...
  public RestRefRestrictionMatcherType id(IdEnum id) {
    this.id = id;
    return this;
  }
  ...
  public RestRefRestrictionMatcherType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RestRefRestrictionMatcherType {");
