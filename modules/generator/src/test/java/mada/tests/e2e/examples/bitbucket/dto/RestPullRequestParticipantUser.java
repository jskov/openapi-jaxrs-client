...
public class RestPullRequestParticipantUser {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestParticipantUser.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestPullRequestParticipantUser active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestPullRequestParticipantUser avatarUrl(String avatarUrl) {
  ...
  public RestPullRequestParticipantUser displayName(String displayName) {
  ...
  public RestPullRequestParticipantUser emailAddress(String emailAddress) {
  ...
  public RestPullRequestParticipantUser id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestPullRequestParticipantUser links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestPullRequestParticipantUser name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestPullRequestParticipantUser slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestPullRequestParticipantUser type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestPullRequestParticipantUser)) {
      return false;
    }
    RestPullRequestParticipantUser other = (RestPullRequestParticipantUser) o;
  ...
  public String toString() {
    ...
    sb.append("class RestPullRequestParticipantUser {");
