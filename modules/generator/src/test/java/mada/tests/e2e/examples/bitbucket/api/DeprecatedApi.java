...
public interface DeprecatedApi {
    ...
    /**
     * Add user to group. <strong>Deprecated since 2.10</strong>. Use /rest/users/add-groups instead.
     * 
    ...
    /**
     * Remove user from group. <strong>Deprecated since 2.10</strong>. Use /rest/users/remove-groups instead.
     * 
     ...
     * <em>itemName</em> attributes of the supplied request entity reversed. On the face of it this may appear redundant,
     * but it facilitates a specific UI component in the application.
     * 
    ...
    /**
     * Get default branch. Retrieves the repository's default branch, if it has been created. If the repository is empty,
     * 204 No Content will be returned. For non-empty repositories, if the configured default branch has not yet been
     * created a 404 Not Found will be returned.
     * 
    ...
    /**
     * Update default branch. Update the default branch of a repository.
     * 
    ...
    /**
     * Approve pull request. Approve a pull request as the current user. Implicitly adds the user as a participant if they
     * are not already.
     * 
    ...
    /**
     * Unapprove pull request. Remove approval from a pull request as the current user. This does not remove the user as a
     * participant.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
    ...
    /**
     * Get pull request tasks. Retrieve the tasks associated with a pull request.
     ** 
    ...
    /**
     * Get pull request task count. Retrieve the total number of OPEN and RESOLVED tasks associated with a pull request.
     * 
     ...
     * 
     * <strong>Removed in 8.0</strong>. Tasks are now managed using Comments with severity BLOCKER. Call
     * <code>POST /rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/pull-requests/{pullRequestId}/comments</code>
    ...
    /**
     * Get task. Retrieve an existing task.
     * 
     * <strong>Removed in 8.0</strong>. Tasks are now managed using Comments with BLOCKER severity. Call
     * <code>GET /rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/pull-requests/{pullRequestId}/comments/{commentId} </code>instead. @deprecated
     * since 7.2, changed to 404 in 8.0, remove in 9.0. Call GET
     ...
     * 
     * <strong>Removed in 8.0</strong>. Tasks are now managed using Comments with BLOCKER severity. Call
     * <code>PUT /rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/pull-requests/{pullRequestId}/comments/{commentId} </code>
     * instead. To resolve a task, pass the attribute 'state' set to 'RESOLVED'. @deprecated since 7.2, changed to 404 in
     * 8.0, remove in 9.0. Call
     * <code>PUT  /rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/pull-requests/{pullRequestId}/comments/{commentId}
    </code> instead.
     * 
     * As of Stash 3.3, only the state and text of a task can be updated.
     * 
     * Updating the state of a task is allowed for any user having <em>READ</em> access to the repository. However only the
     * task's creator, the context's author or an admin of the context's repository can update the task's text. (For a pull
     * request task, those are the task's creator, the pull request's author or an admin on the repository containing the
     * pull request). Additionally the task's text cannot be updated if it has been resolved.
     *
     ...
     * 
     * <strong>Removed in 8.0</strong>. Tasks are now managed using Comments with BLOCKER severity. Call
     * <code>DELETE /rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/pull-requests/{pullRequestId}/comments/{commentId}</code>instead. @deprecated
     * since 7.2, changed to 404 in 8.0, remove in 9.0. Call DELETE
     * /rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/pull-requests/{pullRequestId}/comments/{commentId}
     * instead.
     * 
     * Note that only the task's creator, the context's author or an admin of the context's repository can delete a task.
     * (For a pull request task, those are the task's creator, the pull request's author or an admin on the repository
     * containing the pull request). Additionally a task cannot be deleted if it has already been resolved.
     *
    ...
    /**
     * Get build statuses for commit. Gets build statuses associated with a commit.
     * 
    ...
    /**
     * Create build status for commit. Associates a build status with a commit.The <code>state</code>, the <code>key</code>
     * and the <code>url</code> fields are mandatory. The <code>name</code> and<code>description</code> fields are
     * optional.All fields (mandatory or optional) are limited to 255 characters, except for the <code>url</code>,which is
     * limited to 450 characters.Supported values for the <code>state</code> are <code>SUCCESSFUL</code>,
     * <code>FAILED</code>and <code>INPROGRESS</code>.The authenticated user must have <strong>LICENSED</strong> permission
    ...
    /**
     * Get comment likes. Get a page of users who liked a commit comment in the specified repository, identified by
     * <code>commitId</code> and <code>commentId</code>.
     * 
     * The authenticated user must have the **REPO_READ** (or higher) permission for the specified repository to access this
     * resource.
     * 
    ...
    /**
     * Like a commit comment. Like a commit comment in the specified repository, identified by <code>commitId</code> and
     * <code>commentId</code>.
     * 
    ...
    /**
     * Unlike a commit comment. Unlike a commit comment in the specified repository, identified by <code>commitId</code> and
     * <code>commentId</code>.
     * 
     * The authenticated user must have the <strong>REPO_READ</strong> (or higher) permission for the specified repository
     * to access this resource.
    ...
    /**
     * Get pull request comment likes. Get a page of users who liked a pull request comment in the specified repository,
     * identified by <code>pullRequestId</code> and <code>commentId</code>.
     * 
     * The authenticated user must have the <strong>REPO_READ</strong> (or higher) permission for the specified repository
     * to access this resource.
     ** 
    ...
    /**
     * Like a pull request comment. Like a pull request comment in the specified repository, identified by
     * <code>pullRequestId</code> and <code>commentId</code>. The like will be recorded against the requesting user.
     * 
     * The authenticated user must have the <strong>REPO_READ</strong> (or higher) permission for the specified repository
     * to access this resource.
     ** 
    ...
    /**
     * Unlike a pull request comment. Unlike a pull request comment in the specified repository, identified by
     ...
     * from 4.6.0, mirrors no longer specify a disabled lifecycle callback in their addon descriptor. Prior to 4.6.0, this
     * was the callback method that was called when the mirroring atlassian-connect add-on has been disabled in the upstream
     * server identified by <code> upstreamId</code>.
     *
     ...
     * from 4.6.0, mirrors no longer specify an enabled lifecycle callback in their addon descriptor. Prior to 4.6.0, this
     * was the callback method that was called when the mirroring atlassian-connect add-on has been enabled in the upstream
     * server identified by <code>upstreamId</code>.
     *
     * @param upstreamId the upstream server ID to retrieve settings for (not null)
     */
    ...
    /**
     * Get upstream settings. This method is no longer supported
     *
    ...
    /**
     * Change upstream settings. This method is no longer supported
     *
