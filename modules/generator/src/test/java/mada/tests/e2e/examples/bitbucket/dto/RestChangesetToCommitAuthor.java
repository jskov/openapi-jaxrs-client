...
public class RestChangesetToCommitAuthor {
  ...
  public RestChangesetToCommitAuthor avatarUrl(String avatarUrl) {
  ...
  public RestChangesetToCommitAuthor emailAddress(String emailAddress) {
  ...
  public RestChangesetToCommitAuthor name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestChangesetToCommitAuthor)) {
      return false;
    }
    RestChangesetToCommitAuthor other = (RestChangesetToCommitAuthor) o;
  ...
  public String toString() {
    ...
    sb.append("class RestChangesetToCommitAuthor {");
