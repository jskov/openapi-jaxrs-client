...
public class RestChangesetRepository {
  ...
  @Schema(readOnly = true)
  private RestChangesetRepositoryOrigin origin;
  ...
  private RestChangesetRepositoryProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestChangesetRepository.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestChangesetRepository archived(Boolean archived) {
  ...
  public RestChangesetRepository defaultBranch(String defaultBranch) {
  ...
  public RestChangesetRepository description(String description) {
  ...
  public RestChangesetRepository forkable(Boolean forkable) {
  ...
  public RestChangesetRepository hierarchyId(String hierarchyId) {
  ...
  public RestChangesetRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestChangesetRepository links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestChangesetRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestChangesetRepository origin(RestChangesetRepositoryOrigin origin) {
    this.origin = origin;
    return this;
  }
   ...
   **/
  @Valid
  public RestChangesetRepositoryOrigin getOrigin() {
    return origin;
  }

  public void setOrigin(RestChangesetRepositoryOrigin origin) {
    this.origin = origin;
  }

  public RestChangesetRepository partition(Integer partition) {
  ...
  public RestChangesetRepository project(RestChangesetRepositoryProject project) {
   ...
   **/
  @Valid
  public RestChangesetRepositoryProject getProject() {
    return project;
  }

  public void setProject(RestChangesetRepositoryProject project) {
    this.project = project;
  }

  public RestChangesetRepository public_(Boolean public_) {
  ...
  public RestChangesetRepository relatedLinks(Object relatedLinks) {
  ...
  public RestChangesetRepository scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestChangesetRepository scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestChangesetRepository slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestChangesetRepository state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestChangesetRepository statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestChangesetRepository)) {
      return false;
    }
    RestChangesetRepository other = (RestChangesetRepository) o;
  ...
  public String toString() {
    ...
    sb.append("class RestChangesetRepository {");
