...
public class _ResponseApiLatestProjectsProjectKeyReposRepositorySlugRefChangeActivities {
   ...
   * @return values
   **/
  public List<@Valid RestRepositoryRefChangeActivity> getValues() {
    return values;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof _ResponseApiLatestProjectsProjectKeyReposRepositorySlugRefChangeActivities other) {
