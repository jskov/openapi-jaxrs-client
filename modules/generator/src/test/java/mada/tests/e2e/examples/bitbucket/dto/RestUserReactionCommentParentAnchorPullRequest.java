...
public class RestUserReactionCommentParentAnchorPullRequest {
  ...
  private RestUserReactionCommentParentAnchorPullRequestFromRef fromRef;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentParentAnchorPullRequest.StateEnum.StateEnumAdapter.class)
  ...
  private RestUserReactionCommentParentAnchorPullRequestToRef toRef;
  ...
  public RestUserReactionCommentParentAnchorPullRequest closed(Boolean closed) {
    this.closed = closed;
    return this;
  }
  ...
  public RestUserReactionCommentParentAnchorPullRequest closedDate(Long closedDate) {
  ...
  public RestUserReactionCommentParentAnchorPullRequest createdDate(Long createdDate) {
  ...
  public RestUserReactionCommentParentAnchorPullRequest description(String description) {
  ...
  public RestUserReactionCommentParentAnchorPullRequest draft(Boolean draft) {
    this.draft = draft;
    return this;
  }
  ...
  public RestUserReactionCommentParentAnchorPullRequest fromRef(RestUserReactionCommentParentAnchorPullRequestFromRef fromRef) {
   ...
   **/
  @Valid
  public RestUserReactionCommentParentAnchorPullRequestFromRef getFromRef() {
    return fromRef;
  }

  public void setFromRef(RestUserReactionCommentParentAnchorPullRequestFromRef fromRef) {
    this.fromRef = fromRef;
  }

  public RestUserReactionCommentParentAnchorPullRequest htmlDescription(String htmlDescription) {
  ...
  public RestUserReactionCommentParentAnchorPullRequest id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public RestUserReactionCommentParentAnchorPullRequest links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestUserReactionCommentParentAnchorPullRequest locked(Boolean locked) {
    this.locked = locked;
    return this;
  }
  ...
  public RestUserReactionCommentParentAnchorPullRequest open(Boolean open) {
    this.open = open;
    return this;
  }
  ...
  public RestUserReactionCommentParentAnchorPullRequest participants(List<RestPullRequestParticipant> participants) {
    this.participants = participants;
    return this;
  }

  public RestUserReactionCommentParentAnchorPullRequest addParticipantsItem(RestPullRequestParticipant participantsItem) {
  ...
  public RestUserReactionCommentParentAnchorPullRequest reviewers(List<RestPullRequestParticipant> reviewers) {
    this.reviewers = reviewers;
    return this;
  }

  public RestUserReactionCommentParentAnchorPullRequest addReviewersItem(RestPullRequestParticipant reviewersItem) {
  ...
  public RestUserReactionCommentParentAnchorPullRequest state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestUserReactionCommentParentAnchorPullRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public RestUserReactionCommentParentAnchorPullRequest toRef(RestUserReactionCommentParentAnchorPullRequestToRef toRef) {
    this.toRef = toRef;
    return this;
  }
   ...
   **/
  @Valid
  public RestUserReactionCommentParentAnchorPullRequestToRef getToRef() {
    return toRef;
  }

  public void setToRef(RestUserReactionCommentParentAnchorPullRequestToRef toRef) {
    this.toRef = toRef;
  }

  public RestUserReactionCommentParentAnchorPullRequest updatedDate(Long updatedDate) {
  ...
  public RestUserReactionCommentParentAnchorPullRequest version(Integer version) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestUserReactionCommentParentAnchorPullRequest)) {
      return false;
    }
    RestUserReactionCommentParentAnchorPullRequest other = (RestUserReactionCommentParentAnchorPullRequest) o;
  ...
  public String toString() {
    ...
    sb.append("class RestUserReactionCommentParentAnchorPullRequest {");
