...
public class RestCommentThreadResolver {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentThreadResolver.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestCommentThreadResolver active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public RestCommentThreadResolver avatarUrl(String avatarUrl) {
    ...
    public RestCommentThreadResolver displayName(String displayName) {
    ...
    public RestCommentThreadResolver emailAddress(String emailAddress) {
    ...
    public RestCommentThreadResolver id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentThreadResolver links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentThreadResolver name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentThreadResolver slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestCommentThreadResolver type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentThreadResolver)) {
            return false;
        }
        RestCommentThreadResolver other = (RestCommentThreadResolver) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentThreadResolver {");
