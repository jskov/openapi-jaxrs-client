...
public class RestAutoMergeProcessingResultPullRequestToRefRepository {
    ...
    @Schema(readOnly = true)
    private RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin origin;
    ...
    private RestAutoMergeProcessingResultPullRequestToRefRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestAutoMergeProcessingResultPullRequestToRefRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository archived(Boolean archived) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository defaultBranch(String defaultBranch) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository description(String description) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository forkable(Boolean forkable) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository hierarchyId(String hierarchyId) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository origin(RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    public @Valid RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestAutoMergeProcessingResultPullRequestToRefRepository partition(Integer partition) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository project(RestAutoMergeProcessingResultPullRequestToRefRepositoryProject project) {
     ...
     * @return project
     **/
    public @Valid RestAutoMergeProcessingResultPullRequestToRefRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestAutoMergeProcessingResultPullRequestToRefRepositoryProject project) {
        this.project = project;
    }

    public RestAutoMergeProcessingResultPullRequestToRefRepository public_(Boolean public_) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository relatedLinks(Object relatedLinks) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestAutoMergeProcessingResultPullRequestToRefRepository)) {
            return false;
        }
        RestAutoMergeProcessingResultPullRequestToRefRepository other = (RestAutoMergeProcessingResultPullRequestToRefRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestAutoMergeProcessingResultPullRequestToRefRepository {");
