...
public interface Api_DocsApi {
   ...
   * @param item  (optional)
   * @param dto dto description (not null)
   * @return String
   */
  @GET
  @Path("/params/{in-path}")
  ...
  String apiDocsParamsInPathGet(@PathParam("in-path") @NotNull String inPath, @QueryParam("query") String query, @QueryParam("query-deprecated") String queryDeprecated, @HeaderParam("item") List<String> item, @NotNull @Valid Simple dto);
