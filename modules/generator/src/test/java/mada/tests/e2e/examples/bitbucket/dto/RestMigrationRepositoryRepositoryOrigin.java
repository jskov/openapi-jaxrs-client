...
public class RestMigrationRepositoryRepositoryOrigin {
  ...
  private RestMigrationRepositoryRepositoryOriginProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestMigrationRepositoryRepositoryOrigin.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestMigrationRepositoryRepositoryOrigin archived(Boolean archived) {
  ...
  public RestMigrationRepositoryRepositoryOrigin defaultBranch(String defaultBranch) {
  ...
  public RestMigrationRepositoryRepositoryOrigin description(String description) {
  ...
  public RestMigrationRepositoryRepositoryOrigin forkable(Boolean forkable) {
  ...
  public RestMigrationRepositoryRepositoryOrigin hierarchyId(String hierarchyId) {
  ...
  public RestMigrationRepositoryRepositoryOrigin id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryOrigin links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryOrigin name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryOrigin partition(Integer partition) {
  ...
  public RestMigrationRepositoryRepositoryOrigin project(RestMigrationRepositoryRepositoryOriginProject project) {
   ...
   **/
  @Valid
  public RestMigrationRepositoryRepositoryOriginProject getProject() {
    return project;
  }

  public void setProject(RestMigrationRepositoryRepositoryOriginProject project) {
    this.project = project;
  }

  public RestMigrationRepositoryRepositoryOrigin public_(Boolean public_) {
  ...
  public RestMigrationRepositoryRepositoryOrigin relatedLinks(Object relatedLinks) {
  ...
  public RestMigrationRepositoryRepositoryOrigin scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryOrigin scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryOrigin slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryOrigin state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryOrigin statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestMigrationRepositoryRepositoryOrigin)) {
      return false;
    }
    RestMigrationRepositoryRepositoryOrigin other = (RestMigrationRepositoryRepositoryOrigin) o;
  ...
  public String toString() {
    ...
    sb.append("class RestMigrationRepositoryRepositoryOrigin {");
