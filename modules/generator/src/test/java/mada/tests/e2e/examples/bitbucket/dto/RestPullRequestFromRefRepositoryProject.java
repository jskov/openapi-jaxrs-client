...
public class RestPullRequestFromRefRepositoryProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestFromRefRepositoryProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestPullRequestFromRefRepositoryProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryProject avatarUrl(String avatarUrl) {
    ...
    public RestPullRequestFromRefRepositoryProject description(String description) {
    ...
    public RestPullRequestFromRefRepositoryProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryProject key(String key) {
    ...
    public RestPullRequestFromRefRepositoryProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryProject namespace(String namespace) {
    ...
    public RestPullRequestFromRefRepositoryProject public_(Boolean public_) {
    ...
    public RestPullRequestFromRefRepositoryProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestPullRequestFromRefRepositoryProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestFromRefRepositoryProject)) {
            return false;
        }
        RestPullRequestFromRefRepositoryProject other = (RestPullRequestFromRefRepositoryProject) o;
