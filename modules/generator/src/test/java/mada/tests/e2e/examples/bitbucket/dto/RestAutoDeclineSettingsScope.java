...
public class RestAutoDeclineSettingsScope {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestAutoDeclineSettingsScope.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestAutoDeclineSettingsScope resourceId(Integer resourceId) {
    ...
    public RestAutoDeclineSettingsScope type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestAutoDeclineSettingsScope {");
