...
public class RestDetailedUser {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(active, avatarUrl, deletable, directoryName, displayName, emailAddress, id, lastAuthenticationTimestamp, links, mutableDetails, mutableGroups, name, slug, type);
    }
