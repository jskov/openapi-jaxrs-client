...
public class RestChangesetRepositoryOrigin {
    ...
    private RestChangesetRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestChangesetRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestChangesetRepositoryOrigin archived(Boolean archived) {
    ...
    public RestChangesetRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestChangesetRepositoryOrigin description(String description) {
    ...
    public RestChangesetRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestChangesetRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestChangesetRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestChangesetRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestChangesetRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestChangesetRepositoryOrigin partition(Integer partition) {
    ...
    public RestChangesetRepositoryOrigin project(RestChangesetRepositoryOriginProject project) {
     ...
     **/
    @Valid
    public RestChangesetRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestChangesetRepositoryOriginProject project) {
        this.project = project;
    }

    public RestChangesetRepositoryOrigin public_(Boolean public_) {
    ...
    public RestChangesetRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestChangesetRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestChangesetRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestChangesetRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestChangesetRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestChangesetRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestChangesetRepositoryOrigin)) {
            return false;
        }
        RestChangesetRepositoryOrigin other = (RestChangesetRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestChangesetRepositoryOrigin {");
