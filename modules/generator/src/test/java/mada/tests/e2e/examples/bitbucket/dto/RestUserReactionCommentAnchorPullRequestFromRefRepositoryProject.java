...
public class RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject avatarUrl(String avatarUrl) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject description(String description) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject key(String key) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject namespace(String namespace) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject public_(Boolean public_) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject)) {
            return false;
        }
        RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject other = (RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject {");
