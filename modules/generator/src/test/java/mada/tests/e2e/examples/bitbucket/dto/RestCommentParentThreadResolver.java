...
public class RestCommentParentThreadResolver {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentThreadResolver.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestCommentParentThreadResolver active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestCommentParentThreadResolver avatarUrl(String avatarUrl) {
  ...
  public RestCommentParentThreadResolver displayName(String displayName) {
  ...
  public RestCommentParentThreadResolver emailAddress(String emailAddress) {
  ...
  public RestCommentParentThreadResolver id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestCommentParentThreadResolver links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestCommentParentThreadResolver name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCommentParentThreadResolver slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestCommentParentThreadResolver type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestCommentParentThreadResolver)) {
      return false;
    }
    RestCommentParentThreadResolver other = (RestCommentParentThreadResolver) o;
  ...
  public String toString() {
    ...
    sb.append("class RestCommentParentThreadResolver {");
