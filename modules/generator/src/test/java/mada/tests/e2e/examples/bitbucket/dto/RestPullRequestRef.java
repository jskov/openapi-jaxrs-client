...
public class RestPullRequestRef {
    ...
    private RestPullRequestRefRepository repository;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestRef.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestPullRequestRef displayId(String displayId) {
    ...
    public RestPullRequestRef id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestRef latestCommit(String latestCommit) {
    ...
    public RestPullRequestRef repository(RestPullRequestRefRepository repository) {
     ...
     * @return repository
     **/
    @Valid public RestPullRequestRefRepository getRepository() {
        return repository;
    }

    public void setRepository(RestPullRequestRefRepository repository) {
        this.repository = repository;
    }

    public RestPullRequestRef type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestRef)) {
            return false;
        }
        RestPullRequestRef other = (RestPullRequestRef) o;
