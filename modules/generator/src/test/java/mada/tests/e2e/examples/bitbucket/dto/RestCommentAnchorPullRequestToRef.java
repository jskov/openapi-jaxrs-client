...
public class RestCommentAnchorPullRequestToRef {
    ...
    private RestCommentAnchorPullRequestToRefRepository repository;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequestToRef.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestCommentAnchorPullRequestToRef displayId(String displayId) {
    ...
    public RestCommentAnchorPullRequestToRef id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRef latestCommit(String latestCommit) {
    ...
    public RestCommentAnchorPullRequestToRef repository(RestCommentAnchorPullRequestToRefRepository repository) {
     ...
     * @return repository
     **/
    public @Valid RestCommentAnchorPullRequestToRefRepository getRepository() {
        return repository;
    }

    public void setRepository(RestCommentAnchorPullRequestToRefRepository repository) {
        this.repository = repository;
    }

    public RestCommentAnchorPullRequestToRef type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorPullRequestToRef {");
