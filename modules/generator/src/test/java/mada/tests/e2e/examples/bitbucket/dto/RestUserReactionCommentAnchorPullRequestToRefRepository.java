...
public class RestUserReactionCommentAnchorPullRequestToRefRepository {
    ...
    @Schema(readOnly = true)
    private RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin origin;
    ...
    private RestUserReactionCommentAnchorPullRequestToRefRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAnchorPullRequestToRefRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository archived(Boolean archived) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository defaultBranch(String defaultBranch) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository description(String description) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository forkable(Boolean forkable) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository hierarchyId(String hierarchyId) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository origin(RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    @Valid public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestUserReactionCommentAnchorPullRequestToRefRepository partition(Integer partition) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository project(RestUserReactionCommentAnchorPullRequestToRefRepositoryProject project) {
     ...
     * @return project
     **/
    @Valid public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestUserReactionCommentAnchorPullRequestToRefRepositoryProject project) {
        this.project = project;
    }

    public RestUserReactionCommentAnchorPullRequestToRefRepository public_(Boolean public_) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository relatedLinks(Object relatedLinks) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentAnchorPullRequestToRefRepository)) {
            return false;
        }
        RestUserReactionCommentAnchorPullRequestToRefRepository other = (RestUserReactionCommentAnchorPullRequestToRefRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentAnchorPullRequestToRefRepository {");
