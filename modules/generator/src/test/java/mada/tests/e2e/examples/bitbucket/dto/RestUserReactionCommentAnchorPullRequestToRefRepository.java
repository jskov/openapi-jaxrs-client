...
public class RestUserReactionCommentAnchorPullRequestToRefRepository {
   ...
   **/
  @Valid
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin getOrigin() {
    return origin;
  }
   ...
   **/
  @Valid
  public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject getProject() {
    return project;
  }
