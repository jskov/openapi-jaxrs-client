...
public class RestUserReactionCommentAnchorPullRequestToRefRepository {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository origin(
            RestUserReactionCommentAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepository project(
            RestUserReactionCommentAnchorPullRequestToRefRepositoryProject project) {
