...
public class RestCommentThreadDiffAnchorPath {
  ...
  public RestCommentThreadDiffAnchorPath components(List<String> components) {
    this.components = components;
    return this;
  }

  public RestCommentThreadDiffAnchorPath addComponentsItem(String componentsItem) {
  ...
  public RestCommentThreadDiffAnchorPath extension(String extension) {
  ...
  public RestCommentThreadDiffAnchorPath name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPath parent(String parent) {
    this.parent = parent;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RestCommentThreadDiffAnchorPath {");
