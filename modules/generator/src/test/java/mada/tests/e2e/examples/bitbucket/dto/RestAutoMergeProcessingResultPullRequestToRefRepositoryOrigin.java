...
public class RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin {
    ...
    private RestAutoMergeProcessingResultPullRequestToRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin description(String description) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin project(RestAutoMergeProcessingResultPullRequestToRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    public @Valid RestAutoMergeProcessingResultPullRequestToRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestAutoMergeProcessingResultPullRequestToRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin)) {
            return false;
        }
        RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin other = (RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestAutoMergeProcessingResultPullRequestToRefRepositoryOrigin {");
