...
public class RestCommentParentAuthor {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentAuthor.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestCommentParentAuthor active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestCommentParentAuthor avatarUrl(String avatarUrl) {
  ...
  public RestCommentParentAuthor displayName(String displayName) {
  ...
  public RestCommentParentAuthor emailAddress(String emailAddress) {
  ...
  public RestCommentParentAuthor id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestCommentParentAuthor links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestCommentParentAuthor name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCommentParentAuthor slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestCommentParentAuthor type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestCommentParentAuthor)) {
      return false;
    }
    RestCommentParentAuthor other = (RestCommentParentAuthor) o;
  ...
  public String toString() {
    ...
    sb.append("class RestCommentParentAuthor {");
