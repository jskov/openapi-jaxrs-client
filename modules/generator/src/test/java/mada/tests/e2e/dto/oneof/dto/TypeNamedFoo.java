...
public class TypeNamedFoo extends AbstractTypeBySchemaName {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof TypeNamedFoo)) {
      return false;
    }
    TypeNamedFoo other = (TypeNamedFoo) o;
