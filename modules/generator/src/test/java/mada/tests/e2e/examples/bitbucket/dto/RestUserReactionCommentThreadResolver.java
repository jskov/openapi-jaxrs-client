...
public class RestUserReactionCommentThreadResolver {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentThreadResolver.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestUserReactionCommentThreadResolver active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public RestUserReactionCommentThreadResolver avatarUrl(String avatarUrl) {
    ...
    public RestUserReactionCommentThreadResolver displayName(String displayName) {
    ...
    public RestUserReactionCommentThreadResolver emailAddress(String emailAddress) {
    ...
    public RestUserReactionCommentThreadResolver id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentThreadResolver links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentThreadResolver name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentThreadResolver slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestUserReactionCommentThreadResolver type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentThreadResolver)) {
            return false;
        }
        RestUserReactionCommentThreadResolver other = (RestUserReactionCommentThreadResolver) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentThreadResolver {");
