...
/**
 * _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles {
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles isLastPage(Boolean isLastPage) {
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles values(List<FileListResource> values) {
        this.values = values;
        return this;
    }

    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles addValuesItem(FileListResource valuesItem) {
        if (this.values == null) {
     ...
     * @return values
     **/
    public @Valid List<FileListResource> getValues() {
        return values;
    }
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles {");
