...
package mada.tests.e2e.opts.generator.types.noformat_int.dto;
...
public class Primitives {
  ...
  public static final String JSON_PROPERTY_NO_FORMAT = "noFormat";
  @JsonbProperty(JSON_PROPERTY_NO_FORMAT)
  ...
  public Primitives noFormat(Integer noFormat) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aBoolean, other.aBoolean) &&
        ...
        Objects.equals(this.noFormat, other.noFormat) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aBoolean, aByte, aDouble, aFloat, aLong, anInt, aString, noFormat, object, plainObject);
  }
  ...
  public String toString() {
    ...
    sb.append("\n    noFormat: ").append(toIndentedString(noFormat));
