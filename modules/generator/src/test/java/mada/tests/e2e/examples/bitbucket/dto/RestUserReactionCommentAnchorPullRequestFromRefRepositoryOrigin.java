...
public class RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin {
    ...
    private RestUserReactionCommentAnchorPullRequestFromRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin description(String description) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin project(RestUserReactionCommentAnchorPullRequestFromRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    @Valid public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestUserReactionCommentAnchorPullRequestFromRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin)) {
            return false;
        }
        RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin other = (RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin {");
