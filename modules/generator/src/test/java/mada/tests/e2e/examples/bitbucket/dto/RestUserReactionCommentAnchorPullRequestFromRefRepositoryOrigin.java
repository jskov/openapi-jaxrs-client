...
public class RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin project(
            RestUserReactionCommentAnchorPullRequestFromRefRepositoryOriginProject project) {
