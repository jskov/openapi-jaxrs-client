...
public class RestCommentParentAnchorPullRequestToRefRepositoryProject {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentAnchorPullRequestToRefRepositoryProject.TypeEnum.TypeEnumAdapter.class)
  @Schema(readOnly = true)
  private TypeEnum type;

  public RestCommentParentAnchorPullRequestToRefRepositoryProject avatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryProject avatarUrl(String avatarUrl) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryProject description(String description) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryProject id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryProject key(String key) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryProject links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryProject namespace(String namespace) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryProject public_(Boolean public_) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryProject scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryProject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestCommentParentAnchorPullRequestToRefRepositoryProject)) {
      return false;
    }
    RestCommentParentAnchorPullRequestToRefRepositoryProject other = (RestCommentParentAnchorPullRequestToRefRepositoryProject) o;
  ...
  public String toString() {
    ...
    sb.append("class RestCommentParentAnchorPullRequestToRefRepositoryProject {");
