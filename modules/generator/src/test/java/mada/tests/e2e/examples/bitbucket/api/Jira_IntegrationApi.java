...
public interface Jira_IntegrationApi {
    ...
    /**
     * Create Jira Issue. Create a Jira issue and associate it with a comment on a pull request.
     * 
     ...
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository containing the comment to
     * call this resource.
     * 
    ...
    /**
     * Get changesets for issue key. Retrieve a page of changesets associated with the given issue key.
     *
    ...
    /**
     * Get entity link. Retrieves the enchanced primary entitylink
     * 
     * The authenticated user must have <strong>PROJECT_READ</strong> permission for the project having the primary enhanced
     * entitylink.
     *
     * 
     * 
    ...
    /**
     * Get issues for a pull request. Retrieves Jira issue keys that are associated with the commits in the specified pull
     * request. The number of commits checked for issues is limited to a default of 100.
     *
     * @param projectKey     The project key (not null)
