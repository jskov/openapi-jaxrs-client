...
public class RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject avatarUrl(String avatarUrl) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject description(String description) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject key(String key) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject namespace(String namespace) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject public_(Boolean public_) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject)) {
            return false;
        }
        RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject other = (RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject {");
