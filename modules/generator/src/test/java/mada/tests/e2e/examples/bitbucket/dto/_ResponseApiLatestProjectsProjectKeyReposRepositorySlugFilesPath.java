...
/**
 * _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath {
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath)) {
            return false;
        }
        _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath other = (_ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath) o;
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath {");
