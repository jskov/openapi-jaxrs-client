...
package mada.tests.e2e.opts.generator.validation.requirenonnull.jsonb.dto;
 ...
 * Environment
 */
@JsonbTypeAdapter(mada.tests.e2e.opts.generator.validation.requirenonnull.jsonb.dto.Environment.EnvironmentAdapter.class)
