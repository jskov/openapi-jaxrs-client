...
public class RestPullRequestRefRepositoryProject {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestRefRepositoryProject.TypeEnum.TypeEnumAdapter.class)
  @Schema(readOnly = true)
  private TypeEnum type;

  public RestPullRequestRefRepositoryProject avatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public RestPullRequestRefRepositoryProject avatarUrl(String avatarUrl) {
  ...
  public RestPullRequestRefRepositoryProject description(String description) {
  ...
  public RestPullRequestRefRepositoryProject id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestPullRequestRefRepositoryProject key(String key) {
  ...
  public RestPullRequestRefRepositoryProject links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestPullRequestRefRepositoryProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestPullRequestRefRepositoryProject namespace(String namespace) {
  ...
  public RestPullRequestRefRepositoryProject public_(Boolean public_) {
  ...
  public RestPullRequestRefRepositoryProject scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestPullRequestRefRepositoryProject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestPullRequestRefRepositoryProject)) {
      return false;
    }
    RestPullRequestRefRepositoryProject other = (RestPullRequestRefRepositoryProject) o;
  ...
  public String toString() {
    ...
    sb.append("class RestPullRequestRefRepositoryProject {");
