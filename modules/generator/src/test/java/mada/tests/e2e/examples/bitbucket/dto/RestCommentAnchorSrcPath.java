...
public class RestCommentAnchorSrcPath {
    ...
    public RestCommentAnchorSrcPath components(List<String> components) {
        this.components = components;
        return this;
    }

    public RestCommentAnchorSrcPath addComponentsItem(String componentsItem) {
    ...
    public RestCommentAnchorSrcPath extension(String extension) {
    ...
    public RestCommentAnchorSrcPath name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentAnchorSrcPath parent(String parent) {
        this.parent = parent;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorSrcPath {");
