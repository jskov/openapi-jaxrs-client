...
public class RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin {
    ...
    private RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin description(String description) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin project(RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    @Valid public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin)) {
            return false;
        }
        RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin other = (RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin {");
