...
public class ExampleJsonLastModifiedCallbackPomXml {
    public static final String JSON_PROPERTY_AUTHOR = "author";
    @JsonbProperty(JSON_PROPERTY_AUTHOR)
    private ExampleJsonLastModifiedCallbackPomXmlAuthor author;
    ...
    private ExampleJsonLastModifiedCallbackPomXmlCommitter committer;
    ...
    public ExampleJsonLastModifiedCallbackPomXml author(ExampleJsonLastModifiedCallbackPomXmlAuthor author) {
        this.author = author;
        return this;
    }
     ...
     * @return author
     **/
    public @Valid ExampleJsonLastModifiedCallbackPomXmlAuthor getAuthor() {
        return author;
    }

    public void setAuthor(ExampleJsonLastModifiedCallbackPomXmlAuthor author) {
        this.author = author;
    }

    public ExampleJsonLastModifiedCallbackPomXml authorTimestamp(Long authorTimestamp) {
    ...
    public ExampleJsonLastModifiedCallbackPomXml committer(ExampleJsonLastModifiedCallbackPomXmlCommitter committer) {
     ...
     * @return committer
     **/
    public @Valid ExampleJsonLastModifiedCallbackPomXmlCommitter getCommitter() {
        return committer;
    }

    public void setCommitter(ExampleJsonLastModifiedCallbackPomXmlCommitter committer) {
        this.committer = committer;
    }

    public ExampleJsonLastModifiedCallbackPomXml committerTimestamp(Long committerTimestamp) {
    ...
    public ExampleJsonLastModifiedCallbackPomXml displayId(String displayId) {
    ...
    public ExampleJsonLastModifiedCallbackPomXml id(String id) {
        this.id = id;
        return this;
    }
    ...
    public ExampleJsonLastModifiedCallbackPomXml message(String message) {
    ...
    public ExampleJsonLastModifiedCallbackPomXml parents(List<RestMinimalCommit> parents) {
        this.parents = parents;
        return this;
    }

    public ExampleJsonLastModifiedCallbackPomXml addParentsItem(RestMinimalCommit parentsItem) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExampleJsonLastModifiedCallbackPomXml)) {
            return false;
        }
        ExampleJsonLastModifiedCallbackPomXml other = (ExampleJsonLastModifiedCallbackPomXml) o;
    ...
    public String toString() {
        ...
        sb.append("class ExampleJsonLastModifiedCallbackPomXml {");
