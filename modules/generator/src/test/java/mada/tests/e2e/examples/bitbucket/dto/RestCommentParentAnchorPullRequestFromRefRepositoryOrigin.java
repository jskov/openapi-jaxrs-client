...
public class RestCommentParentAnchorPullRequestFromRefRepositoryOrigin {
    ...
    private RestCommentParentAnchorPullRequestFromRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentAnchorPullRequestFromRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin description(String description) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin partition(Integer partition) {
     ...
     * @return project
     **/
    public @Valid RestCommentParentAnchorPullRequestFromRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestCommentParentAnchorPullRequestFromRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentParentAnchorPullRequestFromRefRepositoryOrigin)) {
            return false;
        }
        RestCommentParentAnchorPullRequestFromRefRepositoryOrigin other = (RestCommentParentAnchorPullRequestFromRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentParentAnchorPullRequestFromRefRepositoryOrigin {");
