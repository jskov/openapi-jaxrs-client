...
public class RestCommentThreadDiffAnchorPullRequestToRefRepository {
   ...
   **/
  @Valid
  public RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin getOrigin() {
    return origin;
  }
   ...
   **/
  @Valid
  public RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject getProject() {
    return project;
  }
