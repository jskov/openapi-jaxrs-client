...
public class RestCommentThreadDiffAnchorPullRequestToRefRepository {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository origin(
            RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository project(
            RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject project) {
