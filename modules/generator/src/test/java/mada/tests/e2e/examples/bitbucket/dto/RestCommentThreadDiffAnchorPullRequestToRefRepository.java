...
public class RestCommentThreadDiffAnchorPullRequestToRefRepository {
    ...
    @Schema(readOnly = true)
    private RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin origin;
    ...
    private RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentThreadDiffAnchorPullRequestToRefRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository archived(Boolean archived) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository defaultBranch(String defaultBranch) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository description(String description) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository forkable(Boolean forkable) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository hierarchyId(String hierarchyId) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository origin(RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    public @Valid RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestCommentThreadDiffAnchorPullRequestToRefRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestCommentThreadDiffAnchorPullRequestToRefRepository partition(Integer partition) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository project(RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject project) {
     ...
     * @return project
     **/
    public @Valid RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestCommentThreadDiffAnchorPullRequestToRefRepositoryProject project) {
        this.project = project;
    }

    public RestCommentThreadDiffAnchorPullRequestToRefRepository public_(Boolean public_) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository relatedLinks(Object relatedLinks) {
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestToRefRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentThreadDiffAnchorPullRequestToRefRepository)) {
            return false;
        }
        RestCommentThreadDiffAnchorPullRequestToRefRepository other = (RestCommentThreadDiffAnchorPullRequestToRefRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentThreadDiffAnchorPullRequestToRefRepository {");
