...
public class RestRateLimitSettingsDefaultSettings {
    ...
    public RestRateLimitSettingsDefaultSettings capacity(Integer capacity) {
    ...
    public RestRateLimitSettingsDefaultSettings fillRate(Integer fillRate) {
    ...
    public String toString() {
        ...
        sb.append("class RestRateLimitSettingsDefaultSettings {");
