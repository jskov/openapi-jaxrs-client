...
public class RestDefaultReviewersRequestTargetMatcherType {
    public enum IdEnum {
        ANY_REF("ANY_REF"),
        BRANCH("BRANCH"),
        PATTERN("PATTERN"),
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestDefaultReviewersRequestTargetMatcherType.IdEnum.IdEnumAdapter.class)
    private IdEnum id;
    ...
    public RestDefaultReviewersRequestTargetMatcherType id(IdEnum id) {
        this.id = id;
        return this;
    }
    ...
    public RestDefaultReviewersRequestTargetMatcherType name(String name) {
        this.name = name;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestDefaultReviewersRequestTargetMatcherType {");
