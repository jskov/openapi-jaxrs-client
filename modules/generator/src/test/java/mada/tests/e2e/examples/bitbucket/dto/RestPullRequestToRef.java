...
public class RestPullRequestToRef {
  ...
  private RestPullRequestToRefRepository repository;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestToRef.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestPullRequestToRef displayId(String displayId) {
  ...
  public RestPullRequestToRef id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestPullRequestToRef latestCommit(String latestCommit) {
  ...
  public RestPullRequestToRef repository(RestPullRequestToRefRepository repository) {
   ...
   **/
  @Valid
  public RestPullRequestToRefRepository getRepository() {
    return repository;
  }

  public void setRepository(RestPullRequestToRefRepository repository) {
    this.repository = repository;
  }

  public RestPullRequestToRef type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestPullRequestToRef)) {
      return false;
    }
    RestPullRequestToRef other = (RestPullRequestToRef) o;
  ...
  public String toString() {
    ...
    sb.append("class RestPullRequestToRef {");
