...
/**
 * RestApplySuggestionRequestSuggestionIndex
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class RestApplySuggestionRequestSuggestionIndex {
  ...
  public RestApplySuggestionRequestSuggestionIndex asInt(Integer asInt) {
    this.asInt = asInt;
    return this;
  }
  ...
  public RestApplySuggestionRequestSuggestionIndex present(Boolean present) {
  ...
  public String toString() {
    ...
    sb.append("class RestApplySuggestionRequestSuggestionIndex {");
