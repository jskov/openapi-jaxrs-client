...
public class RestMinimalRef {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestMinimalRef.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestMinimalRef displayId(String displayId) {
    ...
    public RestMinimalRef id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestMinimalRef type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestMinimalRef {");
