...
public class RestUserRateLimitSettingsSettings {
    ...
    public RestUserRateLimitSettingsSettings capacity(Integer capacity) {
    ...
    public RestUserRateLimitSettingsSettings fillRate(Integer fillRate) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserRateLimitSettingsSettings)) {
            return false;
        }
        RestUserRateLimitSettingsSettings other = (RestUserRateLimitSettingsSettings) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserRateLimitSettingsSettings {");
