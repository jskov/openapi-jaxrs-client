...
public class RestPermittedUserUser {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPermittedUserUser.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestPermittedUserUser active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestPermittedUserUser avatarUrl(String avatarUrl) {
  ...
  public RestPermittedUserUser displayName(String displayName) {
  ...
  public RestPermittedUserUser emailAddress(String emailAddress) {
  ...
  public RestPermittedUserUser id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestPermittedUserUser links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestPermittedUserUser name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestPermittedUserUser slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestPermittedUserUser type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RestPermittedUserUser {");
