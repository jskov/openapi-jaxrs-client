...
public class RestCommentAnchorPullRequest {
    ...
    private RestCommentAnchorPullRequestFromRef fromRef;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequest.StateEnum.StateEnumAdapter.class)
    ...
    private RestCommentAnchorPullRequestToRef toRef;
    ...
    public RestCommentAnchorPullRequest closed(Boolean closed) {
        this.closed = closed;
        return this;
    }
    ...
    public RestCommentAnchorPullRequest closedDate(Long closedDate) {
    ...
    public RestCommentAnchorPullRequest createdDate(Long createdDate) {
    ...
    public RestCommentAnchorPullRequest description(String description) {
    ...
    public RestCommentAnchorPullRequest draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public RestCommentAnchorPullRequest fromRef(RestCommentAnchorPullRequestFromRef fromRef) {
     ...
     * @return fromRef
     **/
    public @Valid RestCommentAnchorPullRequestFromRef getFromRef() {
        return fromRef;
    }

    public void setFromRef(RestCommentAnchorPullRequestFromRef fromRef) {
        this.fromRef = fromRef;
    }

    public RestCommentAnchorPullRequest htmlDescription(String htmlDescription) {
    ...
    public RestCommentAnchorPullRequest id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentAnchorPullRequest links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentAnchorPullRequest locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public RestCommentAnchorPullRequest open(Boolean open) {
        this.open = open;
        return this;
    }
    ...
    public RestCommentAnchorPullRequest participants(List<RestPullRequestParticipant> participants) {
        this.participants = participants;
        return this;
    }

    public RestCommentAnchorPullRequest addParticipantsItem(RestPullRequestParticipant participantsItem) {
    ...
    public RestCommentAnchorPullRequest reviewers(List<RestPullRequestParticipant> reviewers) {
        this.reviewers = reviewers;
        return this;
    }

    public RestCommentAnchorPullRequest addReviewersItem(RestPullRequestParticipant reviewersItem) {
    ...
    public RestCommentAnchorPullRequest state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentAnchorPullRequest title(String title) {
        this.title = title;
        return this;
    }
    ...
    public RestCommentAnchorPullRequest toRef(RestCommentAnchorPullRequestToRef toRef) {
        this.toRef = toRef;
        return this;
    }
     ...
     * @return toRef
     **/
    public @Valid RestCommentAnchorPullRequestToRef getToRef() {
        return toRef;
    }

    public void setToRef(RestCommentAnchorPullRequestToRef toRef) {
        this.toRef = toRef;
    }

    public RestCommentAnchorPullRequest updatedDate(Long updatedDate) {
    ...
    public RestCommentAnchorPullRequest version(Integer version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentAnchorPullRequest)) {
            return false;
        }
        RestCommentAnchorPullRequest other = (RestCommentAnchorPullRequest) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorPullRequest {");
