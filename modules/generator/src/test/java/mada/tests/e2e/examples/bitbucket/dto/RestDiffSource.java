...
public class RestDiffSource {
    ...
    public RestDiffSource components(List<String> components) {
        this.components = components;
        return this;
    }

    public RestDiffSource addComponentsItem(String componentsItem) {
    ...
    public RestDiffSource extension(String extension) {
    ...
    public RestDiffSource name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestDiffSource parent(String parent) {
        this.parent = parent;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestDiffSource)) {
            return false;
        }
        RestDiffSource other = (RestDiffSource) o;
    ...
    public String toString() {
        ...
        sb.append("class RestDiffSource {");
