...
/**
 * _ResponseApiLatestRepos
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestRepos {
    ...
    public _ResponseApiLatestRepos isLastPage(Boolean isLastPage) {
    ...
    public _ResponseApiLatestRepos limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestRepos nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseApiLatestRepos size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestRepos start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseApiLatestRepos values(List<RestRepository> values) {
        this.values = values;
        return this;
    }

    public _ResponseApiLatestRepos addValuesItem(RestRepository valuesItem) {
        if (this.values == null) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseApiLatestRepos)) {
            return false;
        }
        _ResponseApiLatestRepos other = (_ResponseApiLatestRepos) o;
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestRepos {");
