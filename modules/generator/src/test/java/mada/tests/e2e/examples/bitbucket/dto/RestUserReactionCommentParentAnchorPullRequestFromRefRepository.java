...
public class RestUserReactionCommentParentAnchorPullRequestFromRefRepository {
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepository origin(
            RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestFromRefRepository project(
            RestUserReactionCommentParentAnchorPullRequestFromRefRepositoryProject project) {
    ...
    public int hashCode() {
        return Objects.hash(archived, defaultBranch, description, forkable, hierarchyId, id, links, name, origin, partition, project,
                public_, relatedLinks, scmId, scope, slug, state, statusMessage);
    }
