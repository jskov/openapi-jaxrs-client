...
public class RestChangePath {
  ...
  public RestChangePath components(List<String> components) {
    this.components = components;
    return this;
  }

  public RestChangePath addComponentsItem(String componentsItem) {
  ...
  public RestChangePath extension(String extension) {
  ...
  public RestChangePath name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestChangePath parent(String parent) {
    this.parent = parent;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestChangePath)) {
      return false;
    }
    RestChangePath other = (RestChangePath) o;
  ...
  public String toString() {
    ...
    sb.append("class RestChangePath {");
