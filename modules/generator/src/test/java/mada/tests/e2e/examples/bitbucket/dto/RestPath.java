...
public class RestPath {
  ...
  public RestPath components(List<String> components) {
    this.components = components;
    return this;
  }

  public RestPath addComponentsItem(String componentsItem) {
  ...
  public RestPath extension(String extension) {
  ...
  public RestPath name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestPath parent(String parent) {
    this.parent = parent;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof RestPath other) {
