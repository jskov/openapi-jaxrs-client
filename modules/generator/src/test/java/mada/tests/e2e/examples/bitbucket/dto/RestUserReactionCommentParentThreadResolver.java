...
public class RestUserReactionCommentParentThreadResolver {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentParentThreadResolver.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestUserReactionCommentParentThreadResolver active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public RestUserReactionCommentParentThreadResolver avatarUrl(String avatarUrl) {
    ...
    public RestUserReactionCommentParentThreadResolver displayName(String displayName) {
    ...
    public RestUserReactionCommentParentThreadResolver emailAddress(String emailAddress) {
    ...
    public RestUserReactionCommentParentThreadResolver id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentParentThreadResolver links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentParentThreadResolver name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentParentThreadResolver slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestUserReactionCommentParentThreadResolver type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentParentThreadResolver)) {
            return false;
        }
        RestUserReactionCommentParentThreadResolver other = (RestUserReactionCommentParentThreadResolver) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentParentThreadResolver {");
