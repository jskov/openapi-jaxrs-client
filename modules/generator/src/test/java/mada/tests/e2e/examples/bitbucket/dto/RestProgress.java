...
public class RestProgress {
    ...
    public RestProgress message(String message) {
    ...
    public RestProgress percentage(Integer percentage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestProgress)) {
            return false;
        }
        RestProgress other = (RestProgress) o;
