...
public class RestCommentParentAnchorPullRequestFromRefRepositoryProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentAnchorPullRequestFromRefRepositoryProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestCommentParentAnchorPullRequestFromRefRepositoryProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryProject avatarUrl(String avatarUrl) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryProject description(String description) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryProject key(String key) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryProject namespace(String namespace) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryProject public_(Boolean public_) {
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequestFromRefRepositoryProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentParentAnchorPullRequestFromRefRepositoryProject)) {
            return false;
        }
        RestCommentParentAnchorPullRequestFromRefRepositoryProject other = (RestCommentParentAnchorPullRequestFromRefRepositoryProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentParentAnchorPullRequestFromRefRepositoryProject {");
