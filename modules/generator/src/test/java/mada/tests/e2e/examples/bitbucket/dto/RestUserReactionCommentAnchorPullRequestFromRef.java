...
public class RestUserReactionCommentAnchorPullRequestFromRef {
  ...
  private RestUserReactionCommentAnchorPullRequestFromRefRepository repository;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAnchorPullRequestFromRef.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestUserReactionCommentAnchorPullRequestFromRef displayId(String displayId) {
  ...
  public RestUserReactionCommentAnchorPullRequestFromRef id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestFromRef latestCommit(String latestCommit) {
  ...
  public RestUserReactionCommentAnchorPullRequestFromRef repository(RestUserReactionCommentAnchorPullRequestFromRefRepository repository) {
   ...
   **/
  @Valid
  public RestUserReactionCommentAnchorPullRequestFromRefRepository getRepository() {
    return repository;
  }

  public void setRepository(RestUserReactionCommentAnchorPullRequestFromRefRepository repository) {
    this.repository = repository;
  }

  public RestUserReactionCommentAnchorPullRequestFromRef type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestUserReactionCommentAnchorPullRequestFromRef)) {
      return false;
    }
    RestUserReactionCommentAnchorPullRequestFromRef other = (RestUserReactionCommentAnchorPullRequestFromRef) o;
  ...
  public String toString() {
    ...
    sb.append("class RestUserReactionCommentAnchorPullRequestFromRef {");
