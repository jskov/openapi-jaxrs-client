...
public class RestScope {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestScope.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestScope resourceId(Integer resourceId) {
  ...
  public RestScope type(TypeEnum type) {
    this.type = type;
    return this;
  }
