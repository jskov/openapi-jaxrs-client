...
public class RestHookScriptConfigScript {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestHookScriptConfigScript.TypeEnum.TypeEnumAdapter.class)
    ...
    public RestHookScriptConfigScript createdDate(OffsetDateTime createdDate) {
    ...
    public RestHookScriptConfigScript description(String description) {
    ...
    public RestHookScriptConfigScript id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public RestHookScriptConfigScript name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestHookScriptConfigScript pluginKey(String pluginKey) {
    ...
    public RestHookScriptConfigScript type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RestHookScriptConfigScript updatedDate(OffsetDateTime updatedDate) {
    ...
    public RestHookScriptConfigScript version(Integer version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestHookScriptConfigScript)) {
            return false;
        }
        RestHookScriptConfigScript other = (RestHookScriptConfigScript) o;
