...
public class RestUserReactionCommentAnchorPullRequestToRef {
    ...
    private RestUserReactionCommentAnchorPullRequestToRefRepository repository;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAnchorPullRequestToRef.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestUserReactionCommentAnchorPullRequestToRef displayId(String displayId) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRef id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRef latestCommit(String latestCommit) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRef repository(RestUserReactionCommentAnchorPullRequestToRefRepository repository) {
     ...
     * @return repository
     **/
    @Valid public RestUserReactionCommentAnchorPullRequestToRefRepository getRepository() {
        return repository;
    }

    public void setRepository(RestUserReactionCommentAnchorPullRequestToRefRepository repository) {
        this.repository = repository;
    }

    public RestUserReactionCommentAnchorPullRequestToRef type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentAnchorPullRequestToRef)) {
            return false;
        }
        RestUserReactionCommentAnchorPullRequestToRef other = (RestUserReactionCommentAnchorPullRequestToRef) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentAnchorPullRequestToRef {");
