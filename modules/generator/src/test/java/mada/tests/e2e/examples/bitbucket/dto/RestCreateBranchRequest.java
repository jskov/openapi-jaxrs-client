...
public class RestCreateBranchRequest {
  ...
  public RestCreateBranchRequest message(String message) {
  ...
  public RestCreateBranchRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCreateBranchRequest startPoint(String startPoint) {
  ...
  public String toString() {
    ...
    sb.append("class RestCreateBranchRequest {");
