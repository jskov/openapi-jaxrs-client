...
public class RestUserReactionCommentAnchorPullRequestFromRefRepository {
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepository origin(
            RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestFromRefRepository project(
            RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject project) {
