...
public class RestUserReactionCommentAnchorPullRequestFromRefRepository {
  ...
  @Schema(readOnly = true)
  private RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin origin;
  ...
  private RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAnchorPullRequestFromRefRepository.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository archived(Boolean archived) {
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository defaultBranch(String defaultBranch) {
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository description(String description) {
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository forkable(Boolean forkable) {
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository hierarchyId(String hierarchyId) {
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository origin(RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin origin) {
    this.origin = origin;
    return this;
  }
   ...
   **/
  @Valid
  public RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin getOrigin() {
    return origin;
  }

  public void setOrigin(RestUserReactionCommentAnchorPullRequestFromRefRepositoryOrigin origin) {
    this.origin = origin;
  }

  public RestUserReactionCommentAnchorPullRequestFromRefRepository partition(Integer partition) {
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository project(RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject project) {
   ...
   **/
  @Valid
  public RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject getProject() {
    return project;
  }

  public void setProject(RestUserReactionCommentAnchorPullRequestFromRefRepositoryProject project) {
    this.project = project;
  }

  public RestUserReactionCommentAnchorPullRequestFromRefRepository public_(Boolean public_) {
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository relatedLinks(Object relatedLinks) {
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestUserReactionCommentAnchorPullRequestFromRefRepository statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestUserReactionCommentAnchorPullRequestFromRefRepository)) {
      return false;
    }
    RestUserReactionCommentAnchorPullRequestFromRefRepository other = (RestUserReactionCommentAnchorPullRequestFromRefRepository) o;
  ...
  public String toString() {
    ...
    sb.append("class RestUserReactionCommentAnchorPullRequestFromRefRepository {");
