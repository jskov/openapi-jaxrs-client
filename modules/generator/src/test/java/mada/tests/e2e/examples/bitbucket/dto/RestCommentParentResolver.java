...
public class RestCommentParentResolver {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentResolver.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestCommentParentResolver active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestCommentParentResolver avatarUrl(String avatarUrl) {
  ...
  public RestCommentParentResolver displayName(String displayName) {
  ...
  public RestCommentParentResolver emailAddress(String emailAddress) {
  ...
  public RestCommentParentResolver id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestCommentParentResolver links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestCommentParentResolver name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCommentParentResolver slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestCommentParentResolver type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestCommentParentResolver)) {
      return false;
    }
    RestCommentParentResolver other = (RestCommentParentResolver) o;
  ...
  public String toString() {
    ...
    sb.append("class RestCommentParentResolver {");
