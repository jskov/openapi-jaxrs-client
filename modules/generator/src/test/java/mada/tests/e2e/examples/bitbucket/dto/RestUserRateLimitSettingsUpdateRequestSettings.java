...
public class RestUserRateLimitSettingsUpdateRequestSettings {
  ...
  public RestUserRateLimitSettingsUpdateRequestSettings capacity(Integer capacity) {
  ...
  public RestUserRateLimitSettingsUpdateRequestSettings fillRate(Integer fillRate) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestUserRateLimitSettingsUpdateRequestSettings)) {
      return false;
    }
    RestUserRateLimitSettingsUpdateRequestSettings other = (RestUserRateLimitSettingsUpdateRequestSettings) o;
  ...
  public String toString() {
    ...
    sb.append("class RestUserRateLimitSettingsUpdateRequestSettings {");
