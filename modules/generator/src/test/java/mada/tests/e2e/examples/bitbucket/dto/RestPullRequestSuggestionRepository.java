...
public class RestPullRequestSuggestionRepository {
    ...
    @Schema(readOnly = true)
    private RestPullRequestSuggestionRepositoryOrigin origin;
    ...
    private RestPullRequestSuggestionRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestSuggestionRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestPullRequestSuggestionRepository archived(Boolean archived) {
    ...
    public RestPullRequestSuggestionRepository defaultBranch(String defaultBranch) {
    ...
    public RestPullRequestSuggestionRepository description(String description) {
    ...
    public RestPullRequestSuggestionRepository forkable(Boolean forkable) {
    ...
    public RestPullRequestSuggestionRepository hierarchyId(String hierarchyId) {
    ...
    public RestPullRequestSuggestionRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepository origin(RestPullRequestSuggestionRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    public @Valid RestPullRequestSuggestionRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestPullRequestSuggestionRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestPullRequestSuggestionRepository partition(Integer partition) {
    ...
    public RestPullRequestSuggestionRepository project(RestPullRequestSuggestionRepositoryProject project) {
     ...
     * @return project
     **/
    public @Valid RestPullRequestSuggestionRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestPullRequestSuggestionRepositoryProject project) {
        this.project = project;
    }

    public RestPullRequestSuggestionRepository public_(Boolean public_) {
    ...
    public RestPullRequestSuggestionRepository relatedLinks(Object relatedLinks) {
    ...
    public RestPullRequestSuggestionRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestSuggestionRepository)) {
            return false;
        }
        RestPullRequestSuggestionRepository other = (RestPullRequestSuggestionRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestSuggestionRepository {");
