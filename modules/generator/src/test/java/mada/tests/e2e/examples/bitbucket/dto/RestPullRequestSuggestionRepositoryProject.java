...
public class RestPullRequestSuggestionRepositoryProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestSuggestionRepositoryProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestPullRequestSuggestionRepositoryProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryProject avatarUrl(String avatarUrl) {
    ...
    public RestPullRequestSuggestionRepositoryProject description(String description) {
    ...
    public RestPullRequestSuggestionRepositoryProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryProject key(String key) {
    ...
    public RestPullRequestSuggestionRepositoryProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryProject namespace(String namespace) {
    ...
    public RestPullRequestSuggestionRepositoryProject public_(Boolean public_) {
    ...
    public RestPullRequestSuggestionRepositoryProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestPullRequestSuggestionRepositoryProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestSuggestionRepositoryProject)) {
            return false;
        }
        RestPullRequestSuggestionRepositoryProject other = (RestPullRequestSuggestionRepositoryProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestSuggestionRepositoryProject {");
