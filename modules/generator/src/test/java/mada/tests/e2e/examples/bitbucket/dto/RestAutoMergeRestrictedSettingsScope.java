...
public class RestAutoMergeRestrictedSettingsScope {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestAutoMergeRestrictedSettingsScope.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestAutoMergeRestrictedSettingsScope resourceId(Integer resourceId) {
  ...
  public RestAutoMergeRestrictedSettingsScope type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RestAutoMergeRestrictedSettingsScope {");
