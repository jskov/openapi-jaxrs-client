...
public class RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin {
    ...
    public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin project(
            RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOriginProject project) {
