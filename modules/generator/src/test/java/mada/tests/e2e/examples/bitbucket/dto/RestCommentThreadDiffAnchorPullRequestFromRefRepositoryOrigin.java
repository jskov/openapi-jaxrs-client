...
public class RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin {
  ...
  private RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOriginProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin archived(Boolean archived) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin defaultBranch(String defaultBranch) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin description(String description) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin forkable(Boolean forkable) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin hierarchyId(String hierarchyId) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin partition(Integer partition) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin project(RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOriginProject project) {
   ...
   **/
  @Valid
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOriginProject getProject() {
    return project;
  }

  public void setProject(RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOriginProject project) {
    this.project = project;
  }

  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin public_(Boolean public_) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin relatedLinks(Object relatedLinks) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin)) {
      return false;
    }
    RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin other = (RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin) o;
  ...
  public String toString() {
    ...
    sb.append("class RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin {");
