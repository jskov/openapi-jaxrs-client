...
public class RestUserReactionCommentAnchorPullRequestToRefRepositoryProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentAnchorPullRequestToRefRepositoryProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject avatarUrl(String avatarUrl) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject description(String description) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject key(String key) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject namespace(String namespace) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject public_(Boolean public_) {
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestUserReactionCommentAnchorPullRequestToRefRepositoryProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentAnchorPullRequestToRefRepositoryProject)) {
            return false;
        }
        RestUserReactionCommentAnchorPullRequestToRefRepositoryProject other = (RestUserReactionCommentAnchorPullRequestToRefRepositoryProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentAnchorPullRequestToRefRepositoryProject {");
