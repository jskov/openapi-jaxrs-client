...
public interface AuthenticationApi {
    ...
    /**
     * Get project HTTP tokens. Get all access tokens associated with the given project.
     *
    ...
    /**
     * Create project HTTP token. Create an access token for the project according to the given request.
     *
     * @param projectKey The project key. (not null)
    ...
    /**
     * Get repository HTTP tokens. Get all access tokens associated with the given repository.
     *
     * @param projectKey     The project key. (not null)
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A response containing a page of access tokens and associated details.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseAccessTokensLatestProjectsProjectKeyReposRepositorySlug.class))),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseAccessTokensLatestProjectsProjectKeyReposRepositorySlug_401.class))),
            @APIResponse(
                    responseCode = "404",
    ...
    /**
     * Create repository HTTP token. Create an access token for the repository according to the given request.
     *
     * @param projectKey     The project key. (not null)
     * @param repositorySlug The repository slug. (not null)
     * @param dto            The request containing the details of the access token to create. (optional)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseAccessTokensLatestProjectsProjectKeyReposRepositorySlug_400.class))),
            @APIResponse(
                    responseCode = "401",
    ...
    /**
     * Get HTTP token by ID. Get the access token identified by the given ID.
     *
     * @param projectKey     The project key. (not null)
    ...
    /**
     * Update HTTP token. Modify an access token according to the given request. Any fields not specified will not be
     * altered.
     *
     * @param projectKey     The project key. (not null)
     * @param tokenId        The token id. (not null)
    ...
    /**
     * Delete a HTTP token. Delete the access token identified by the given ID.
     *
     * @param projectKey     The project key. (not null)
     * @param tokenId        The token id. (not null)
     * @param repositorySlug The repository slug. (not null)
    ...
    void deleteById_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("tokenId") @NotNull String tokenId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The specified user or token does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseAccessTokensLatestProjectsProjectKeyTokenId_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    @Operation(summary = "Delete a HTTP token")
    ...
    /**
     * Get personal HTTP tokens. Get all access tokens associated with the given user.
     *
    ...
    /**
     * Create personal HTTP token. Create an access token for the user according to the given request.
     *
     * @param userSlug The user slug. (not null)
     * @param dto      The request containing the details of the access token to create. (optional)
     * @return RestRawAccessToken
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The specified user or token does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseAccessTokensLatestUsersUserSlugTokenId_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    @Operation(summary = "Delete a HTTP token")
    ...
    /**
     * Get repository SSH keys. Retrieves the access keys for the repository identified in the URL.
     *
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseKeysLatestProjectsProjectKeyReposRepositorySlugSsh.class))),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseKeysLatestProjectsProjectKeyReposRepositorySlugSsh_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist",
                    content = @Content(
    ...
    /**
     * Add repository SSH key. Register a new SSH key and grants access to the repository identified in the URL.
     *
     * @param projectKey     The project key (not null)
     * @param repositorySlug The repository slug (not null)
     * @param dto            (optional)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseKeysLatestProjectsProjectKeyReposRepositorySlugSsh_400.class))),
            @APIResponse(
                    responseCode = "401",
    ...
    /**
     * Get repository SSH key. Retrieves the access key for the SSH key with id <code>keyId</code> on the repository
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to retrieve the access keys for this repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseKeysLatestProjectsProjectKeyReposRepositorySlugSshKeyId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or key does not exist or the key does not have access on the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseKeysLatestProjectsProjectKeyReposRepositorySlugSshKeyId_404.class)))
    })
    @Operation(summary = "Get repository SSH key")
    RestSshAccessKey getForRepository(@PathParam("projectKey") @NotNull String projectKey, @PathParam("keyId") @NotNull String keyId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);

    /**
     * Revoke repository SSH key. Remove an existing access key for the repository identified in the URL. If the same SSH
     * key is used as an access key for multiple projects or repositories, only the access to the repository identified in
     * the URL will be revoked.
     *
     * @param projectKey     The project key (not null)
     * @param keyId          The key id (not null)
     * @param repositorySlug The repository slug (not null)
    ...
    void revokeForRepository(@PathParam("projectKey") @NotNull String projectKey, @PathParam("keyId") @NotNull String keyId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);

    /**
     * Update repository SSH key permission. Updates the permission granted to the specified SSH key to the repository
     * identified in the URL.
     *
     * @param projectKey     The project key (not null)
    ...
    RestSshAccessKey updatePermission_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("keyId") @NotNull String keyId,
            @PathParam("permission") @NotNull String permission, @PathParam("repositorySlug") @NotNull String repositorySlug);

    /**
     * Get SSH key. Retrieves the access keys for the project identified in the URL.
     *
    ...
    /**
     * Add project SSH key. Register a new SSH key and grants access to the project identified in the URL.
     *
     * @param projectKey The project key (not null)
     * @param dto        (optional)
     * @return RestSshAccessKey
    ...
    /**
     * Get project SSH key. Retrieves the access key for the SSH key with id <code>keyId</code> on the project identified in
     * the URL.
     *
     * @param projectKey The project key (not null)
     * @param keyId      The key id (not null)
    ...
    /**
     * Revoke project SSH key. Remove an existing access key for the project identified in the URL. If the same SSH key is
     * used as an access key for multiple projects or repositories, only the access to the project identified in the URL
     * will be revoked.
     *
     * @param projectKey The project key (not null)
     * @param keyId      The key id (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseKeysLatestProjectsProjectKeySshKeyId_401.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Update project SSH key permission. Updates the permission granted to the specified SSH key to the project identified
     * in the URL.
     *
     * @param projectKey The project key (not null)
     * @param keyId      The newly created access key (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The specified project does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseKeysLatestProjectsProjectKeySshKeyIdPermissionPermission_404.class)))
    })
    @Operation(summary = "Update project SSH key permission")
    RestSshAccessKey updatePermission(@PathParam("projectKey") @NotNull String projectKey, @PathParam("keyId") @NotNull String keyId,
            @PathParam("permission") @NotNull String permission);

    /**
     * Revoke project SSH key. Remove an existing access key for the projects and repositories in the submitted entity. If
     * the same SSH key is used as an access key for multiple projects or repositories not supplied, only the access to the
     * projects or repositories identified will be revoked.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseKeysLatestSshKeyId_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "On or more of the specified repositories or projects does not exist or the key itself does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseKeysLatestSshKeyId_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    @Operation(summary = "Revoke project SSH key")
    ...
    /**
     * Get project SSH keys. Retrieves all project-related access keys for the SSH key with id <code>keyId</code>. If the
     * current user is not an admin any of the projects the key provides access to, none are returned.
     *
    ...
    /**
     * Get repository SSH key. Retrieves all repository-related access keys for the SSH key with id <code>keyId</code>. If
     * the current user is not an admin of any of the projects the key provides access to, none are returned.
     *
     * @param keyId            The key id (not null)
    ...
    /**
     * Get SSH keys for user. Retrieve a page of SSH keys.
     *
    ...
    _ResponseSshLatestKeys getSshKeys(@QueryParam("userName") String userName, @QueryParam("user") String user,
            @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);

    /**
     * Add SSH key for user. Add a new SSH key to a supplied user.
     *
    ...
    /**
     * Delete all user SSH key. Delete all SSH keys for a supplied user.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseSshLatestKeys_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "No user matches the supplied <strong>user</strong>",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseSshLatestKeys_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Get SSH key for user by keyId. Retrieve an SSH key by keyId
     *
    ...
    /**
     * Remove SSH key. Delete an SSH key.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseSshLatestKeysKeyId_401.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Get SSH settings. Gets the SSH settings from the upstream.
     *
