...
public class RestBulkUserRateLimitSettingsUpdateRequestSettings {
    ...
    public RestBulkUserRateLimitSettingsUpdateRequestSettings capacity(Integer capacity) {
    ...
    public RestBulkUserRateLimitSettingsUpdateRequestSettings fillRate(Integer fillRate) {
