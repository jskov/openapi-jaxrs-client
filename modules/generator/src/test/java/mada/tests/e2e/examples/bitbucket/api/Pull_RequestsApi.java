...
public interface Pull_RequestsApi {
    ...
    /**
     * Get merge strategies. Retrieve the merge strategies available for this instance.
     * 
    ...
    /**
     * Update merge strategies. Update the pull request merge strategies for the context repository.
     * 
     ...
     * `mergeConfig` attribute. i.e: ``` { "mergeConfig": {} } ```
     * 
    ...
    /**
     * Get repository pull requests containing commit. Retrieve a page of pull requests in the current repository that
    ...
    /**
     * Search pull request participants. Retrieve a page of participant users for all the pull requests to or from the
    ...
    /**
     * Get pull requests for repository. Retrieve a page of pull requests to or from the specified repository.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the specified repository to call this
     * resource. Optionally clients can specify PR participant filters. Each filter has a mandatory username.N parameter,
     * and the optional role.N and approved.N parameters.
     * 
     * - username.N - the "root" of a single participant filter, where "N" is a natural number starting from 1. This allows
     * clients to specify multiple participant filters, by providing consecutive filters as username.1, username.2 etc. Note
     * that the filters numbering has to start with 1 and be continuous for all filters to be processed. The total allowed
     * number of participant filters is 10 and all filters exceeding that limit will be dropped. - role.N(optional) the role
     * associated with username.N. This must be one of AUTHOR, REVIEWER, or PARTICIPANT - approved.N (optional) the approved
    ...
    /**
     * Create pull request. Create a new pull request from a source branch or tag to a target branch. The source and target
     * may be in the same repository, or different ones. (Note that different repositories must belong to the same
     * <code>Repository#getHierarchyId()</code> hierarchy.)
     * 
     * The <code>fromRef</code> may be a branch or a tag. The <code>toRef</code> is required to be a branch. Tags are not
     * allowed as targets because tags are intended to be immutable and should not be changed after they are created.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the <code>fromRef</code> and
     * <code>toRef</code> repositories to call this resource.
     *
     * @param projectKey     The project key. (not null)
     * @param repositorySlug The repository slug. (not null)
    ...
    /**
     * Get pull request. Retrieve a pull request.
     * 
    ...
    /**
     * Update pull request metadata. Update the title, description, reviewers, destination branch or draft status of an
     * existing pull request.
     ** 
     * Note:** the <em>reviewers</em> list may be updated using this resource. However the <em>author</em> and
     * <em>participants</em> list may not.
     * 
     * The authenticated user must either:
     * 
     * - be the author of the pull request and have the <strong>REPO_READ</strong> permission for the repository that this
     * pull request targets; or - have the <strong>REPO_WRITE</strong> permission for the repository that this pull request
     * targets
     * 
     * 
    ...
    /**
     * Delete pull request. Deletes a pull request.
     * 
     * To call this resource, users must be authenticated and have permission to view the pull request. Additionally, they
     * must:
     * 
     * - be the pull request author, if the system is configured to allow authors to delete their own pull requests (this is
     * the default) OR - have repository administrator permission for the repository the pull request is targeting
     * 
     * 
    ...
    /**
     * Stream raw pull request diff. Streams the raw diff for a pull request.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Stream pull request as patch. Streams a patch representing a pull request.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Get pull request activity. Retrieve a page of activity associated with a pull request.
     * 
    ...
    /**
     * Get auto-merge request for pull request. Returns an auto-merge request for the pull request, if requested.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Auto-merge pull request. Requests the system to try merging the pull request if auto-merge was requested on it.
     * 
    ...
    /**
     * Cancel auto-merge for pull request. Cancels a request to auto-merge the pull request, if the pull request was not
     * merged yet.
     * 
     * The authenticated user must have <strong>REPO_WRITE</strong> permission for the repository that this pull request
     * targets to call this resource.
    ...
    /**
     * Search pull request comments. Gets comments matching the given set of field values for the specified pull request.
    ...
    /**
     * Add new blocker comment. Add a new blocker comment.
     * 
     ...
     * ```
     * 
     * { "text": "A blocker comment on a file.", "anchor": { "diffType": "RANGE", "fromHash":
     * "6df3858eeb9a53a911cd17e66a9174d44ffb02cd", "path": "path/to/file", "srcPath": "path/to/file", "toHash":
     ...
     * ```
     * 
     * { "text": "A task on a particular line within a file.", "anchor": { "diffType": "COMMIT", "line": 1, "lineType":
     * "CONTEXT", "fileType": "FROM", "fromHash": "6df3858eeb9a53a911cd17e66a9174d44ffb02cd", "path": "path/to/file",
     * "srcPath": "path/to/file", "toHash": "04c7c5c931b9418ca7b66f51fe934d0bd9b2ba4b" } } ```
     * 
     ...
     * diffType is REQUIRED.
     * 
     * For line comments, 'line' refers to the line in the diff that the comment should apply to. 'lineType' refers to the
     * type of diff hunk, which can be:
     * 
     * - 'ADDED' - for an added line; - 'REMOVED' - for a removed line; or - 'CONTEXT' - for a line that was unmodified but
     * is in the vicinity of the diff.
     * 
     ...
     * 
     * - 'FROM' - the source file of the diff - 'TO' - the destination file of the diff
     * 
     * 
    ...
    /**
     * Get pull request comment. Retrieves a pull request comment.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Update pull request comment. Update a comment, with the following restrictions:
     * 
     * - only the author of the comment may update the <i>text</i> of the comment - only the author of the comment, the
     * author of the pull request or repository admins and above may update the other fields of a comment
     * 
     * 
     ...
     * be fetched from the server prior to the update. Look for the 'version' attribute in the returned JSON structure.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Delete pull request comment. Delete a pull request comment. Anyone can delete their own comment. Only users with
     * <strong>REPO_ADMIN</strong> and above may delete comments created by other users.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Gets pull request changes. Gets changes for the specified PullRequest.
     * 
     * If the changeScope query parameter is set to 'UNREVIEWED', the application will attempt to stream unreviewed changes
     * based on the lastReviewedCommit of the current user, which are the changes between the lastReviewedCommit and the
     * latest commit of the source branch. The current user is considered to <i>not</i> have any unreviewed changes for the
     * pull request when the lastReviewedCommit is either null (everything is unreviewed, so all changes are streamed),
     * equal to the latest commit of the source branch (everything is reviewed), or no longer on the source branch (the
     * source branch has been rebased). In these cases, the application will fall back to streaming all changes (the
     * default), which is the effective diff for the pull request. The type of changes streamed can be determined by the
     * changeScope parameter included in the properties map of the response.
     * 
     * Note: This resource is currently <i>not paged</i>. The server will return at most one page. The server will truncate
     * the number of changes to either the request's page limit or an internal maximum, whichever is smaller. The start
     * parameter of the page request is also ignored.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Get pull request comments for path. Gets comments for the specified pull request and path.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Add pull request comment. Add a new comment.
     * 
     * Comments can be added in a few places by setting different attributes:
     * </p>
    ...
    /**
     * Get a pull request comment. Retrieves a pull request comment.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Delete a pull request comment. Delete a pull request comment. Anyone can delete their own comment. Only users with
     * <strong>REPO_ADMIN</strong> and above may delete comments created by other users.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
    ...
    /**
     * Apply pull request suggestion. Apply a suggestion contained within a comment.
     *
     * @param projectKey     The project key. (not null)
     * @param commentId      The ID of the comment to retrieve. (not null)
     * @param pullRequestId  The pull request ID. (not null)
    ...
    /**
     * Get commit message suggestion. Retrieve a suggested commit message for the given Pull Request.
     *
     * @param projectKey     The project key. (not null)
    ...
    /**
     * Get pull request commits. Retrieve commits for the specified pull request.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Stream a diff within a pull request. Streams a diff within a pull request.
     * 
     * If the specified file has been copied, moved or renamed, the <code>srcPath</code> must also be specified to produce
     * the correct diff.
     * 
    ...
    /**
     * Test if pull request can be merged. Test whether a pull request can be merged.
     * 
     * A pull request may not be merged if:
     * 
     * - there are conflicts that need to be manually resolved before merging; and/or - one or more merge checks have vetoed
     * the merge.
     * 
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
    ...
    /**
     * Merge pull request. Merge the specified pull request immediately or set the pull request to auto-merge when all the
    ...
    /**
     * Get the common ancestor between the latest commits of the source and target branches of the pull request. Returns the
     * best common ancestor between the latest commits of the source and target branches of the pull request.
     * 
    ...
    /**
     * Get pull request participants. Retrieves a page of the participants for a given pull request.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Assign pull request participant role. Assigns a participant to an explicit role in pull request. Currently only the
     * REVIEWER role may be assigned.
     * 
    ...
    /**
     * Change pull request status. Change the current user's status for a pull request. Implicitly adds the user as a
     * participant if they are not already. If the current user is the author, this method will fail.
     * 
     * The possible values for {@code status} are <strong>UNAPPROVED</strong>, <strong>NEEDS_WORK</strong> (which is
     * referred to as "Requested changes" in the frontend from 8.10 onward), or <strong>APPROVED</strong>.
     * 
     * If the new {@code status} is <strong>NEEDS_WORK</strong> or <strong>APPROVED</strong> then the
     * {@code lastReviewedCommit} for the participant will be updated to the latest commit of the source branch of the pull
     * request.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
    ...
    /**
     * Unassign pull request participant. Unassigns a participant from the REVIEWER role they may have been given in a pull
     * request.
     * 
    ...
    /**
     * Re-open pull request. Re-open a declined pull request.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Get pull request comment thread. Get the <code>CommentThread</code> threads which have <code>Comment</code> comments
     * that have a <code>CommentState#PENDING</code> pending state and are part of the pull request review for the
     * authenticated user.
     *
     * @param projectKey     The project key. (not null)
     * @param pullRequestId  The pull request ID. (not null)
    ...
    /**
     * Complete pull request review. Complete a review on a pull request.
     *
     * @param projectKey     The project key. (not null)
     * @param pullRequestId  The pull request ID. (not null)
     * @param version        The current version of the pull request. If the server's version isn't the same as the
    ...
    /**
     * Discard pull request review. Discard a pull request review for the authenticated user.
     * 
    ...
    /**
     * Watch pull request. Add the authenticated user as a watcher for the specified pull request.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Stop watching pull request. Remove the authenticated user as a watcher for the specified pull request.
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    /**
     * Get all reviewer groups. Retrieve a page of reviewer groups of a given scope.
     * 
    ...
    /**
     * Create reviewer group. Create a reviewer group.
     * 
    ...
    /**
     * Get reviewer group. Retrieve a reviewer group.
     * 
     * The authenticated user must have <b>REPO_READ</b> permission for the specified repository to call this resource.
     *
     * @param projectKey     The project key. (not null)
    ...
    /**
     * Update reviewer group attributes. Update the attributes of a reviewer group.
     * 
     * The authenticated user must have <b>REPO_ADMIN</b> permission for the specified repository to call this resource.
     *
     * @param projectKey     The project key. (not null)
    ...
    /**
     * Delete reviewer group. Deletes a reviewer group.
     * 
     * The authenticated user must have <b>REPO_ADMIN</b> permission for the specified repository to call this resource.
     *
     * @param projectKey     The project key. (not null)
    ...
    /**
     * Get reviewer group users. Retrieve a list of the users of a reviewer group.
     * 
     * This does not return all the users of the group, only the users who are licensed and have <b>REPO_READ</b> permission
    ...
    /**
     * React to a PR comment. Add an emoticon reaction to a pull request comment
     *
     * @param projectKey     The project key. (not null)
    ...
    /**
     * Remove a reaction from a PR comment. Remove an emoticon reaction from a pull request comment
     *
     * @param projectKey     The project key. (not null)
     * @param commentId      The comment id. (not null)
     * @param pullRequestId  The pull request id. (not null)
    ...
    /**
     * Create default reviewer. Create a default reviewer pull request condition for the given project.
     *
     * @param projectKey The project key. (not null)
    ...
    /**
     * Update the default reviewer. Update the default reviewer pull request condition for the given ID.
     *
     * @param projectKey The project key. (not null)
    ...
    /**
     * Remove default reviewer. Delete the default reviewer pull request condition associated with the given ID.
     *
     * @param projectKey The project key. (not null)
     * @param id         The ID of the pull request condition. (not null)
     */
    ...
    /**
     * Get default reviewers. Return a page of default reviewer pull request conditions that have been configured for this
     * project.
     *
     * @param projectKey The project key. (not null)
    ...
    /**
     * Create default reviewers condition. Create a default reviewer pull request condition for the given repository.
     *
     * @param projectKey     The project key. (not null)
     * @param repositorySlug The repository slug. (not null)
     * @param dto            The details needed to create a default reviewer pull request condition. (optional)
    ...
    /**
     * Update a default reviewer condition. Update the default reviewer pull request condition for the given ID.
     *
     * @param projectKey     The project key. (not null)
     * @param id             The ID of the pull request condition (not null)
     * @param repositorySlug The repository slug. (not null)
    ...
    /**
     * Delete a default reviewer condition. Delete the default reviewer pull request condition associated with the given ID.
     *
     * @param projectKey     The project key. (not null)
     * @param id             (not null)
     * @param repositorySlug The repository slug. (not null)
    ...
    /**
     * Get configured default reviewers. Return a page of default reviewer pull request conditions that have been configured
     * for this repository.
     *
     * @param projectKey     The project key. (not null)
     * @param repositorySlug The repository slug. (not null)
    ...
    /**
     * Get required reviewers for PR creation. Return a set of users who are required reviewers for pull requests created
     * from the given source repository and ref to the given target ref in this repository.
     *
    ...
    /**
     * Check PR rebase precondition. Checks preconditions to determine whether the pull request can be rebased.
     * 
     * Some of the preconditions are:
     * 
     * - The pull request is between Git repositories - The pull request is currently open - The pull request's
     ...
     * just because a user can <i>see</i> a pull request does not mean they can request a rebase
     * 
     * 
    ...
    /**
     * Rebase pull request. Rebases the specified pull request, rewriting the incoming commits to start from the tip commit
     * of the pull request's target branch. <i>This operation alters the pull request's source branch and cannot be
     * undone.</i>
     * 
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets <i>and</i> <strong>REPO_WRITE</strong> permission for the pull request's source repository to call this
     * resource.
     *
     * @param projectKey     The project key. (not null)
     * @param pullRequestId  The ID of the pull request within the repository. (not null)
