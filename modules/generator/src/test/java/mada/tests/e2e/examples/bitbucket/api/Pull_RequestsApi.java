...
public interface Pull_RequestsApi {
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdPullRequests.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to see the request repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdPullRequests_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The request repository does not exist",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdPullRequests_404.class)))
    })
    @Operation(summary = "Get repository pull requests containing commit")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdPullRequests getPullRequests(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commitId") @NotNull String commitId,
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugParticipants_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the specified repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugParticipants_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugParticipants_404.class)))
    })
    @Operation(summary = "Search pull request participants")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugParticipants search(@QueryParam("filter") String filter, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("role") String role, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("direction") String direction, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
     ...
     * resource.  Optionally clients can specify PR participant filters. Each filter has a mandatory username.N
     * parameter, and the optional role.N and approved.N parameters.
     * - username.N - the "root" of a single participant filter, where "N" is a natural number   starting from 1. This
     * allows clients to specify multiple participant filters, by providing consecutive   filters as username.1,
     * username.2 etc. Note that the filters numbering has to start   with 1 and be continuous for all filters to be
     * processed. The total allowed number of participant   filters is 10 and all filters exceeding that limit will be
     * dropped. - role.N(optional) the role associated with username.N.   This must be one of AUTHOR, REVIEWER, or
     * PARTICIPANT - approved.N (optional) the approved status associated with username.N.   That is whether username.N
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequests_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the specified pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequests_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequests_404.class)))
    })
    @Operation(summary = "Get pull requests for repository")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequests getPage(@QueryParam("withAttributes") String withAttributes, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("at") String at, @QueryParam("withProperties") String withProperties, @QueryParam("draft") String draft, @QueryParam("filterText") String filterText, @QueryParam("state") String state, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("order") String order, @QueryParam("direction") String direction, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);

    /**
     * Create pull request.
     *
     * Create a new pull request from a source branch or tag to a target branch. The source and target may be in the
     * same repository, or different ones. (Note that different repositories must belong to the same
     * <code>Repository#getHierarchyId()</code> hierarchy.)
     * The <code>fromRef</code> may be a branch or a tag. The <code>toRef</code> is required to be a branch. Tags are
     * not allowed as targets because tags are intended to be immutable and should not be changed after they are
     * created.
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequests_409.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to view the specified pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestId_404.class)))
    })
     ...
     * - be the author of the pull request and have the <strong>REPO_READ</strong> permission for the repository that
     * this pull request targets; or - have the <strong>REPO_WRITE</strong> permission for the repository that this pull
     * request targets
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestId_400.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestId_409.class)))
    })
     ...
     * To call this resource, users must be authenticated and have permission to view the pull request. Additionally,
     * they must:
     * - be the pull request author, if the system is configured to allow authors to delete their own   pull requests
     * (this is the default) OR - have repository administrator permission for the repository the pull request is
     * targeting
    ...
    void streamRawDiff_2(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("contextLines") String contextLines,
            @QueryParam("whitespace") String whitespace, @PathParam("pullRequestId") @NotNull String pullRequestId, @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestId_patch_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestId_patch_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdActivities.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdActivities_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the specified pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdActivities_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdActivities_404.class)))
    })
    @Operation(summary = "Get pull request activity")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdActivities getActivities(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("fromType") String fromType,
            @PathParam("pullRequestId") @NotNull String pullRequestId, @QueryParam("fromId") String fromId, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to view the specified pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdAutoMerge_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdAutoMerge_404.class)))
    })
    @Operation(summary = "Get auto-merge request for pull request")
    RestAutoMergeRequest getAutoMergeRequest(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdAutoMerge_400.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdAutoMerge_403.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
    ...
    RestAutoMergeProcessingResult tryAutoMerge(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdAutoMerge_409.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
     ...
     * perform any kind of searching for comments by their text).
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
     * @param projectKey     The project key. (not null)
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdBlockerComments.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository or pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdBlockerComments_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdBlockerComments_404.class)))
    })
    @Operation(summary = "Search pull request comments")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdBlockerComments getComments_1(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("count") String count,
            @QueryParam("state") List<String> state, @PathParam("pullRequestId") @NotNull String pullRequestId, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("states") String states, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
     ...
     * ```
     * {      "text": "A blocker comment on a file.",      "anchor": {          "diffType": "RANGE",
     * "fromHash": "6df3858eeb9a53a911cd17e66a9174d44ffb02cd",          "path": "path/to/file",          "srcPath":
     * "path/to/file",          "toHash": "04c7c5c931b9418ca7b66f51fe934d0bd9b2ba4b"      }  } ```
     * Blocker file line comment:
     * ```
     * {      "text": "A task on a particular line within a file.",      "anchor": {          "diffType": "COMMIT",
     * "line": 1,          "lineType": "CONTEXT",          "fileType": "FROM",          "fromHash":
     ...
     * Finally diffType refers to the type of diff the comment was added on. For backwards compatibility purposes if no
     * diffType is provided and no fromHash/toHash pair is provided the diffType will be resolved to 'EFFECTIVE'. In any
     * other cases the diffType is REQUIRED.
     ...
     * - 'ADDED' - for an added line; - 'REMOVED' - for a removed line; or - 'CONTEXT' - for a line that was unmodified
     * but is in the vicinity of the diff.
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdBlockerComments_400.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdBlockerComments_409.class)))
    })
    @Operation(summary = "Add new blocker comment")
    RestComment createComment_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestComment dto);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdBlockerCommentsCommentId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "Unable to find the supplied project, repository, pull request or comment.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdBlockerCommentsCommentId_404.class)))
    })
     ...
     * version of the comment or the update will fail. To determine the current version of the comment, the comment
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdBlockerCommentsCommentId_400.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdBlockerCommentsCommentId_409.class)))
    })
    ...
    RestComment updateComment_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commentId") @NotNull String commentId,
            @PathParam("pullRequestId") @NotNull String pullRequestId, @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestComment dto);
    ...
    void deleteComment_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commentId") @NotNull String commentId,
            @PathParam("pullRequestId") @NotNull String pullRequestId, @QueryParam("version") String version, @PathParam("repositorySlug") @NotNull String repositorySlug);

    /**
     * Gets pull request changes.
     *
     * Gets changes for the specified PullRequest.
     * If the changeScope query parameter is set to 'UNREVIEWED', the application will attempt to stream unreviewed
     * changes based on the lastReviewedCommit of the current user, which are the changes between the lastReviewedCommit
     * and the latest commit of the source branch. The current user is considered to <i>not</i> have any unreviewed
     * changes for the pull request when the lastReviewedCommit is either null (everything is unreviewed, so all changes
     * are streamed), equal to the latest commit of the source branch (everything is reviewed), or no longer on the
     * source branch (the source branch has been rebased). In these cases, the application will fall back to streaming
     * all changes (the default), which is the effective diff for the pull request. The type of changes streamed can be
     * determined by the changeScope parameter included in the properties map of the response.
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to view the repository or pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdChanges_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdChanges_404.class)))
    })
    ...
    RestChange streamChanges_1(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("sinceId") String sinceId,
            @QueryParam("changeScope") String changeScope, @QueryParam("untilId") String untilId, @PathParam("pullRequestId") @NotNull String pullRequestId, @QueryParam("withComments") String withComments, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A page of Comments from the supplied pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdComments.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository or pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdComments_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdComments_404.class)))
    })
    @Operation(summary = "Get pull request comments for path")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdComments getComments_2(@QueryParam("path") @NotNull String path, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("fromHash") String fromHash, @QueryParam("anchorState") String anchorState, @QueryParam("diffType") List<String> diffType, @QueryParam("toHash") String toHash, @QueryParam("state") List<String> state, @PathParam("pullRequestId") @NotNull String pullRequestId, @QueryParam("diffTypes") String diffTypes, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("states") String states, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);

    /**
     * Add pull request comment.
     *
     * Add a new comment.
     * Comments can be added in a few places by setting different attributes: </p>General pull request comment:  <pre> {
     * "text": "An insightful general comment on a pull request."  }  </pre> Reply to a comment:  <pre> {    "text": "A
     * measured reply.",    "parent": {       "id": 1     }  }  </pre> General file comment:  <pre> {    "text": "An
     * insightful general comment on a file.",    "anchor": {       "diffType": "RANGE",       "fromHash":
     * "6df3858eeb9a53a911cd17e66a9174d44ffb02cd",       "path": "path/to/file",       "srcPath": "path/to/file",
     * "toHash": "04c7c5c931b9418ca7b66f51fe934d0bd9b2ba4b"    }  }  </pre> File line comment:  <pre> {    "text": "A
     ...
     * "04c7c5c931b9418ca7b66f51fe934d0bd9b2ba4b"     }  }  </pre>
     * Add a new task.
     * Tasks are just comments with the attribute 'severity' set to 'BLOCKER':
     * General pull request task:  <pre> {    "text": "A task on a pull request.",    "severity": "BLOCKER"  }  </pre>
     * Add a pending comment.
     * Pending comments are just comments with the attribute 'state' set to 'PENDING':
     * Pending comment: <pre> {    "text": "This is a pending comment",    "state": "PENDING"  }  </pre>
     * For file and line comments, 'path' refers to the path of the file to which the comment should be applied and
     * 'srcPath' refers to the path the that file used to have (only required for copies and moves). Also, fromHash and
     * toHash refer to the sinceId / untilId (respectively) used to produce the diff on which the comment was added.
     * Finally diffType refers to the type of diff the comment was added on. For backwards compatibility purposes if no
     ...
     * the type of diff hunk, which can be:
     * - 'ADDED' - for an added line; - 'REMOVED' - for a removed line; or - 'CONTEXT' - for a line that was unmodified
     * but is in the vicinity of the diff. </ul>'fileType' refers to the file of the diff to which the anchor should be
     * attached - which is of relevance when displaying the diff in a side-by-side way. Currently the supported values
     * are:
     * - 'FROM' - the source file of the diff - 'TO' - the destination file of the diff </ul>If the current user is not
     * a participant the user is added as a watcher of the pull request.
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
     * @param projectKey     The project key. (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The comment was not created due to a validation error.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdComments_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the pull request, create a comment or watch the pull request.",
                    content = @Content(
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdComments_409.class)))
    })
    @Operation(summary = "Add pull request comment")
    RestComment createComment_2(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestComment dto);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to view the comment.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "Unable to find the supplied project, repository, pull request or comment.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentId_404.class)))
    })
     ...
     * Update a comment, with the following restrictions:
     * - only the author of the comment may update the <i>text</i> of the comment - only the author of the comment, the
     * author of the pull request or repository admins and above may update the other fields of a comment </ul>
     * Convert a comment to a task or vice versa.
     * Comments can be converted to tasks by setting the 'severity' attribute to 'BLOCKER':  <pre> {  "severity":
     * "BLOCKER"  }  </pre>
     * Tasks can be converted to comments by setting the 'severity' attribute to 'NORMAL':  <pre> {  "severity":
     * "NORMAL"  }  </pre>
     * Resolve a task.
     * Tasks can be resolved by setting the 'state' attribute to 'RESOLVED':  <pre> {  "state": "RESOLVED"  }  </pre>
     * <strong>Note:</strong> the supplied JSON object must contain a <code>version</code> that must match the server's
     * version of the comment or the update will fail. To determine the current version of the comment, the comment
     * should be fetched from the server prior to the update. Look for the 'version' attribute in the returned JSON
     * structure.
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The comment was not updated due to a validation error.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentId_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the pull request, update a comment or watch the pull request.",
                    content = @Content(
            ...
            @APIResponse(
                    ...
                    description = "The comment version supplied does not match the current version or the repository is archived.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentId_409.class)))
    })
    @Operation(summary = "Update pull request comment")
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentIdApplySuggestion_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to apply the suggestion.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentIdApplySuggestion_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "Unable to find the supplied project, repository, pull request or parent comment.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentIdApplySuggestion_404.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "409",
                    description = "There was an error applying the suggestion to the source branch. It must be applied manually.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommentsCommentIdApplySuggestion_409.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    void applySuggestion(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commentId") @NotNull String commentId,
            @PathParam("pullRequestId") @NotNull String pullRequestId, @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestApplySuggestionRequest dto);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to view the specified pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommitMessageSuggestion_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommitMessageSuggestion_404.class)))
    })
    @Operation(summary = "Get commit message suggestion")
    RestCommitMessageSuggestion getCommitMessageSuggestion(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommits.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository or pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommits_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommits_404.class)))
    })
    @Operation(summary = "Get pull request commits")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdCommits getCommits_1(@QueryParam("avatarScheme") String avatarScheme, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("withCounts") String withCounts, @PathParam("pullRequestId") @NotNull String pullRequestId, @QueryParam("avatarSize") String avatarSize, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdDecline_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdDecline_404.class))),
            @APIResponse(
                    responseCode = "409",
                    description = "The pull request is not OPEN or has been updated since the version specified by the request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdDecline_409.class)))
    })
    ...
    RestPullRequest decline(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @QueryParam("version") String version, @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestPullRequestDeclineRequest dto);
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdDiffPath.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "If the request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdDiffPath_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository or pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdDiffPath_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdDiffPath_404.class)))
    })
    @Operation(summary = "Stream a diff within a pull request")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdDiffPath streamDiff_2(@QueryParam("avatarScheme") String avatarScheme, @PathParam("path") @NotNull String path,
            @PathParam("projectKey") @NotNull String projectKey, @QueryParam("contextLines") String contextLines, @QueryParam("sinceId") String sinceId, @QueryParam("srcPath") String srcPath, @QueryParam("diffType") String diffType, @QueryParam("untilId") String untilId, @PathParam("pullRequestId") @NotNull String pullRequestId, @QueryParam("whitespace") String whitespace, @QueryParam("withComments") String withComments, @QueryParam("avatarSize") String avatarSize, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
     ...
     * - there are conflicts that need to be manually resolved before merging; and/or - one or more merge checks have
     * vetoed the merge.
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to view the specified pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdMerge_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdMerge_404.class))),
            @APIResponse(
                    responseCode = "409",
                    description = "The specified pull request is not open.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdMerge_409.class)))
    })
    @Operation(summary = "Test if pull request can be merged")
    RestPullRequestMergeability canMerge(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);

    /**
     * Merge pull request.
     *
     * Merge the specified pull request immediately or set the pull request to auto-merge when all the merge checks pass
     * by setting <strong>autoMerge</strong> field in the request body.
     * The authenticated user must have <strong>REPO_WRITE</strong> permission for the repository that this pull request
     * targets to call this resource.
     *
     * @param projectKey     The project key. (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The auto-merge setting is not enabled for the repository that this pull request targets.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdMerge_403.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
    ...
    RestPullRequest merge(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @QueryParam("version") String version, @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestPullRequestMergeRequest dto);

    /**
     * Get the common ancestor between the latest commits of the source and target branches of the pull request.
     *
     * Returns the best common ancestor between the latest commits of the source and target branches of the pull
     * request.
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdMergeBase_404.class)))
    })
    ...
    RestCommit getMergeBase_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants_404.class)))
    })
    @Operation(summary = "Get pull request participants")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants listParticipants(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants_400.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants_409.class)))
    })
    @Operation(summary = "Assign pull request participant role")
    RestPullRequestParticipant assignParticipantRole(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @NotNull @Valid RestPullRequestAssignParticipantRoleRequest dto);
     ...
     * If the new {@code status} is <strong>NEEDS_WORK</strong> or <strong>APPROVED</strong> then the {@code
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipantsUserSlug_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipantsUserSlug_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipantsUserSlug_404.class))),
            @APIResponse(
                    responseCode = "409",
                    description = "The pull request is not open, or has been updated since the version specified by the request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipantsUserSlug_409.class)))
    })
    @Operation(summary = "Change pull request status")
    RestPullRequestParticipant updateStatus(@PathParam("projectKey") @NotNull String projectKey, @PathParam("userSlug") @NotNull String userSlug,
            @PathParam("pullRequestId") @NotNull String pullRequestId, @QueryParam("version") String version, @PathParam("repositorySlug") @NotNull String repositorySlug, @NotNull @Valid RestPullRequestAssignStatusRequest dto);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdReopen_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdReopen_404.class))),
            @APIResponse(
                    responseCode = "409",
                    description = "One of the following error cases occurred (check the error message for more details): \n\n- The pull request is not in a declined state.\n- The specified version is out of date.\n- The <em>to</em> repository is archived.\n",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdReopen_409.class)))
    })
    ...
    RestPullRequest reopen(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @QueryParam("version") String version, @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestPullRequestReopenRequest dto);

    /**
     * Get pull request comment thread.
     *
     * Get the <code>CommentThread</code> threads which have <code>Comment</code> comments that have a
     * <code>CommentState#PENDING</code> pending state and are part of the pull request review for the authenticated
     * user.
     *
     * @param projectKey     The project key. (not null)
     * @param pullRequestId  The pull request ID. (not null)
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A page of Comments from the supplied pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdReview.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository or pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdReview_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdReview_404.class)))
    })
    @Operation(summary = "Get pull request comment thread")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdReview getReview(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdReview_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the pull request, update a comment or watch the pull request.",
                    content = @Content(
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdReview_409.class)))
    })
    ...
    void finishReview(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @QueryParam("version") String version, @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestPullRequestFinishReviewRequest dto);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to view the pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdWatch_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdWatch_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsReviewerGroups.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsReviewerGroups_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository scope supplied does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsReviewerGroups_404.class)))
    })
    @Operation(summary = "Get all reviewer groups")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsReviewerGroups getReviewerGroups_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("repositorySlug") @NotNull String repositorySlug,
            @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsReviewerGroups_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository.",
                    content = @Content(
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsReviewerGroups_409.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to view the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsReviewerGroupsId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The ID supplied does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsReviewerGroupsId_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsReviewerGroupsId_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository.",
                    content = @Content(
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsReviewerGroupsId_409.class)))
    })
     ...
     * This does not return all the users of the group, only the users who are licensed and have <b>REPO_READ</b>
    ...
    @Operation(summary = "Get all reviewer groups")
    _ResponseApiLatestProjectsProjectKeySettingsReviewerGroups getReviewerGroups(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("start") BigDecimal start,
    ...
    RestUserReaction react_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commentId") @NotNull String commentId,
            @PathParam("pullRequestId") @NotNull String pullRequestId, @PathParam("emoticon") @NotNull String emoticon, @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseDefaultReviewersLatestProjectsProjectKeyReposRepositorySlugCondition_400.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseDefaultReviewersLatestProjectsProjectKeyReposRepositorySlugConditionId_400.class)))
    })
    @Operation(summary = "Update a default reviewer condition")
    RestPullRequestCondition updatePullRequestCondition_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("id") @NotNull String id,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid _RequestDefaultReviewersLatestProjectsProjectKeyReposRepositorySlugConditionId dto);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "An empty response indicating a pull request condition with the given ID could not be found.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseDefaultReviewersLatestProjectsProjectKeyReposRepositorySlugConditionId_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
     ...
     *
     * Return a set of users who are required reviewers for pull requests created from the given source repository and
     * ref to the given target ref in this repository.
     *
    ...
    List<RestPullRequestCondition> getReviewers(@QueryParam("targetRepoId") String targetRepoId, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("sourceRepoId") String sourceRepoId, @QueryParam("sourceRefId") String sourceRefId, @QueryParam("targetRefId") String targetRefId, @PathParam("repositorySlug") @NotNull String repositorySlug);
     ...
     * - The pull request is between Git repositories - The pull request is currently open - The pull request's {@link
     * PullRequest#getFromRef "from" ref} is a <i>branch</i>    - In other words, the qualified ID for the "from" ref
     * must start with <code>refs/heads/</code>    - Tags, and other non-standard refs, cannot be rebased - The current
     * user has an e-mail address    - Pull requests cannot be rebased anonymously    - `git rebase` records the current
     * user as the committer for the rebased commits, which        requires a name and e-mail address - The current user
     * has <i>write</i> access to the {@link PullRequest#getFromRef "from" ref}'s repository    - Note that in order to
     * <i>view</i> a pull request a user is only required to have <i>read</i>      access to the {@link
     * PullRequest#getToRef toRef}'s repository, so just because a user can <i>see</i>      a pull request does not mean
     * they can request a rebase
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to view the specified pull request.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseGitLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdRebase_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or pull request does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseGitLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdRebase_404.class)))
    })
    @Operation(summary = "Check PR rebase precondition")
    RestPullRequestRebaseability canRebase(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);
     ...
     * request's target branch. <i>This operation alters the pull request's source branch and cannot be undone.</i>
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that this pull request
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseGitLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdRebase_409.class)))
    })
    @Operation(summary = "Rebase pull request")
    RestPullRequestRebaseResult rebase(@PathParam("projectKey") @NotNull String projectKey, @PathParam("pullRequestId") @NotNull String pullRequestId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestPullRequestRebaseRequest dto);
}
