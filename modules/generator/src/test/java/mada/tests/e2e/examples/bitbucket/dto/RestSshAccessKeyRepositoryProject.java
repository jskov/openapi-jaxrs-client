...
public class RestSshAccessKeyRepositoryProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestSshAccessKeyRepositoryProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestSshAccessKeyRepositoryProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryProject avatarUrl(String avatarUrl) {
    ...
    public RestSshAccessKeyRepositoryProject description(String description) {
    ...
    public RestSshAccessKeyRepositoryProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryProject key(String key) {
    ...
    public RestSshAccessKeyRepositoryProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryProject namespace(String namespace) {
    ...
    public RestSshAccessKeyRepositoryProject public_(Boolean public_) {
    ...
    public RestSshAccessKeyRepositoryProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestSshAccessKeyRepositoryProject)) {
            return false;
        }
        RestSshAccessKeyRepositoryProject other = (RestSshAccessKeyRepositoryProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestSshAccessKeyRepositoryProject {");
