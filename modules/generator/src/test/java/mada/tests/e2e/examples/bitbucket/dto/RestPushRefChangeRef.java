...
public class RestPushRefChangeRef {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPushRefChangeRef.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestPushRefChangeRef displayId(String displayId) {
    ...
    public RestPushRefChangeRef id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestPushRefChangeRef type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPushRefChangeRef)) {
            return false;
        }
        RestPushRefChangeRef other = (RestPushRefChangeRef) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPushRefChangeRef {");
