...
public class RestJobInitiator {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestJobInitiator.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestJobInitiator active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public RestJobInitiator avatarUrl(String avatarUrl) {
    ...
    public RestJobInitiator displayName(String displayName) {
    ...
    public RestJobInitiator emailAddress(String emailAddress) {
    ...
    public RestJobInitiator id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestJobInitiator links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestJobInitiator name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestJobInitiator slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestJobInitiator type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestJobInitiator)) {
            return false;
        }
        RestJobInitiator other = (RestJobInitiator) o;
    ...
    public String toString() {
        ...
        sb.append("class RestJobInitiator {");
