...
public class RestDeploymentRepositoryProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestDeploymentRepositoryProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestDeploymentRepositoryProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestDeploymentRepositoryProject avatarUrl(String avatarUrl) {
    ...
    public RestDeploymentRepositoryProject description(String description) {
    ...
    public RestDeploymentRepositoryProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestDeploymentRepositoryProject key(String key) {
    ...
    public RestDeploymentRepositoryProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestDeploymentRepositoryProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestDeploymentRepositoryProject namespace(String namespace) {
    ...
    public RestDeploymentRepositoryProject public_(Boolean public_) {
    ...
    public RestDeploymentRepositoryProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestDeploymentRepositoryProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestDeploymentRepositoryProject)) {
            return false;
        }
        RestDeploymentRepositoryProject other = (RestDeploymentRepositoryProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestDeploymentRepositoryProject {");
