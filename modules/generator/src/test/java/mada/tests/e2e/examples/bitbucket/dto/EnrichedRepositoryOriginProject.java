...
public class EnrichedRepositoryOriginProject {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.EnrichedRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
  @Schema(readOnly = true)
  private TypeEnum type;

  public EnrichedRepositoryOriginProject avatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public EnrichedRepositoryOriginProject avatarUrl(String avatarUrl) {
  ...
  public EnrichedRepositoryOriginProject description(String description) {
  ...
  public EnrichedRepositoryOriginProject id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public EnrichedRepositoryOriginProject key(String key) {
  ...
  public EnrichedRepositoryOriginProject links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public EnrichedRepositoryOriginProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public EnrichedRepositoryOriginProject namespace(String namespace) {
  ...
  public EnrichedRepositoryOriginProject public_(Boolean public_) {
  ...
  public EnrichedRepositoryOriginProject scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public EnrichedRepositoryOriginProject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof EnrichedRepositoryOriginProject)) {
      return false;
    }
    EnrichedRepositoryOriginProject other = (EnrichedRepositoryOriginProject) o;
  ...
  public String toString() {
    ...
    sb.append("class EnrichedRepositoryOriginProject {");
