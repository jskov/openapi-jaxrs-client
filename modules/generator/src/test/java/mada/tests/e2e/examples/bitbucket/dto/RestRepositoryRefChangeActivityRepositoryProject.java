...
public class RestRepositoryRefChangeActivityRepositoryProject {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRepositoryRefChangeActivityRepositoryProject.TypeEnum.TypeEnumAdapter.class)
  @Schema(readOnly = true)
  private TypeEnum type;

  public RestRepositoryRefChangeActivityRepositoryProject avatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryProject avatarUrl(String avatarUrl) {
  ...
  public RestRepositoryRefChangeActivityRepositoryProject description(String description) {
  ...
  public RestRepositoryRefChangeActivityRepositoryProject id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryProject key(String key) {
  ...
  public RestRepositoryRefChangeActivityRepositoryProject links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryProject namespace(String namespace) {
  ...
  public RestRepositoryRefChangeActivityRepositoryProject public_(Boolean public_) {
  ...
  public RestRepositoryRefChangeActivityRepositoryProject scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestRepositoryRefChangeActivityRepositoryProject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestRepositoryRefChangeActivityRepositoryProject)) {
      return false;
    }
    RestRepositoryRefChangeActivityRepositoryProject other = (RestRepositoryRefChangeActivityRepositoryProject) o;
  ...
  public String toString() {
    ...
    sb.append("class RestRepositoryRefChangeActivityRepositoryProject {");
