...
/**
 * _ResponseApiLatestAdminPermissionsUsers_403
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestAdminPermissionsUsers_403 {
  public static final String JSON_PROPERTY_ERRORS = "errors";
  @JsonbProperty(JSON_PROPERTY_ERRORS)
  private List<RestErrorMessage> errors;

  public _ResponseApiLatestAdminPermissionsUsers_403 errors(List<RestErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public _ResponseApiLatestAdminPermissionsUsers_403 addErrorsItem(RestErrorMessage errorsItem) {
    if (this.errors == null) {
  ...
  public String toString() {
    ...
    sb.append("class _ResponseApiLatestAdminPermissionsUsers_403 {");
