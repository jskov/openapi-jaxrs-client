...
/**
 *  <b>NOTE: Discriminator mapping is not shown in Swagger UI (as of september 2023). Read the .yaml spec file directly for the discriminator mapping or use an alternative UI, for example Redoc.</b> <br/><br/> The identification of the contact. Can only be changed when identification.loginId is not set.
 */
