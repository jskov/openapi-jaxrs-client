...
public class RestMigrationRepositoryRepositoryProject {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestMigrationRepositoryRepositoryProject.TypeEnum.TypeEnumAdapter.class)
  @Schema(readOnly = true)
  private TypeEnum type;

  public RestMigrationRepositoryRepositoryProject avatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryProject avatarUrl(String avatarUrl) {
  ...
  public RestMigrationRepositoryRepositoryProject description(String description) {
  ...
  public RestMigrationRepositoryRepositoryProject id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryProject key(String key) {
  ...
  public RestMigrationRepositoryRepositoryProject links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryProject namespace(String namespace) {
  ...
  public RestMigrationRepositoryRepositoryProject public_(Boolean public_) {
  ...
  public RestMigrationRepositoryRepositoryProject scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestMigrationRepositoryRepositoryProject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestMigrationRepositoryRepositoryProject)) {
      return false;
    }
    RestMigrationRepositoryRepositoryProject other = (RestMigrationRepositoryRepositoryProject) o;
  ...
  public String toString() {
    ...
    sb.append("class RestMigrationRepositoryRepositoryProject {");
