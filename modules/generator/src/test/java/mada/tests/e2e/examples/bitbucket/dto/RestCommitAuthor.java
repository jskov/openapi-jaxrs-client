...
public class RestCommitAuthor {
  ...
  public RestCommitAuthor avatarUrl(String avatarUrl) {
  ...
  public RestCommitAuthor emailAddress(String emailAddress) {
  ...
  public RestCommitAuthor name(String name) {
    this.name = name;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RestCommitAuthor {");
