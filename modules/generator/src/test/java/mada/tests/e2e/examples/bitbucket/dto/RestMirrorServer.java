...
public class RestMirrorServer {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestMirrorServer.MirrorTypeEnum.MirrorTypeEnumAdapter.class)
    ...
    public RestMirrorServer baseUrl(String baseUrl) {
    ...
    public RestMirrorServer enabled(Boolean enabled) {
    ...
    public RestMirrorServer id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestMirrorServer lastSeenDate(OffsetDateTime lastSeenDate) {
    ...
    public RestMirrorServer mirrorType(MirrorTypeEnum mirrorType) {
    ...
    public RestMirrorServer name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestMirrorServer productType(String productType) {
    ...
    public RestMirrorServer productVersion(String productVersion) {
    ...
    public String toString() {
        ...
        sb.append("class RestMirrorServer {");
