...
public class RestAggregateRejectCounterUser {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestAggregateRejectCounterUser.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestAggregateRejectCounterUser active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public RestAggregateRejectCounterUser avatarUrl(String avatarUrl) {
    ...
    public RestAggregateRejectCounterUser displayName(String displayName) {
    ...
    public RestAggregateRejectCounterUser emailAddress(String emailAddress) {
    ...
    public RestAggregateRejectCounterUser id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestAggregateRejectCounterUser links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestAggregateRejectCounterUser name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestAggregateRejectCounterUser slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestAggregateRejectCounterUser type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestAggregateRejectCounterUser)) {
            return false;
        }
        RestAggregateRejectCounterUser other = (RestAggregateRejectCounterUser) o;
    ...
    public String toString() {
        ...
        sb.append("class RestAggregateRejectCounterUser {");
