...
public class RestMigrationRepositoryRepositoryOriginProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestMigrationRepositoryRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestMigrationRepositoryRepositoryOriginProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestMigrationRepositoryRepositoryOriginProject avatarUrl(String avatarUrl) {
    ...
    public RestMigrationRepositoryRepositoryOriginProject description(String description) {
    ...
    public RestMigrationRepositoryRepositoryOriginProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestMigrationRepositoryRepositoryOriginProject key(String key) {
    ...
    public RestMigrationRepositoryRepositoryOriginProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestMigrationRepositoryRepositoryOriginProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestMigrationRepositoryRepositoryOriginProject namespace(String namespace) {
    ...
    public RestMigrationRepositoryRepositoryOriginProject public_(Boolean public_) {
    ...
    public RestMigrationRepositoryRepositoryOriginProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestMigrationRepositoryRepositoryOriginProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestMigrationRepositoryRepositoryOriginProject)) {
            return false;
        }
        RestMigrationRepositoryRepositoryOriginProject other = (RestMigrationRepositoryRepositoryOriginProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestMigrationRepositoryRepositoryOriginProject {");
