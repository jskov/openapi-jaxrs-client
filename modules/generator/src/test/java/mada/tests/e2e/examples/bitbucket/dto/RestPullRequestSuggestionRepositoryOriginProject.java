...
public class RestPullRequestSuggestionRepositoryOriginProject {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestSuggestionRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
  @Schema(readOnly = true)
  private TypeEnum type;

  public RestPullRequestSuggestionRepositoryOriginProject avatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public RestPullRequestSuggestionRepositoryOriginProject avatarUrl(String avatarUrl) {
  ...
  public RestPullRequestSuggestionRepositoryOriginProject description(String description) {
  ...
  public RestPullRequestSuggestionRepositoryOriginProject id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestPullRequestSuggestionRepositoryOriginProject key(String key) {
  ...
  public RestPullRequestSuggestionRepositoryOriginProject links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestPullRequestSuggestionRepositoryOriginProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestPullRequestSuggestionRepositoryOriginProject namespace(String namespace) {
  ...
  public RestPullRequestSuggestionRepositoryOriginProject public_(Boolean public_) {
  ...
  public RestPullRequestSuggestionRepositoryOriginProject scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestPullRequestSuggestionRepositoryOriginProject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestPullRequestSuggestionRepositoryOriginProject)) {
      return false;
    }
    RestPullRequestSuggestionRepositoryOriginProject other = (RestPullRequestSuggestionRepositoryOriginProject) o;
  ...
  public String toString() {
    ...
    sb.append("class RestPullRequestSuggestionRepositoryOriginProject {");
