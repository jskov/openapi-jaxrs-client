...
public class RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin {
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin project(
            RestAutoMergeProcessingResultPullRequestFromRefRepositoryOriginProject project) {
