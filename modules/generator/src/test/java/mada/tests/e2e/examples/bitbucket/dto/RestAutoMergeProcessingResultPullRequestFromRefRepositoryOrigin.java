...
public class RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin {
    ...
    private RestAutoMergeProcessingResultPullRequestFromRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin description(String description) {
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin project(RestAutoMergeProcessingResultPullRequestFromRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    public @Valid RestAutoMergeProcessingResultPullRequestFromRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestAutoMergeProcessingResultPullRequestFromRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin)) {
            return false;
        }
        RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin other = (RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin {");
