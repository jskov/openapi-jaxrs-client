...
public class RestChangesetToCommitCommitter {
  ...
  public RestChangesetToCommitCommitter avatarUrl(String avatarUrl) {
  ...
  public RestChangesetToCommitCommitter emailAddress(String emailAddress) {
  ...
  public RestChangesetToCommitCommitter name(String name) {
    this.name = name;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RestChangesetToCommitCommitter {");
