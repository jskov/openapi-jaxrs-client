...
public class RestSshAccessKeyRepositoryOriginProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestSshAccessKeyRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestSshAccessKeyRepositoryOriginProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOriginProject avatarUrl(String avatarUrl) {
    ...
    public RestSshAccessKeyRepositoryOriginProject description(String description) {
    ...
    public RestSshAccessKeyRepositoryOriginProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOriginProject key(String key) {
    ...
    public RestSshAccessKeyRepositoryOriginProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOriginProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOriginProject namespace(String namespace) {
    ...
    public RestSshAccessKeyRepositoryOriginProject public_(Boolean public_) {
    ...
    public RestSshAccessKeyRepositoryOriginProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestSshAccessKeyRepositoryOriginProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestSshAccessKeyRepositoryOriginProject)) {
            return false;
        }
        RestSshAccessKeyRepositoryOriginProject other = (RestSshAccessKeyRepositoryOriginProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestSshAccessKeyRepositoryOriginProject {");
