...
public class _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants {
    ...
    private List<RestPullRequestParticipant> values;

    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants isLastPage(Boolean isLastPage) {
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants start(Integer start) {
        this.start = start;
        return this;
    }
     ...
     * @return values
     **/
    public @Valid List<RestPullRequestParticipant> getValues() {
        return values;
    }

    public void setValues(List<RestPullRequestParticipant> values) {
        this.values = values;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants)) {
            return false;
        }
        _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants other = (_ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants) o;
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPullRequestsPullRequestIdParticipants {");
