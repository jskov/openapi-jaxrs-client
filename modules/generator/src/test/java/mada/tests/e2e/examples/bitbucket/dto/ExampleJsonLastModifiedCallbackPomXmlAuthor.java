...
public class ExampleJsonLastModifiedCallbackPomXmlAuthor {
  ...
  public ExampleJsonLastModifiedCallbackPomXmlAuthor avatarUrl(String avatarUrl) {
  ...
  public ExampleJsonLastModifiedCallbackPomXmlAuthor emailAddress(String emailAddress) {
  ...
  public ExampleJsonLastModifiedCallbackPomXmlAuthor name(String name) {
    this.name = name;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class ExampleJsonLastModifiedCallbackPomXmlAuthor {");
