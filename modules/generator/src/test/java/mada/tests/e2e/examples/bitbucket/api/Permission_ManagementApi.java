...
public interface Permission_ManagementApi {
    ...
    /**
     * Get groups. Retrieve a page of groups.
     * 
    ...
    _ResponseApiLatestAdminGroups getGroups_1(@QueryParam("filter") String filter, @QueryParam("start") BigDecimal start,
    ...
    /**
     * Remove group. Deletes the specified group, removing them from the system. This also removes any permissions that may
    ...
    /**
     * Add multiple users to group. Add multiple users to a group.
     * 
     * The authenticated user must have the <strong>ADMIN</strong> permission to call this resource.
     *
     * @param dto (optional)
    ...
    /**
     * Get group members. Retrieves a list of users that are members of a specified group.
     * <p>
    ...
    /**
     * Get members not in group. Retrieves a list of users that are <em>not</em> members of a specified group.
     * <p>
     * The authenticated user must have the <strong>LICENSED_USER</strong> permission to call this resource.
     *
     * @param filter  If specified only users with usernames, display names or email addresses containing the supplied
    ...
    /**
     * Get groups with a global permission. Retrieve a page of groups that have been granted at least one global permission.
     * 
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission or higher to call this resource.
     *
    ...
    /**
     * Update global permission for group. Promote or demote a group's global permission level. Available global permissions
     * are:
     * 
     * 
     * - LICENSED_USER - PROJECT_CREATE - ADMIN - SYS_ADMIN
     * 
     * See the <a href="https://confluence.atlassian.com/display/BitbucketServer/Global+permissions">Bitbucket Data Center
     ...
     * level of a group with higher permissions than them)
     * 
     * 
     * to call this resource. In addition, a user may not demote a group's permission level if their own permission level
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsGroups_400.class),
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsGroups_403.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified group does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsGroups_404.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "409",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsGroups_409.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Revoke all global permissions for group. Revoke all global permissions for a group.
     * 
     * 
     * 
     * The authenticated user must have:
     * 
     * 
     * - <strong>ADMIN</strong> permission or higher; and - greater or equal permissions than the current permission level
     * of the group (a user may not demote the permission level of a group with higher permissions than them)
     * 
     * 
     * to call this resource. In addition, a user may not revoke a group's permissions if their own permission level would
    ...
    /**
     * Get groups with no global permission. Retrieve a page of groups that have no granted global permissions.
     * 
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission or higher to call this resource.
     *
    ...
    /**
     * Get users with a global permission. Retrieve a page of users that have been granted at least one global permission.
     * 
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission or higher to call this resource.
     *
    ...
    /**
     * Update global permission for user. Promote or demote the global permission level of a user. Available global
     * permissions are:
     * 
     * 
     * - LICENSED_USER - PROJECT_CREATE - ADMIN - SYS_ADMIN
     ...
     * with higher permissions than them)
     * 
     * 
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed or the specified permission does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsUsers_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not an administrator or doesn't have the\nspecified permission they are attempting to grant.",
            ...
            @APIResponse(
                    ...
                    description = "The action was disallowed as it would exceed the server's license limits.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsUsers_403.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified user does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsUsers_404.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "409",
                    description = "The action was disallowed as it would reduce the currently authenticated user's\npermission level or the currently authenticated user has a lower permission\nlevel than the user they are attempting to modify.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsUsers_409.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Revoke all global permissions for user. Revoke all global permissions for a user.
     * 
     * 
     * The authenticated user must have:
     * 
     * 
     * - <strong>ADMIN</strong> permission or higher; and - greater or equal permissions than the current permission level
     * of the user (a user may not demote the permission level of a user with higher permissions than them)
     * 
     * 
     * to call this resource. In addition, a user may not demote their own permission level.
     *
    ...
    /**
     * Get users with no global permission. Retrieve a page of users that have no granted global permissions.
     * 
     * 
     * The authenticated user must have <strong>ADMIN</strong> permission or higher to call this resource.
     *
    ...
    /**
     * Get directories. Retrieve a list of active directories.
     * 
     * The authenticated user must have the <strong>ADMIN</strong> permission to call this resource.
     *
    ...
    /**
     * Get users. Retrieve a page of users.
     * 
     * The authenticated user must have the <strong>LICENSED_USER</strong> permission to call this resource.
     *
    ...
    _ResponseApiLatestAdminUsers getUsers_1(@QueryParam("filter") String filter, @QueryParam("start") BigDecimal start,
            @QueryParam("limit") BigDecimal limit);

    /**
     * Create user. Creates a new user from the assembled query parameters.
     * 
     * The default group can be used to control initial permissions for new users, such as granting users the ability to
     * login or providing read access to certain projects or repositories. If the user is not added to the default group,
     * they may not be able to login after their account is created until explicit permissions are configured.
     * 
     * The authenticated user must have the <strong>ADMIN</strong> permission to call this resource.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsers_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
                    description = "The authenticated user is not an administrator.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsers_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "403",
                    description = "Adding the user to the default group would exceed the server's license limit.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsers_403.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "409",
                    description = "Another user with the same name already exists.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsers_409.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Update user details. Update a user's details.
     * 
     * The authenticated user must have the <strong>ADMIN</strong> permission to call this resource.
     *
     * @param dto (optional)
    ...
    /**
     * Remove user. Deletes the specified user, removing them from the system. This also removes any permissions that may
    ...
    /**
     * Add user to groups. Add a user to one or more groups.
     * 
     * The authenticated user must have the <strong>ADMIN</strong> permission to call this resource.
     *
     * @param dto (optional)
    ...
    /**
     * Clear CAPTCHA for user. Clears any CAPTCHA challenge that may constrain the user with the supplied username when they
     * authenticate. Additionally any counter or metric that contributed towards the user being issued the CAPTCHA challenge
     * (for instance too many consecutive failed logins) will also be reset.
     * 
     * The authenticated user must have the <strong>ADMIN</strong> permission to call this resource, and may not clear the
     * CAPTCHA of a user with greater permissions than themselves.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersCaptcha_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
                    description = "The authenticated user does not have the <strong>ADMIN</strong> permission.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersCaptcha_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "403",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersCaptcha_403.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified user does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersCaptcha_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Set password for user. Update a user's password.
     * 
     * The authenticated user must have the <strong>ADMIN</strong> permission to call this resource, and may not update the
     * password of a user with greater permissions than themselves.
     *
     * @param dto (optional)
     */
    @PUT
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersCredentials_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersCredentials_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified user does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersCredentials_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Check user removal. Validate if a user can be erased.
     * 
     ...
     * 
     * This endpoint does <strong>not</strong> perform the actual user erasure, and will not modify the application in any
     * way.
     * 
     * The authenticated user must have the <strong>ADMIN</strong> permission to call this resource.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersErasure_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersErasure_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The requested username does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersErasure_404.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "409",
                    description = "The requested username is the username of a not deleted user.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersErasure_409.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    /**
     * Erase user information. Erases personally identifying user data for a deleted user.
     * 
     ...
     * 
     * User erasure can only be performed on a deleted user. If the user has not been deleted first then this endpoint will
     * return a bad request and no erasure will be performed.
     * 
     * Erasing user data is <strong>irreversible</strong> and may lead to a degraded user experience. This method should not
     * be used as part of a standard user deletion and cleanup process.
     * 
    ...
    /**
     * Get groups for user. Retrieves a list of users that are <em>not</em> members of a specified group.
     * <p>
     * The authenticated user must have the <strong>LICENSED_USER</strong> permission to call this resource.
     *
     * @param filter  If specified only users with usernames, display names or email addresses containing the supplied
    ...
    /**
     * Find other groups for user. Retrieves a list of groups the specified user is <em>not</em> a member of.
     * <p>
     * The authenticated user must have the <strong>LICENSED_USER</strong> permission to call this resource.
     *
    ...
    /**
     * Remove user from group. Remove a user from a group. This is very similar to <code>groups/remove-user</code>, but with
     * the <em>context</em> and <em>itemName</em> attributes of the supplied request entity reversed. On the face of it this
    ...
    /**
     * Get group names. Retrieve a page of group names.
     * 
     * The authenticated user must have <strong>LICENSED_USER</strong> permission or higher to call this resource.
     *
    ...
    _ResponseApiLatestGroups getGroups(@QueryParam("filter") String filter, @QueryParam("start") BigDecimal start,
            @QueryParam("limit") BigDecimal limit);

    /**
     * Revoke all repository permissions for users and groups. Revoke all permissions for the specified repository for the
     * given groups and users.
     * 
     * The authenticated user must have <strong>PROJECT_ADMIN</strong> permission for the specified repository or a higher
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPermissions_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist, or one or more of the users or groups provided does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPermissions_404.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "409",
                    description = "The action was disallowed as it would revoke the currently authenticated user's permission on the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugPermissions_409.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    @Operation(summary = "Revoke all repository permissions for users and groups")
    void revokePermissions_1(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("user") String user,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("group") String group);

    /**
     * Get groups with permission to repository. Retrieve a page of groups that have been granted at least one permission
    ...
    /**
     * Update group repository permission. Promote or demote a group's permission level for the specified repository.
     ...
     * 
     * The authenticated user must have <strong>REPO_ADMIN</strong> permission for the specified repository or a higher
     * project or global permission to call this resource. In addition, a user may not demote a group's permission level if
     * their own permission level would be reduced as a result.
     *
     * @param projectKey     The project key. (not null)
     * @param name           The names of the groups. (not null)
     * @param permission     The permission to grant (not null)
    ...
    void setPermissionForGroup(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("name") @NotNull List<String> name,
            @QueryParam("permission") @NotNull String permission, @PathParam("repositorySlug") @NotNull String repositorySlug);

    /**
     * Revoke group repository permission. Revoke all permissions for the specified repository for a group.
     * 
     * The authenticated user must have <strong>REPO_ADMIN</strong> permission for the specified repository or a higher
     * project or global permission to call this resource.
     * 
    ...
    void revokePermissionsForGroup_2(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("name") @NotNull String name,
            @PathParam("repositorySlug") @NotNull String repositorySlug);

    /**
     * Get groups without repository permission. Retrieve a page of groups that have no granted permissions for the
    ...
    /**
     * Search repository permissions. Search direct and implied permissions of users and groups. This endpoint returns a
     * superset of the results returned by the /users and /groups endpoints because it allows filtering by project and
    ...
    /**
     * Get users with permission to repository. Retrieve a page of users that have been granted at least one permission for
    ...
    /**
     * Update user repository permission. Promote or demote a user's permission level for the specified repository.
     * Available repository permissions are:
     * 
    ...
    void setPermissionForUser(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("name") @NotNull List<String> name,
            @QueryParam("permission") @NotNull String permission, @PathParam("repositorySlug") @NotNull String repositorySlug);

    /**
     * Revoke user repository permission. Revoke all permissions for the specified repository for a user.
     * 
     * The authenticated user must have <strong>REPO_ADMIN</strong> permission for the specified repository or a higher
     * project or global permission to call this resource.
     * 
     * In addition, a user may not revoke their own repository permissions if they do not have a higher project or global
     * permission.
     *
     * @param projectKey     The project key. (not null)
     * @param name           The name of the user. (not null)
    ...
    void revokePermissionsForUser_2(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("name") @NotNull String name,
            @PathParam("repositorySlug") @NotNull String repositorySlug);

    /**
     * Get users without repository permission. Retrieve a page of <i>licensed</i> users that have no granted permissions
     * for the specified repository.
     * 
     * The authenticated user must have <strong>REPO_ADMIN</strong> permission for the specified repository or a higher
     * project or global permission to call this resource.
