...
public interface Permission_ManagementApi {
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroups.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not a licensed user.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroups_401.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestDetailedGroup.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroups_400.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroups_409.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroups_403.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified group does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroups_404.class))),
            @APIResponse(
                    responseCode = "409",
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The authenticated user does not have the <strong>ADMIN</strong> permission.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroupsAddUsers_401.class))),
            @APIResponse(
                    responseCode = "403",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroupsAddUsers_403.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified user or group does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroupsAddUsers_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroupsMoreMembers.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not a licensed user.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A page of users.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminGroupsMoreNonMembers.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not a licensed user.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsGroups.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not an administrator.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsGroupsNone.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not an administrator.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsUsers.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not an administrator.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminPermissionsUsersNone.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not an administrator.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestUserDirectory.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not an administrator",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUserDirectories_401.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A page of users.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsers.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not a licensed user.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestDetailedUser.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request was malformed.",
                    content = @Content(
            ...
            @APIResponse(
                    ...
                    description = "The specified user does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsers_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The authenticated user does not have the <strong>ADMIN</strong> permission.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersAddGroups_401.class))),
            @APIResponse(
                    responseCode = "403",
                    description = "The action was disallowed as it would exceed the server's licensing limit, or the groups permissions exceed the authenticated user's permission level.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersAddGroups_403.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified user or group does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersAddGroups_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestErasedUser.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request was malformed (e.g. if no username was supplied).",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A page of users.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersMoreMembers.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not a licensed user.",
                    content = @Content(
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A page of groups.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersMoreNonMembers.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not a licensed user.",
                    content = @Content(
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The authenticated user does not have the <strong>ADMIN</strong> permission.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersRemoveGroup_401.class))),
            @APIResponse(
                    responseCode = "403",
                    description = "The action was disallowed as the group has a higher permission level than the context user.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersRemoveGroup_403.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified user or group does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersRemoveGroup_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersRename_400.class))),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersRename_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified user does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestAdminUsersRename_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestGroups.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not a project administrator.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestGroups_401.class)))
    })
