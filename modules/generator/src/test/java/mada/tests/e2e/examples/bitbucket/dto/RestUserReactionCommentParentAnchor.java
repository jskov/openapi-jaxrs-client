...
public class RestUserReactionCommentParentAnchor {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentParentAnchor.DiffTypeEnum.DiffTypeEnumAdapter.class)
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentParentAnchor.FileTypeEnum.FileTypeEnumAdapter.class)
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentParentAnchor.LineTypeEnum.LineTypeEnumAdapter.class)
  private LineTypeEnum lineType;

  public static final String JSON_PROPERTY_PATH = "path";
  @JsonbProperty(JSON_PROPERTY_PATH)
  private RestUserReactionCommentParentAnchorPath path;

  public static final String JSON_PROPERTY_PULL_REQUEST = "pullRequest";
  @JsonbProperty(JSON_PROPERTY_PULL_REQUEST)
  @Schema(readOnly = true)
  private RestUserReactionCommentParentAnchorPullRequest pullRequest;

  public static final String JSON_PROPERTY_SRC_PATH = "srcPath";
  @JsonbProperty(JSON_PROPERTY_SRC_PATH)
  private RestUserReactionCommentParentAnchorSrcPath srcPath;
  ...
  public RestUserReactionCommentParentAnchor diffType(DiffTypeEnum diffType) {
  ...
  public RestUserReactionCommentParentAnchor fileType(FileTypeEnum fileType) {
  ...
  public RestUserReactionCommentParentAnchor fromHash(String fromHash) {
  ...
  public RestUserReactionCommentParentAnchor line(Integer line) {
    this.line = line;
    return this;
  }
  ...
  public RestUserReactionCommentParentAnchor lineComment(Boolean lineComment) {
  ...
  public RestUserReactionCommentParentAnchor lineType(LineTypeEnum lineType) {
  ...
  public RestUserReactionCommentParentAnchor path(RestUserReactionCommentParentAnchorPath path) {
    this.path = path;
    return this;
  }
  ...
  public void setPath(RestUserReactionCommentParentAnchorPath path) {
    this.path = path;
  }

  public RestUserReactionCommentParentAnchor pullRequest(RestUserReactionCommentParentAnchorPullRequest pullRequest) {
  ...
  public void setPullRequest(RestUserReactionCommentParentAnchorPullRequest pullRequest) {
    this.pullRequest = pullRequest;
  }

  public RestUserReactionCommentParentAnchor srcPath(RestUserReactionCommentParentAnchorSrcPath srcPath) {
  ...
  public void setSrcPath(RestUserReactionCommentParentAnchorSrcPath srcPath) {
    this.srcPath = srcPath;
  }

  public RestUserReactionCommentParentAnchor toHash(String toHash) {
    this.toHash = toHash;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestUserReactionCommentParentAnchor)) {
      return false;
    }
    RestUserReactionCommentParentAnchor other = (RestUserReactionCommentParentAnchor) o;
  ...
  public String toString() {
    ...
    sb.append("class RestUserReactionCommentParentAnchor {");
