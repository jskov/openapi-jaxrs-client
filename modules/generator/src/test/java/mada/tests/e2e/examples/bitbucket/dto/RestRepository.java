...
public class RestRepository {
  ...
  private RestRepositoryProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRepository.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestRepository archived(Boolean archived) {
  ...
  public RestRepository defaultBranch(String defaultBranch) {
  ...
  public RestRepository description(String description) {
  ...
  public RestRepository forkable(Boolean forkable) {
  ...
  public RestRepository hierarchyId(String hierarchyId) {
  ...
  public RestRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestRepository links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestRepository partition(Integer partition) {
  ...
  public RestRepository project(RestRepositoryProject project) {
   ...
   **/
  @Valid
  public RestRepositoryProject getProject() {
    return project;
  }

  public void setProject(RestRepositoryProject project) {
    this.project = project;
  }

  public RestRepository public_(Boolean public_) {
  ...
  public RestRepository relatedLinks(Object relatedLinks) {
  ...
  public RestRepository scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestRepository scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestRepository slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestRepository state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestRepository statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestRepository)) {
      return false;
    }
    RestRepository other = (RestRepository) o;
