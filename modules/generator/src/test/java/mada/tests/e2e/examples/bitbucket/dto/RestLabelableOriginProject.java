...
public class RestLabelableOriginProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestLabelableOriginProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestLabelableOriginProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestLabelableOriginProject avatarUrl(String avatarUrl) {
    ...
    public RestLabelableOriginProject description(String description) {
    ...
    public RestLabelableOriginProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestLabelableOriginProject key(String key) {
    ...
    public RestLabelableOriginProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestLabelableOriginProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestLabelableOriginProject namespace(String namespace) {
    ...
    public RestLabelableOriginProject public_(Boolean public_) {
    ...
    public RestLabelableOriginProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestLabelableOriginProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestLabelableOriginProject)) {
            return false;
        }
        RestLabelableOriginProject other = (RestLabelableOriginProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestLabelableOriginProject {");
