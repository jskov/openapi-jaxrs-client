...
public class RestCommentAuthor {
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAuthor.TypeEnum.TypeEnumAdapter.class)
  private TypeEnum type;

  public RestCommentAuthor active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestCommentAuthor avatarUrl(String avatarUrl) {
  ...
  public RestCommentAuthor displayName(String displayName) {
  ...
  public RestCommentAuthor emailAddress(String emailAddress) {
  ...
  public RestCommentAuthor id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestCommentAuthor links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestCommentAuthor name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCommentAuthor slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestCommentAuthor type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestCommentAuthor)) {
      return false;
    }
    RestCommentAuthor other = (RestCommentAuthor) o;
  ...
  public String toString() {
    ...
    sb.append("class RestCommentAuthor {");
