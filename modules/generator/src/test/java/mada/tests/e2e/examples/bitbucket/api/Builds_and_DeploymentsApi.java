...
public interface Builds_and_DeploymentsApi {
     ...
     *
     * Get a specific build status.
     * The authenticated user must have **REPO_READ** permission for the provided repository.The request can also be
     * made with anonymous 2-legged OAuth.<br>Since 7.14
     *
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestBuildStatus.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request has failed validation",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdBuilds_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions this repository",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdBuilds_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository, commit or build status does not exist",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdBuilds_404.class)))
    })
     ...
     * @param commitId       The commit. (not null)
     * @param repositorySlug The repository slug. (not null)
     * @param dto            The contents of the build status request are:
 ...
 (optional)
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestDeployment.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "could not get the deployment because the request was invalid",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdDeployments_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdDeployments_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or deployment does not exist",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdDeployments_404.class)))
    })
    @Operation(summary = "Get a deployment")
    RestDeployment get_1(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("deploymentSequenceNumber") String deploymentSequenceNumber,
            @PathParam("commitId") @NotNull String commitId, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("key") String key, @QueryParam("environmentKey") String environmentKey);
    ...
    RestDeployment createOrUpdateDeployment(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commitId") @NotNull String commitId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestDeploymentSetRequest dto);
    ...
    void delete_1(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("deploymentSequenceNumber") String deploymentSequenceNumber,
            @PathParam("commitId") @NotNull String commitId, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("key") String key, @QueryParam("environmentKey") String environmentKey);

    /**
     * Get build status statistics for multiple commits.
     *
     * Produces a list of the build statistics for multiple commits. Commits <em>without any builds associated with
     * them</em> will not be returned.<br> For example if the commit
     * <code>e00cf62997a027bbf785614a93e2e55bb331d268</code> does not have any build statuses associated with it, it
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestMultipleBuildStats.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The user is not authenticated or does not have the <strong>LICENSED</strong> permission",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBuildStatusLatestCommitsStats_401.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestBuildStats.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The user is not authenticated or does not have the <b>LICENSED</b> permission.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBuildStatusLatestCommitsStatsCommitId_401.class)))
    })
     ...
     * @param commitId       The commit ID on which to record the annotation. This must be a full 40 character commit hash. (not null)
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestInsightAnnotationsResponse.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions (<code>REPO_READ</code>) to get insight annotations.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdAnnotations_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified project, repository, commit, or report does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdAnnotations_404.class)))
    })
    ...
    RestInsightAnnotationsResponse getAnnotations(@QueryParam("severity") String severity, @QueryParam("path") String path,
            @PathParam("projectKey") @NotNull String projectKey, @QueryParam("externalId") String externalId, @PathParam("commitId") @NotNull String commitId, @QueryParam("type") String type, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("key") String key);
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReports.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions (<code>REPO_READ</code>) to get insight reports.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReports_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified project, repository or commit does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReports_404.class)))
    })
    @Operation(summary = "Get all Code Insights reports for a commit")
    _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReports getReports(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commitId") @NotNull String commitId,
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestInsightReport.class))),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReportsKey_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified project, repository, commit, or report does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReportsKey_404.class)))
    })
    @Operation(summary = "Get a Code Insights report")
    RestInsightReport getACodeInsightsReport(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commitId") @NotNull String commitId,
     ...
     * commit, and report key. A request to replace an existing report will be rejected if the authenticated user was
     * not the creator of the specified report.
     * The report key should be a unique string chosen by the reporter and should be unique enough not to potentially
     * clash with report keys from other reporters. We recommend using reverse DNS namespacing or a similar standard to
     * ensure that collision is avoided.<h1>Report parameters</h1><table summary="Report parameters">    <tr>
     * <th>Parameter</th>        <th>Description</th>        <th>Required?</th>        <th>Restrictions</th>
     * <th>Type</th>    </tr>    <tr>        <td>title</td>        <td>A short string representing the name of the
     * report</td>        <td>Yes</td>        <td>Max length: 450 characters (but we recommend that it is shorter so
     * that the display is nicer)</td>        <td>String</td>    </tr>    <tr>        <td>details</td>        <td>
     * A string to describe the purpose of the report. This string may contain             escaped newlines and if it
     * does it will display the content accordingly.        </td>        <td>No</td>        <td>Max length: 2000
     * characters</td>        <td>String</td>    </tr>    <tr>        <td>result</td>        <td>Indicates whether the
     * report is in a passed or failed state</td>        <td>No</td>        <td>One of: PASS, FAIL</td>
     * <td>String</td>    </tr>    <tr>        <td>data</td>        <td>An array of data fields (described below) to
     * display information on the report</td>        <td>No</td>        <td>Maximum 6 data fields</td>
     * <td>Array</td>    </tr>    <tr>        <td>reporter</td>        <td>A string to describe the tool or company who
     * created the report</td>        <td>No</td>        <td>Max length: 450 characters</td>        <td>String</td>
     * </tr>    <tr>        <td>link</td>        <td>A URL linking to the results of the report in an external
     * tool.</td>        <td>No</td>        <td>Must be a valid http or https URL</td>        <td>String</td>    </tr>
     * <tr>        <td>logoUrl</td>        <td>A URL to the report logo. If none is provided, the default insights logo
     * will be used.</td>        <td>No</td>        <td>Must be a valid http or https URL</td>        <td>String</td>
     * </tr></table><h1>Data parameters</h1>The data field on the report is an array with at most 6 data fields (JSON
     * maps) containing information that is to be displayed on the report (see the request example).<table summary="Data
     * parameters">    <tr>        <th>Parameter</th>        <th>Description</th>        <th>Type</th>    </tr>    <tr>
     * <td>title</td>        <td>A string describing what this data field represents</td>        <td>String</td>
     * </tr>    <tr>        <td>type</td>        <td>             The type of data contained in the value field. If not
     * provided,             then the value will be detected as a boolean, number or string.             One of:
     * BOOLEAN, DATE, DURATION, LINK, NUMBER, PERCENTAGE, TEXT        </td>        <td>String</td>    </tr>    <tr>
     * <td>value</td>        <td>            A value based on the type provided. Either a raw value             (string,
     * number or boolean) or a map. See below.        </td>    </tr></table><table summary="Types">    <tr>
     * <th>Type Field</th>        <th>Value Field Type</th>        <th>Value Field Display</th>    </tr>    <tr>
     * <td>None/Omitted</td>        <td>Number, String or Boolean (not an array or object)</td>        <td>Plain
     * text</td>    </tr>    <tr>        <td>BOOLEAN</td>        <td>Boolean</td>        <td>The value will be read as a
     * JSON boolean and displayed as 'Yes' or 'No'.</td>    </tr>    <tr>        <td>DATE</td>        <td>Number</td>
     * <td>             The value will be read as a JSON number in the form of a Unix timestamp
     * (milliseconds) and will be displayed as a relative date if the date is less             than one week ago,
     * otherwise it will be displayed as an absolute date.        </td>    </tr>    <tr>        <td>DURATION</td>
     * <td>Number</td>        <td>             The value will be read as a JSON number in milliseconds and
     * will be displayed in a human readable duration format.        </td>    </tr>    <tr>        <td>LINK</td>
     * <td>Object: {"linktext": "Link text here", "href": "https://link.to.annotation/in/external/tool"}</td>
     * <td>             The value will be read as a JSON object containing the fields "linktext"             and "href"
     * and will be displayed as a clickable link on the report.        </td>    </tr>    <tr>        <td>NUMBER</td>
     * <td>Number</td>        <td>             The value will be read as a JSON number and large numbers will
     * be displayed in a human readable format (e.g. 14.3k).        </td>    </tr>    <tr>        <td>PERCENTAGE</td>
     * <td>Number (between 0 and 100)</td>        <td>             The value will be read as a JSON number between 0 and
     * 100              and will be displayed with a percentage sign.        </td>    </tr>    <tr>        <td>TEXT</td>
     ...
     * @param commitId       The commit ID on which to record the annotation. This must be a full 40 character commit hash. (not null)
     * @param repositorySlug The repository slug. (not null)
     * @param key            A unique string representing the report as chosen by the reporter. This should be unique enough to not clash with other report's keys. To do this, we recommend namespacing the key using reverse DNS (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReportsKey_400.class))),
            @APIResponse(
                    responseCode = "401",
    ...
    RestInsightReport setACodeInsightsReport(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commitId") @NotNull String commitId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @PathParam("key") @NotNull String key, @Valid RestSetInsightReportRequest dto);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions (<code>REPO_READ needed</code>) to get insight reports.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReportsKeyAnnotations_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified project, repository, commit, or report does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReportsKeyAnnotations_404.class)))
    })
    @Operation(summary = "Get Code Insights annotations for a report")
    RestInsightAnnotationsResponse getAnnotations_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commitId") @NotNull String commitId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @PathParam("key") @NotNull String key);
     ...
     * annotations.   Annotations are posted separately from the report, and can be posted in bulk using this endpoint.
     * - Only the annotations that are on lines changed in the unified diff will be displayed. This means it is  likely
     * not all annotations posted will be displayed on the pull request  It also means that if the user is viewing a
     * side-by-side diff,  commit diff or iterative review diff they will not be able to view the annotations. - A
     * report cannot have more than 1000 annotations by default, however this property is congurable at an  instance
     * level. If the request would result in more than the maximum number of annotations being stored  then the entire
     * request is rejected and no new annotations are stored. - There is no de-duplication of annotations on Bitbucket
     * so be sure that reruns of builds will first  delete the report and annotations before creating them.
     * # Annotation parameters
     * |Parameter|Description|Required?|Restrictions|Type| |--- |--- |--- |--- |--- | |path|The path of the file on
     * which this annotation should be placed. This is the path of the filerelative to the git repository. If no path is
     * provided, then it will appear in the overview modalon all pull requests where the tip of the branch is the given
     * commit, regardless of which files weremodified.|No||String| |line|The line number that the annotation should
     * belong to. If no line number is provided, then it willdefault to 0 and in a pull request it will appear at the
     * top of the file specified by the path field.|No|Non-negative integer|Integer| |message|The message to display to
     * users|Yes|The maximum length accepted is 2000 characters, however the user interface may truncate this valuefor
     * display purposes. We recommend that the message is short and succinct, with further detailsavailable to the user
     * if needed on the page linked to by the the annotation link.|String| |severity|The severity of the
     * annotation|Yes|One of: LOW, MEDIUM, HIGH|String| |link|An http or https URL representing the location of the
     * annotation in the external tool|No||String| |type|The type of annotation posted|No|One of: VULNERABILITY,
     * CODE_SMELL, BUG|String| |externalId|If the caller requires a link to get or modify this annotation, then an ID
     * must be provided. It isnot used or required by Bitbucket, but only by the annotation creator for updating or
    ...
    void addAnnotations(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commitId") @NotNull String commitId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @PathParam("key") @NotNull String key, @Valid RestBulkAddInsightAnnotationRequest dto);
    ...
    void deleteAnnotations(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("externalId") String externalId,
            @PathParam("commitId") @NotNull String commitId, @PathParam("repositorySlug") @NotNull String repositorySlug, @PathParam("key") @NotNull String key);

    /**
     * Create or replace a Code Insights annotation.
     *
     * Create an annotation with the given external ID, or replace it if it already exists. A request to replace an
     * existing annotation will be rejected if the authenticated user was not the creator of the specified report.
     *
     * @param projectKey     The project key. (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user is not the author of the report, or the author no longer has sufficient permissions (<code>REPO_READ</code>).",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReportsKeyAnnotationsExternalId_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified project, repository, commit, report or annotation does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseInsightsLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdReportsKeyAnnotationsExternalId_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
    ...
    void setAnnotation(@PathParam("projectKey") @NotNull String projectKey, @PathParam("externalId") @NotNull String externalId,
            @PathParam("commitId") @NotNull String commitId, @PathParam("repositorySlug") @NotNull String repositorySlug, @PathParam("key") @NotNull String key, @Valid RestSingleAddInsightAnnotationRequest dto);
     ...
     * These fields are **required**:
     * - **buildParentKeys**: A non-empty list of build parent keys that require green builds for this merge check to
     * pass - **refMatcher.id**: The value to match refs against in the target branch - **refMatcher.type.id**: The type
     * of ref matcher, one of: "ANY_REF", "BRANCH", "PATTERN", "MODEL_CATEGORY" or "MODEL_BRANCH"
     * These fields are optional:
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = RestRequiredBuildCondition.class))),
            @APIResponse(
                    responseCode = "400",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseRequiredBuildsLatestProjectsProjectKeyReposRepositorySlugCondition_400.class))),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseRequiredBuildsLatestProjectsProjectKeyReposRepositorySlugCondition_401.class)))
    })
     ...
     * The authenticated user must have **REPO_ADMIN** permission for the target repository to update a required build
     * merge check.
     * The contents of the required build merge check request are:
     * These fields are **required**:
     * - **buildParentKeys**: A non-empty list of build parent keys that require green builds for this merge check to
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request was malformed. This could be caused because:\n\n- The build parent key list is empty\n- Either of the provided ref matchers is of an unrecognized type\n- Either of the provided ref matchers could not be created with the provided type and id\n\n\n",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseRequiredBuildsLatestProjectsProjectKeyReposRepositorySlugConditionId_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to create a required build merge check in this repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseRequiredBuildsLatestProjectsProjectKeyReposRepositorySlugConditionId_401.class)))
    })
    @Operation(summary = "Update a required builds merge check")
    RestRequiredBuildCondition updateRequiredBuildsMergeCheck(@PathParam("projectKey") @NotNull String projectKey, @PathParam("id") @NotNull long id,
     ...
     * The authenticated user must have **REPO_ADMIN** permission for the target repository to delete a required build
     * merge check.
     *
     * @param projectKey     The project that the repository belongs to (not null)
     * @param id             (not null)
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseRequiredBuildsLatestProjectsProjectKeyReposRepositorySlugConditions.class))),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseRequiredBuildsLatestProjectsProjectKeyReposRepositorySlugConditions_401.class)))
    })
    @Operation(summary = "Get required builds merge checks")
    _ResponseRequiredBuildsLatestProjectsProjectKeyReposRepositorySlugConditions getPageOfRequiredBuildsMergeChecks(@PathParam("projectKey") @NotNull String projectKey, @PathParam("repositorySlug") @NotNull String repositorySlug,
