...
public class RestReviewerGroupScope {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestReviewerGroupScope.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestReviewerGroupScope resourceId(Integer resourceId) {
    ...
    public RestReviewerGroupScope type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestReviewerGroupScope {");
