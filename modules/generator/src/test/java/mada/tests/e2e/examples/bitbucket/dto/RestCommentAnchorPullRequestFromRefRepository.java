...
public class RestCommentAnchorPullRequestFromRefRepository {
    ...
    @Schema(readOnly = true)
    private RestCommentAnchorPullRequestFromRefRepositoryOrigin origin;
    ...
    private RestCommentAnchorPullRequestFromRefRepositoryProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequestFromRefRepository.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestCommentAnchorPullRequestFromRefRepository archived(Boolean archived) {
    ...
    public RestCommentAnchorPullRequestFromRefRepository defaultBranch(String defaultBranch) {
    ...
    public RestCommentAnchorPullRequestFromRefRepository description(String description) {
    ...
    public RestCommentAnchorPullRequestFromRefRepository forkable(Boolean forkable) {
    ...
    public RestCommentAnchorPullRequestFromRefRepository hierarchyId(String hierarchyId) {
    ...
    public RestCommentAnchorPullRequestFromRefRepository id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepository links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepository name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepository origin(RestCommentAnchorPullRequestFromRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return origin
     **/
    public @Valid RestCommentAnchorPullRequestFromRefRepositoryOrigin getOrigin() {
        return origin;
    }

    public void setOrigin(RestCommentAnchorPullRequestFromRefRepositoryOrigin origin) {
        this.origin = origin;
    }

    public RestCommentAnchorPullRequestFromRefRepository partition(Integer partition) {
    ...
    public RestCommentAnchorPullRequestFromRefRepository project(RestCommentAnchorPullRequestFromRefRepositoryProject project) {
     ...
     * @return project
     **/
    public @Valid RestCommentAnchorPullRequestFromRefRepositoryProject getProject() {
        return project;
    }

    public void setProject(RestCommentAnchorPullRequestFromRefRepositoryProject project) {
        this.project = project;
    }

    public RestCommentAnchorPullRequestFromRefRepository public_(Boolean public_) {
    ...
    public RestCommentAnchorPullRequestFromRefRepository relatedLinks(Object relatedLinks) {
    ...
    public RestCommentAnchorPullRequestFromRefRepository scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepository scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepository slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepository state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepository statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentAnchorPullRequestFromRefRepository)) {
            return false;
        }
        RestCommentAnchorPullRequestFromRefRepository other = (RestCommentAnchorPullRequestFromRefRepository) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorPullRequestFromRefRepository {");
