...
public class RestPullRequestDeclineRequest {
    ...
    public RestPullRequestDeclineRequest comment(String comment) {
    ...
    public RestPullRequestDeclineRequest version(Integer version) {
