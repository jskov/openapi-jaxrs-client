...
public class RestUserReactionCommentParentResolver {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentParentResolver.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestUserReactionCommentParentResolver active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public RestUserReactionCommentParentResolver avatarUrl(String avatarUrl) {
    ...
    public RestUserReactionCommentParentResolver displayName(String displayName) {
    ...
    public RestUserReactionCommentParentResolver emailAddress(String emailAddress) {
    ...
    public RestUserReactionCommentParentResolver id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentParentResolver links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentParentResolver name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentParentResolver slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestUserReactionCommentParentResolver type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentParentResolver)) {
            return false;
        }
        RestUserReactionCommentParentResolver other = (RestUserReactionCommentParentResolver) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentParentResolver {");
