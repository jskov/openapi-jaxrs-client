...
public interface RepositoryApi {
     ...
     * resource.
     *
     * @param boostMatches   Controls whether exact and prefix matches will be boosted to the top (not null)
     * @param projectKey     The project key. (not null)
     * @param orderBy        Ordering of refs either ALPHABETICAL (by name) or MODIFICATION (last updated) (optional)
     * @param details        Whether to retrieve plugin-provided metadata about each branch (not null)
