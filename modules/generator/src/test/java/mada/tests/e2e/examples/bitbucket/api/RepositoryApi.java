...
public interface RepositoryApi {
     ...
     * Repositories are ordered from most recently to least recently accessed. <p>Only authenticated users may call this
     * resource.
     *
    ...
    _ResponseApiLatestProfileRecentRepos getRepositoriesRecentlyAccessed(@QueryParam("permission") String permission, @QueryParam("start") BigDecimal start,
            @QueryParam("limit") BigDecimal limit);

    /**
     * Stream archive of repository.
     *
     * Streams an archive of the repository's contents at the requested commit. If no `at=` commit is requested, an
     * archive of the default branch is streamed.
     * The <code>filename=</code> query parameter may be used to specify the exact filename to include in the
     * "Content-Disposition" header. If an explicit filename is not provided, one will be automatically generated based
     * on what is being archived. Its format depends on the at= value:
     * - No <code>at=</code> commit:     &lt;slug&gt;-&lt;default-branch-name&gt;@&lt;commit&gt;.&lt;format&gt;;
     * e.g. example-master@43c2f8a0fe8.zip - <code>at=</code>sha: &lt;slug&gt;-&lt;at&gt;.&lt;format&gt;; e.g.
     ...
     * - If the branch or tag is qualified (e.g. refs/heads/master, the short name         (master) will be included in
     * the filename     - If the branch or tag's <i>short name</i> includes slashes (e.g. release/4.6),         they
     ...
     * archive's contents should be placed. If the prefix does not end with /, one will be added automatically. The
     * prefix is <i>always</i> treated as a directory; it is not possible to use it to prepend characters to the entries
     * in the archive.
    ...
    void getArchive(@QueryParam("path") String path, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("filename") String filename, @QueryParam("at") String at, @QueryParam("prefix") String prefix, @QueryParam("format") String format, @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugAttachmentsAttachmentId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The attachment does not exist",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugAttachmentsAttachmentId_404.class)))
    })
    ...
    void getAttachment(@PathParam("projectKey") @NotNull String projectKey, @HeaderParam("User-Agent") String userAgent,
            @PathParam("attachmentId") @NotNull String attachmentId, @HeaderParam("Range") String range, @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugAttachmentsAttachmentIdMetadata_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The attachment or the attachment metadata does not exist",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugAttachmentsAttachmentIdMetadata_404.class)))
    })
    @Operation(summary = "Get attachment metadata")
    RestAttachmentMetadata getAttachmentMetadata(@PathParam("projectKey") @NotNull String projectKey, @PathParam("attachmentId") @NotNull String attachmentId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugAttachmentsAttachmentIdMetadata_400.class))),
            @APIResponse(
                    responseCode = "401",
    ...
    void saveAttachmentMetadata(@PathParam("projectKey") @NotNull String projectKey, @PathParam("attachmentId") @NotNull String attachmentId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, String dto);
    ...
    void deleteAttachmentMetadata(@PathParam("projectKey") @NotNull String projectKey, @PathParam("attachmentId") @NotNull String attachmentId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugBranches getBranches(@QueryParam("boostMatches") boolean boostMatches, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("orderBy") String orderBy, @QueryParam("details") boolean details, @QueryParam("filterText") String filterText, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("base") String base, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
     ...
     * that does not use size, type, blame or noContent.
     * 1. size will return a response like {"size":10000} 2. type will return a response like {"type":"FILE"}, where
     * possible values are    "DIRECTORY", "FILE" and "SUBMODULE" 3. blame <i>without</i> noContent will include blame
     * for the lines of    content returned on the page 4. blame <i>with</i> noContent will omit file contents and only
     * return    blame for the requested lines 5. noContent without blame is ignored and does nothing
     ...
     * - ?blame is the same as ?blame=true - ?blame&amp;noContent is the same as ?blame=true&amp;noContent=true - ?size
     * is the same as ?size=false - ?type is the same as ?type=false
     * The authenticated user must have <strong>REPO_READ</strong> permission for the specified repository to call this
     * resource.
     *
    ...
    void getContent(@QueryParam("noContent") String noContent, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("at") String at, @QueryParam("size") String size, @QueryParam("blame") String blame, @QueryParam("type") String type, @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugBrowsePath_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugBrowsePath_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository does not exist.",
                    content = @Content(
    ...
    void getContent_1(@QueryParam("noContent") String noContent, @PathParam("path") @NotNull String path,
            @PathParam("projectKey") @NotNull String projectKey, @QueryParam("at") String at, @QueryParam("size") String size, @QueryParam("blame") String blame, @QueryParam("type") String type, @PathParam("repositorySlug") @NotNull String repositorySlug);
     ...
     * - branch:  the branch on which the path should be modified or created - content: the full content of the file at
     * path - message: the message associated with this change, to be used as the commit message. Or null if the default
     * message should be used. - sourceCommitId: the commit ID of the file before it was edited, used to identify if
     * content has changed. Or null if this is a new file
     * The file can be updated or created on a new branch. In this case, the sourceBranch parameter should be provided
     * to identify the starting point for the new branch and the branch parameter identifies the branch to create the
     * new commit on.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugBrowsePath_403.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository does not exist.",
                    content = @Content(
     ...
     * <strong>Note:</strong> The implementation will apply a hard cap ({@code page.max.changes}) and it is not possible
     * to request subsequent content when that cap is exceeded.
     * The authenticated user must have <strong>REPO_READ</strong> permission for the specified repository to call this
     * resource.
     *
     * @param projectKey     The project key. (not null)
    ...
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugChanges getChanges_1(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("until") String until,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("since") String since, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);

    /**
     * Get commits.
     *
     * Retrieve a page of commits from a given starting commit or "between" two commits. If no explicit commit is
     * specified, the tip of the repository's default branch is assumed. commits may be identified by branch or tag name
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitId_400.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitId_404.class)))
    })
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A page of changes",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdChanges.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The until parameter was not supplied",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdChanges_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdChanges_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository or the since or until parameters supplied does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdChanges_404.class)))
    })
    @Operation(summary = "Get changes in commit")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdChanges getChanges(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commitId") @NotNull String commitId,
            @QueryParam("withComments") String withComments, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("since") String since, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
     ...
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that the commit is in
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdComments.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request was malformed.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdComments_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the comment",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdComments_401.class))),
            @APIResponse(
                    responseCode = "404",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdComments_404.class)))
    })
    @Operation(summary = "Search for commit comments")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdComments getComments(@QueryParam("path") String path, @PathParam("projectKey") @NotNull String projectKey,
            @PathParam("commitId") @NotNull String commitId, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("since") String since, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
     ...
     * </pre> Reply to a comment: <pre>{       "text": "A measured reply.",       "parent": {           "id": 1       }
     * } </pre> General file comment: <pre>{       "text": "An insightful general comment on a file.",       "anchor": {
     * "diffType": "COMMIT",           "fromHash": "6df3858eeb9a53a911cd17e66a9174d44ffb02cd",           "path":
     * "path/to/file",           "srcPath": "path/to/file",           "toHash":
     * "04c7c5c931b9418ca7b66f51fe934d0bd9b2ba4b"       } } </pre> File line comment: <pre>{       "text": "A pithy
     * comment on a particular line within a file.",       "anchor": {           "diffType": "COMMIT",           "line":
     * 1,           "lineType": "CONTEXT",           "fileType": "FROM",           "fromHash":
     * "6df3858eeb9a53a911cd17e66a9174d44ffb02cd",           "path": "path/to/file",           "srcPath":
     * "path/to/file",           "toHash": "04c7c5c931b9418ca7b66f51fe934d0bd9b2ba4b"       } } ```
     ...
     * toHash refer to the sinceId / untilId (respectively) used to produce the diff on which the comment was added.
     ...
     * the type of diff hunk, which can be:- 'ADDED' - for an added line;</li>- 'REMOVED' - for a removed line; or</li>-
     * 'CONTEXT' - for a line that was unmodified but is in the vicinity of the diff.</li>'fileType' refers to the file
     * of the diff to which the anchor should be attached - which is of relevance when displaying the diff in a
     * side-by-side way. Currently the supported values are:- 'FROM' - the source file of the diff</li>- 'TO' - the
     * destination file of the diff</li>If the current user is not a participant the user is added as one and updated to
     * watch the commit.
     * The authenticated user must have REPO_READ permission for the repository that the commit is in to call this
     * resource.
     *
     * @param projectKey     The project key (not null)
     * @param commitId       The <i>full ID</i> of the commit within the repository (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdComments_409.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to view the comment",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdCommentsCommentId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdCommentsCommentId_404.class)))
    })
     ...
     * server's version of the comment or the update will fail. To determine the current version of the comment, the
     * comment should be fetched from the server prior to the update. Look for the 'version' attribute in the returned
     * JSON structure.
     * The authenticated user must have <strong>REPO_READ</strong> permission for the repository that the commit is in
     * to call this resource.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdCommentsCommentId_400.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdCommentsCommentId_409.class)))
    })
    ...
    RestComment updateComment(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commentId") @NotNull String commentId,
            @PathParam("commitId") @NotNull String commitId, @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestComment dto);

    /**
     * Delete a commit comment.
     *
     * Delete a commit comment. Anyone can delete their own comment. Only users with <strong>REPO_ADMIN</strong> and
     * above may delete comments created by other users. Comments which have replies <i>may not be deleted</i>,
    ...
    void deleteComment(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commentId") @NotNull String commentId,
            @PathParam("commitId") @NotNull String commitId, @QueryParam("version") String version, @PathParam("repositorySlug") @NotNull String repositorySlug);
     ...
     * streamed lines, and it is not possible to request subsequent pages if that cap is exceeded. In the event that the
     * cap is reached, the diff will be cut short and one or more {@code truncated} flags will be set to true on the
     * "segments", "hunks" and "diffs" properties, as well as the top-level object, in the returned JSON response.
     * The authenticated user must have <strong>REPO_READ</strong> permission for the specified repository to call this
     * resource.
     *
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The until parameter was not supplied.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdDiffPath_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdDiffPath_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdDiffPath_404.class)))
    })
     ...
     * If more than one best common ancestor exists, only one will be returned. It is unspecified which will be
     * returned.
     *
     * @param projectKey     The project key (not null)
     * @param commitId       The <i>full ID</i> of the commit within the repository (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdMergeBase_400.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The project, repository, or commit(s) does not exist",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdMergeBase_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdWatch_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified project, repository or commit does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCommitsCommitIdWatch_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
     ...
     * If either the <code> from</code> or <code> to</code> commit are not specified, they will be replaced by the
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A page of changes.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCompareChanges.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The source repository,target repository, or commit does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCompareChanges_404.class)))
    })
    @Operation(summary = "Compare commits")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCompareChanges streamChanges(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("fromRepo") String fromRepo,
            @QueryParam("from") String from, @QueryParam("to") String to, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    description = "A page of commits.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCompareCommits.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The source repository,target repository, or commit does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCompareCommits_404.class)))
    })
    @Operation(summary = "Get accessible commits")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCompareCommits streamCommits(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("fromRepo") String fromRepo,
            @QueryParam("from") String from, @QueryParam("to") String to, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCompareDiffPath.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The source repository,target repository, or commit does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCompareDiffPath_404.class)))
    })
    @Operation(summary = "Get diff between commits")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugCompareDiffPath streamDiff_1(@PathParam("path") @NotNull String path, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("contextLines") String contextLines, @QueryParam("fromRepo") String fromRepo, @QueryParam("srcPath") String srcPath, @QueryParam("from") String from, @QueryParam("to") String to, @QueryParam("whitespace") String whitespace, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    void streamRawDiff(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("contextLines") String contextLines,
            @QueryParam("srcPath") String srcPath, @QueryParam("until") String until, @QueryParam("whitespace") String whitespace, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("since") String since);
    ...
    void streamRawDiff_1(@PathParam("path") @NotNull String path, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("contextLines") String contextLines, @QueryParam("srcPath") String srcPath, @QueryParam("until") String until, @QueryParam("whitespace") String whitespace, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("since") String since);
    ...
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFiles streamFiles(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("at") String at,
    ...
    @Operation(summary = "Get files in directory")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugFilesPath streamFiles_1(@PathParam("path") @NotNull String path, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("at") String at, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugHookScripts_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugHookScripts_404.class)))
    })
    @Operation(summary = "Get hook scripts")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugHookScripts getConfigurations_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("repositorySlug") @NotNull String repositorySlug,
            @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugHookScriptsScriptId_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the specified repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugHookScriptsScriptId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository slug supplied does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugHookScriptsScriptId_404.class)))
    })
    @Operation(summary = "Create/update a hook script")
    RestHookScriptConfig setConfiguration_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("scriptId") @NotNull String scriptId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @Valid RestHookScriptTriggers dto);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugLabelsLabelName_401.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugLabelsLabelName_404.class),
                            mediaType = MediaType.APPLICATION_JSON))
    })
     ...
     * Stream files.
     *
     * Streams files from the repository's root with the last commit to modify each file. Commit modifications are
     * traversed starting from the <code>at</code> commit or, if not specified, from the tip of the default branch.
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugLastModified_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugLastModified_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository does not exist or does not contain the <code>at</code> commit.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugLastModified_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "No <code>at</code> commit was specified. When streaming modifications, an explicit starting commit must be supplied.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugLastModifiedPath_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to view the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugLastModifiedPath_401.class))),
            @APIResponse(
                    responseCode = "404",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugLastModifiedPath_404.class)))
    })
    ...
    void streamPatch(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("until") String until,
            @QueryParam("allAncestors") String allAncestors, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("since") String since);
    ...
    void streamRaw(@PathParam("path") @NotNull String path, @PathParam("projectKey") @NotNull String projectKey,
            @QueryParam("at") String at, @QueryParam("markup") String markup, @QueryParam("htmlEscape") String htmlEscape, @QueryParam("includeHeadingId") String includeHeadingId, @QueryParam("hardwrap") String hardwrap, @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugRefChangeActivities.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The user is currently not authenticated or the user does not have REPO_ADMIN permission.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugRefChangeActivities_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugRefChangeActivities_404.class)))
    })
    @Operation(summary = "Get ref change activity")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugRefChangeActivities getRefChangeActivity(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("ref") String ref,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugRefChangeActivitiesBranches.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The user is currently not authenticated or the user does not have REPO_ADMIN permission.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugRefChangeActivitiesBranches_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugRefChangeActivitiesBranches_404.class)))
    })
    @Operation(summary = "Get branches with ref change activities for repository")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugRefChangeActivitiesBranches findBranches(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("filterText") String filterText,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsAutoDecline_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsAutoDecline_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsAutoDecline_400.class))),
            @APIResponse(
                    responseCode = "401",
     ...
     *
     * Retrieves the pull request auto-merge settings for the supplied repository. Project settings will be returned if
     * no explicit settings have been set for the repository. In the case that there are no project settings, the
     * default settings will be returned. If the repository's project has restricted its auto-merge settings, then the
     * settings of the project will be returned.
     * The authenticated user must have <strong>REPO_READ</strong> permission for this repository to call the resource.
     *
     * @param projectKey     The project key (not null)
     * @param repositorySlug The repository slug (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsAutoMerge_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsAutoMerge_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsAutoMerge_400.class))),
            @APIResponse(
                    responseCode = "401",
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsAutoMerge_403.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooks_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooks_404.class)))
    })
    @Operation(summary = "Get repository hooks")
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooks getRepositoryHooks_1(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("type") String type,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooksHookKey_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository hook does not exist for the given repository, or the repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooksHookKey_404.class)))
    })
    @Operation(summary = "Get repository hook")
    RestRepositoryHook getRepositoryHook_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("hookKey") @NotNull String hookKey,
            @PathParam("repositorySlug") @NotNull String repositorySlug);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooksHookKey_400.class),
                            mediaType = MediaType.APPLICATION_JSON)),
            @APIResponse(
                    responseCode = "401",
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooksHookKeyEnabled_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or hook does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooksHookKeyEnabled_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooksHookKeySettings_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository or hook does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooksHookKeySettings_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The settings specified are invalid.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsHooksHookKeySettings_400.class))),
            @APIResponse(
                    responseCode = "401",
     ...
     * com.atlassian.bitbucket.server.bundled-hooks.requiredApproversMergeHook instead) the number of approvals required
     * on a pull request for it to be mergeable, or 0 if the merge check is disabled -
     * com.atlassian.bitbucket.server.bundled-hooks.requiredApproversMergeHook - the merge check configuration for
     * required approvers - requiredAllApprovers - whether or not all approvers must approve a pull request for it to be
     * mergeable - requiredAllTasksComplete - whether or not all tasks on a pull request need to be completed for it to
     * be mergeable - requiredSuccessfulBuilds - (Deprecated, please use
     * com.atlassian.bitbucket.server.bitbucket-build.requiredBuildsMergeCheck instead) the number of successful builds
     * on a pull request for it to be mergeable, or 0 if the merge check is disabled -
     * com.atlassian.bitbucket.server.bitbucket-build.requiredBuildsMergeCheck - the merge check configuration for
     * required builds
     *
     * @param projectKey     The project key. (not null)
     * @param repositorySlug The repository slug. (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsPullRequests_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsPullRequests_404.class)))
    })
     ...
     * - mergeConfig - the merge strategy configuration for pull requests - requiredApprovers - (Deprecated, please use
     * com.atlassian.bitbucket.server.bundled-hooks.requiredApproversMergeHook instead) the number of approvals required
     * on a pull request for it to be mergeable, or 0 to disable the merge check -
     * com.atlassian.bitbucket.server.bundled-hooks.requiredApproversMergeHook - a json map containing the keys
     * 'enabled' (a boolean to enable or disable this merge check) and 'count' (an integer to set the number of required
     * approvals) - requiredAllApprovers - whether or not all approvers must approve a pull request for it to be
     * mergeable - requiredAllTasksComplete - whether or not all tasks on a pull request need to be completed for it to
     * be mergeable - requiredSuccessfulBuilds - (Deprecated, please use
     * com.atlassian.bitbucket.server.bitbucket-build.requiredBuildsMergeCheck instead) the number of successful builds
     * on a pull request for it to be mergeable, or 0 to disable the merge check -
     * com.atlassian.bitbucket.server.bitbucket-build.requiredBuildsMergeCheck - a json map containing the keys
     * 'enabled' (a boolean to enable or disable this merge check) and 'count' (an integer to set the number of required
     * builds)
     ...
     * configuration set for this repository's SCM type as set at the instance level, if present, otherwise - the
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugSettingsPullRequests_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to see the specified repository.",
                    content = @Content(
    ...
    _ResponseApiLatestProjectsProjectKeyReposRepositorySlugTags getTags(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("orderBy") String orderBy,
            @QueryParam("filterText") String filterText, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
     ...
     * Search webhooks.
     *
     * Search webhooks in this repository and parent project. This endpoint returns a superset of the results returned
     * by the /webhooks endpoint because it allows filtering by project scope too, not just repository webhooks.
     * The authenticated user must have <strong>REPO_ADMIN</strong> permission for the specified repository to call this
     * resource.
     *
     * @param projectKey     The project key. (not null)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The currently authenticated user has insufficient permissions to find webhooks in the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksSearch_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksSearch_404.class)))
    })
    ...
    void searchWebhooks(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("scopeType") String scopeType,
            @QueryParam("event") String event, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("statistics") boolean statistics);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksTest_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksTest_404.class)))
    })
    ...
    RestWebhookRequestResponse testWebhook_1(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("webhookId") int webhookId,
            @QueryParam("sslVerificationRequired") String sslVerificationRequired, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("url") String url, @Valid RestWebhookCredentials dto);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksWebhookId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository does not exist, or the webhook does not exist in the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksWebhookId_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksWebhookIdLatest_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist, or the webhook does not exist in the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksWebhookIdLatest_404.class)))
    })
    @Operation(summary = "Get last webhook invocation details")
    RestDetailedInvocation getLatestInvocation_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("webhookId") @NotNull String webhookId,
            @QueryParam("event") String event, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("outcome") String outcome);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksWebhookIdStatistics_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist, or the webhook does not exist in the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksWebhookIdStatistics_404.class)))
    })
    @Operation(summary = "Get webhook statistics")
    RestInvocationHistory getStatistics_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("webhookId") @NotNull String webhookId,
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksWebhookIdStatisticsSummary_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The repository does not exist, or the webhook does not exist in the repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseApiLatestProjectsProjectKeyReposRepositorySlugWebhooksWebhookIdStatisticsSummary_404.class)))
    })
    @Operation(summary = "Get webhook statistics summary")
    RestInvocationHistory getStatisticsSummary_1(@PathParam("projectKey") @NotNull String projectKey, @PathParam("webhookId") @NotNull String webhookId,
            @PathParam("repositorySlug") @NotNull String repositorySlug);
     ...
     * <b>Note on permissions.</b> In absence of the <code>permission</code> query parameter the implicit 'read'
     * permission is assumed. Please note that this permission is lower than the <tt>REPO_READ</tt> permission rather
     * than being equal to it. The implicit 'read' permission for a given repository is assigned to any user that has
     * any of the higher permissions, such as <tt>REPO_READ</tt>, as well as to anonymous users if the repository is
     * marked as public. The important implication of the above is that an anonymous request to this resource with a
     * permission level <tt>REPO_READ</tt> is guaranteed to receive an empty list of repositories as a result. For
     * anonymous requests it is therefore recommended to not specify the <tt>permission</tt> parameter at all.
     *
    ...
    _ResponseApiLatestRepos getRepositories_1(@QueryParam("archived") String archived, @QueryParam("projectname") String projectname,
            @QueryParam("projectkey") String projectkey, @QueryParam("visibility") String visibility, @QueryParam("name") String name, @QueryParam("permission") String permission, @QueryParam("state") String state, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchPermissionsLatestProjectsProjectKeyReposRepositorySlugRestrictions.class))),
            @APIResponse(
                    responseCode = "400",
                    description = "The request has failed validation.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchPermissionsLatestProjectsProjectKeyReposRepositorySlugRestrictions_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not permitted to get restrictions on the provided project",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchPermissionsLatestProjectsProjectKeyReposRepositorySlugRestrictions_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "No restriction exists for the provided ID.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchPermissionsLatestProjectsProjectKeyReposRepositorySlugRestrictions_404.class)))
    })
    @Operation(summary = "Search for ref restrictions")
    _ResponseBranchPermissionsLatestProjectsProjectKeyReposRepositorySlugRestrictions getRestrictions_1(@PathParam("projectKey") @NotNull String projectKey, @QueryParam("matcherType") String matcherType,
            @QueryParam("matcherId") String matcherId, @QueryParam("type") String type, @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    description = "The request has failed validation.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchPermissionsLatestProjectsProjectKeyReposRepositorySlugRestrictionsId_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user is not permitted to get restrictions on the provided project",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchPermissionsLatestProjectsProjectKeyReposRepositorySlugRestrictionsId_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "No restriction exists for the provided ID.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchPermissionsLatestProjectsProjectKeyReposRepositorySlugRestrictionsId_404.class)))
    })
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchUtilsLatestProjectsProjectKeyReposRepositorySlugBranches_400.class))),
            @APIResponse(
                    responseCode = "401",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchUtilsLatestProjectsProjectKeyReposRepositorySlugBranches_401.class))),
            @APIResponse(
                    responseCode = "409",
                    description = "The branch name overlapped with an existing branch",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchUtilsLatestProjectsProjectKeyReposRepositorySlugBranches_409.class)))
    })
    @Operation(summary = "Create branch")
     ...
     * The optional 'endPoint' parameter of the request may contain a commit ID that the provided ref name is  expected
     * to point to. Should the ref point to a different commit ID, a 400 response will be returned with  appropriate
     * error details.
     * The authenticated user must have an effective <strong>REPO_WRITE</strong> permission to call this resource. If
     * branch permissions are set up in the repository, the authenticated user must also have access to the branch name
    ...
    @APIResponses({
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchUtilsLatestProjectsProjectKeyReposRepositorySlugBranchesInfoCommitId.class))),
            @APIResponse(
                    responseCode = "500",
                    description = "The request has timed out processing the branch request",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseBranchUtilsLatestProjectsProjectKeyReposRepositorySlugBranchesInfoCommitId_500.class)))
    })
    @Operation(summary = "Get branch")
    _ResponseBranchUtilsLatestProjectsProjectKeyReposRepositorySlugBranchesInfoCommitId findByCommit(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commitId") @NotNull @Size(max = 40) String commitId,
            @PathParam("repositorySlug") @NotNull String repositorySlug, @QueryParam("start") BigDecimal start, @QueryParam("limit") BigDecimal limit);
    ...
    RestUserReaction react(@PathParam("projectKey") @NotNull String projectKey, @PathParam("commentId") @NotNull String commentId,
            @PathParam("commitId") @NotNull String commitId, @PathParam("emoticon") @NotNull String emoticon, @PathParam("repositorySlug") @NotNull String repositorySlug);
     ...
     * cannot manage synchronization, even on public repositories. Additionally, synchronization must be available for
     * the specified repository. Synchronization is only available if:
     ...
     * - <tt>MERGE</tt>: Merges in commits from the upstream ref. After applying this action, the   synchronized ref
     * will be <tt>AHEAD</tt> (as it still includes commits that do not exist   upstream.    - This action is only
     * supported for <tt>DIVERGED</tt> refs    - If a "commitMessage" is provided in the context, it will be used on the
     * merge commit.      Otherwise a default message is used. - <tt>DISCARD</tt>: <i>Throws away</i> local changes in
     * favour of those made upstream. This is a   <i>destructive</i> operation where commits in the local repository are
     * lost.    - No context entries are supported for this action    - If the upstream ref has been deleted, the local
     * ref is deleted as well    - Otherwise, the local ref is updated to reference the same commit as upstream, even if
     * the update is not fast-forward (similar to a forced push)
    ...
    @APIResponses({
            ...
            @APIResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseSyncLatestProjectsProjectKeyReposRepositorySlugSynchronize_400.class))),
            @APIResponse(
                    responseCode = "401",
                    description = "The currently authenticated user has insufficient permissions to update refs within the specified repository.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseSyncLatestProjectsProjectKeyReposRepositorySlugSynchronize_401.class))),
            @APIResponse(
                    responseCode = "404",
                    description = "The specified repository does not exist.",
                    content = @Content(
                            schema = @Schema(implementation = _ResponseSyncLatestProjectsProjectKeyReposRepositorySlugSynchronize_404.class))),
            @APIResponse(
                    responseCode = "409",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseSyncLatestProjectsProjectKeyReposRepositorySlugSynchronize_409.class))),
            @APIResponse(
                    responseCode = "501",
                    ...
                    content = @Content(
                            schema = @Schema(implementation = _ResponseSyncLatestProjectsProjectKeyReposRepositorySlugSynchronize_501.class)))
    })
