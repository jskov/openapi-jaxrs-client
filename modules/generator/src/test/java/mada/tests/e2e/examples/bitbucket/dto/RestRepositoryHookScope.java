...
public class RestRepositoryHookScope {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRepositoryHookScope.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestRepositoryHookScope resourceId(Integer resourceId) {
    ...
    public RestRepositoryHookScope type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestRepositoryHookScope {");
