...
public class RestAutoMergeProcessingResultPullRequestFromRefRepository {
  ...
  @Schema(readOnly = true)
  private RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin origin;
  ...
  private RestAutoMergeProcessingResultPullRequestFromRefRepositoryProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestAutoMergeProcessingResultPullRequestFromRefRepository.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository archived(Boolean archived) {
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository defaultBranch(String defaultBranch) {
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository description(String description) {
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository forkable(Boolean forkable) {
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository hierarchyId(String hierarchyId) {
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository origin(RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin origin) {
    this.origin = origin;
    return this;
  }
   ...
   **/
  @Valid
  public RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin getOrigin() {
    return origin;
  }

  public void setOrigin(RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin origin) {
    this.origin = origin;
  }

  public RestAutoMergeProcessingResultPullRequestFromRefRepository partition(Integer partition) {
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository project(RestAutoMergeProcessingResultPullRequestFromRefRepositoryProject project) {
   ...
   **/
  @Valid
  public RestAutoMergeProcessingResultPullRequestFromRefRepositoryProject getProject() {
    return project;
  }

  public void setProject(RestAutoMergeProcessingResultPullRequestFromRefRepositoryProject project) {
    this.project = project;
  }

  public RestAutoMergeProcessingResultPullRequestFromRefRepository public_(Boolean public_) {
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository relatedLinks(Object relatedLinks) {
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestAutoMergeProcessingResultPullRequestFromRefRepository statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestAutoMergeProcessingResultPullRequestFromRefRepository)) {
      return false;
    }
    RestAutoMergeProcessingResultPullRequestFromRefRepository other = (RestAutoMergeProcessingResultPullRequestFromRefRepository) o;
  ...
  public String toString() {
    ...
    sb.append("class RestAutoMergeProcessingResultPullRequestFromRefRepository {");
