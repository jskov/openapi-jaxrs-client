...
public class RestAutoMergeProcessingResultPullRequestFromRefRepository {
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepository origin(
            RestAutoMergeProcessingResultPullRequestFromRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
    ...
    public RestAutoMergeProcessingResultPullRequestFromRefRepository project(
            RestAutoMergeProcessingResultPullRequestFromRefRepositoryProject project) {
