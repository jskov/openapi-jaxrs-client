...
public class RestCommentParentAnchorPullRequestToRefRepositoryOrigin {
  ...
  private RestCommentParentAnchorPullRequestToRefRepositoryOriginProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentAnchorPullRequestToRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin archived(Boolean archived) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin defaultBranch(String defaultBranch) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin description(String description) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin forkable(Boolean forkable) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin hierarchyId(String hierarchyId) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin partition(Integer partition) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin project(RestCommentParentAnchorPullRequestToRefRepositoryOriginProject project) {
   ...
   **/
  @Valid
  public RestCommentParentAnchorPullRequestToRefRepositoryOriginProject getProject() {
    return project;
  }

  public void setProject(RestCommentParentAnchorPullRequestToRefRepositoryOriginProject project) {
    this.project = project;
  }

  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin public_(Boolean public_) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin relatedLinks(Object relatedLinks) {
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestCommentParentAnchorPullRequestToRefRepositoryOrigin statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestCommentParentAnchorPullRequestToRefRepositoryOrigin)) {
      return false;
    }
    RestCommentParentAnchorPullRequestToRefRepositoryOrigin other = (RestCommentParentAnchorPullRequestToRefRepositoryOrigin) o;
  ...
  public String toString() {
    ...
    sb.append("class RestCommentParentAnchorPullRequestToRefRepositoryOrigin {");
