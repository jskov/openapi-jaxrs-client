...
public class RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin {
    ...
    private RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin description(String description) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin project(RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    public @Valid RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin)) {
            return false;
        }
        RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin other = (RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin {");
