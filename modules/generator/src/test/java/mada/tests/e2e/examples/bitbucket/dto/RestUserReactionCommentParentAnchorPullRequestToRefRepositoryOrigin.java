...
public class RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin {
    ...
    public RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOrigin project(
            RestUserReactionCommentParentAnchorPullRequestToRefRepositoryOriginProject project) {
