...
public class EnrichedRepository {
  ...
  @Schema(readOnly = true)
  private EnrichedRepositoryOrigin origin;
  ...
  private EnrichedRepositoryProject project;

  public static final String JSON_PROPERTY_PROPERTIES = "properties";
  @JsonbProperty(JSON_PROPERTY_PROPERTIES)
  private EnrichedRepositoryProperties properties;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.EnrichedRepository.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public EnrichedRepository archived(Boolean archived) {
  ...
  public EnrichedRepository defaultBranch(String defaultBranch) {
  ...
  public EnrichedRepository description(String description) {
  ...
  public EnrichedRepository forkable(Boolean forkable) {
  ...
  public EnrichedRepository hierarchyId(String hierarchyId) {
  ...
  public EnrichedRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public EnrichedRepository links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public EnrichedRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public EnrichedRepository origin(EnrichedRepositoryOrigin origin) {
    this.origin = origin;
    return this;
  }
  ...
  public void setOrigin(EnrichedRepositoryOrigin origin) {
    this.origin = origin;
  }

  public EnrichedRepository partition(Integer partition) {
  ...
  public EnrichedRepository project(EnrichedRepositoryProject project) {
  ...
  public void setProject(EnrichedRepositoryProject project) {
    this.project = project;
  }

  public EnrichedRepository properties(EnrichedRepositoryProperties properties) {
  ...
  public void setProperties(EnrichedRepositoryProperties properties) {
    this.properties = properties;
  }

  public EnrichedRepository public_(Boolean public_) {
  ...
  public EnrichedRepository relatedLinks(Object relatedLinks) {
  ...
  public EnrichedRepository scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public EnrichedRepository scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public EnrichedRepository slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public EnrichedRepository state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public EnrichedRepository statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof EnrichedRepository)) {
      return false;
    }
    EnrichedRepository other = (EnrichedRepository) o;
  ...
  public String toString() {
    ...
    sb.append("class EnrichedRepository {");
