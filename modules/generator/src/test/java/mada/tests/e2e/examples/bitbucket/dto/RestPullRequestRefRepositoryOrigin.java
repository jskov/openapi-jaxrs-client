...
public class RestPullRequestRefRepositoryOrigin {
    ...
    private RestPullRequestRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestPullRequestRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestPullRequestRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestPullRequestRefRepositoryOrigin description(String description) {
    ...
    public RestPullRequestRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestPullRequestRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestPullRequestRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestPullRequestRefRepositoryOrigin project(RestPullRequestRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    public @Valid RestPullRequestRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestPullRequestRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestPullRequestRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestPullRequestRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestPullRequestRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestPullRequestRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestPullRequestRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestPullRequestRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestPullRequestRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestRefRepositoryOrigin)) {
            return false;
        }
        RestPullRequestRefRepositoryOrigin other = (RestPullRequestRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestRefRepositoryOrigin {");
