...
public class RestCommentAnchorPullRequestToRefRepositoryOrigin {
    ...
    private RestCommentAnchorPullRequestToRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequestToRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin description(String description) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin project(RestCommentAnchorPullRequestToRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    @Valid public RestCommentAnchorPullRequestToRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestCommentAnchorPullRequestToRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestCommentAnchorPullRequestToRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestToRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentAnchorPullRequestToRefRepositoryOrigin)) {
            return false;
        }
        RestCommentAnchorPullRequestToRefRepositoryOrigin other = (RestCommentAnchorPullRequestToRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorPullRequestToRefRepositoryOrigin {");
