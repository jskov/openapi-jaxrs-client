...
public class RestCommentThreadDiffAnchorPullRequestFromRefRepository {
  ...
  @Schema(readOnly = true)
  private RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin origin;
  ...
  private RestCommentThreadDiffAnchorPullRequestFromRefRepositoryProject project;
  ...
  @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentThreadDiffAnchorPullRequestFromRefRepository.StateEnum.StateEnumAdapter.class)
  @Schema(readOnly = true)
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository archived(Boolean archived) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository defaultBranch(String defaultBranch) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository description(String description) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository forkable(Boolean forkable) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository hierarchyId(String hierarchyId) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository origin(RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin origin) {
    this.origin = origin;
    return this;
  }
   ...
   **/
  @Valid
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin getOrigin() {
    return origin;
  }

  public void setOrigin(RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin origin) {
    this.origin = origin;
  }

  public RestCommentThreadDiffAnchorPullRequestFromRefRepository partition(Integer partition) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository project(RestCommentThreadDiffAnchorPullRequestFromRefRepositoryProject project) {
   ...
   **/
  @Valid
  public RestCommentThreadDiffAnchorPullRequestFromRefRepositoryProject getProject() {
    return project;
  }

  public void setProject(RestCommentThreadDiffAnchorPullRequestFromRefRepositoryProject project) {
    this.project = project;
  }

  public RestCommentThreadDiffAnchorPullRequestFromRefRepository public_(Boolean public_) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository relatedLinks(Object relatedLinks) {
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository scmId(String scmId) {
    this.scmId = scmId;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RestCommentThreadDiffAnchorPullRequestFromRefRepository statusMessage(String statusMessage) {
  ...
  public String toString() {
    ...
    sb.append("class RestCommentThreadDiffAnchorPullRequestFromRefRepository {");
