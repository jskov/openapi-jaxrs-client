...
public class RestCommentThreadDiffAnchorPullRequestFromRefRepository {
    ...
    public RestCommentThreadDiffAnchorPullRequestFromRefRepository origin(
            RestCommentThreadDiffAnchorPullRequestFromRefRepositoryOrigin origin) {
        this.origin = origin;
        return this;
    }
    ...
    public RestCommentThreadDiffAnchorPullRequestFromRefRepository project(
            RestCommentThreadDiffAnchorPullRequestFromRefRepositoryProject project) {
