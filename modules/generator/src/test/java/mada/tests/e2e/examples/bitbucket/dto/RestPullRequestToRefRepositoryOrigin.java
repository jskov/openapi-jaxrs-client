...
public class RestPullRequestToRefRepositoryOrigin {
    ...
    private RestPullRequestToRefRepositoryOriginProject project;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestPullRequestToRefRepositoryOrigin.StateEnum.StateEnumAdapter.class)
    @Schema(readOnly = true)
    ...
    public RestPullRequestToRefRepositoryOrigin archived(Boolean archived) {
    ...
    public RestPullRequestToRefRepositoryOrigin defaultBranch(String defaultBranch) {
    ...
    public RestPullRequestToRefRepositoryOrigin description(String description) {
    ...
    public RestPullRequestToRefRepositoryOrigin forkable(Boolean forkable) {
    ...
    public RestPullRequestToRefRepositoryOrigin hierarchyId(String hierarchyId) {
    ...
    public RestPullRequestToRefRepositoryOrigin id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOrigin links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOrigin name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOrigin partition(Integer partition) {
    ...
    public RestPullRequestToRefRepositoryOrigin project(RestPullRequestToRefRepositoryOriginProject project) {
     ...
     * @return project
     **/
    @Valid public RestPullRequestToRefRepositoryOriginProject getProject() {
        return project;
    }

    public void setProject(RestPullRequestToRefRepositoryOriginProject project) {
        this.project = project;
    }

    public RestPullRequestToRefRepositoryOrigin public_(Boolean public_) {
    ...
    public RestPullRequestToRefRepositoryOrigin relatedLinks(Object relatedLinks) {
    ...
    public RestPullRequestToRefRepositoryOrigin scmId(String scmId) {
        this.scmId = scmId;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOrigin scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOrigin slug(String slug) {
        this.slug = slug;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOrigin state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestPullRequestToRefRepositoryOrigin statusMessage(String statusMessage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPullRequestToRefRepositoryOrigin)) {
            return false;
        }
        RestPullRequestToRefRepositoryOrigin other = (RestPullRequestToRefRepositoryOrigin) o;
    ...
    public String toString() {
        ...
        sb.append("class RestPullRequestToRefRepositoryOrigin {");
