...
/**
 * _ResponseApiLatestAdminPermissionsGroupsNone
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestAdminPermissionsGroupsNone {
    ...
    public _ResponseApiLatestAdminPermissionsGroupsNone isLastPage(Boolean isLastPage) {
    ...
    public _ResponseApiLatestAdminPermissionsGroupsNone limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestAdminPermissionsGroupsNone nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseApiLatestAdminPermissionsGroupsNone size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestAdminPermissionsGroupsNone start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseApiLatestAdminPermissionsGroupsNone values(List<RestDetailedGroup> values) {
        this.values = values;
        return this;
    }

    public _ResponseApiLatestAdminPermissionsGroupsNone addValuesItem(RestDetailedGroup valuesItem) {
        if (this.values == null) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseApiLatestAdminPermissionsGroupsNone)) {
            return false;
        }
        _ResponseApiLatestAdminPermissionsGroupsNone other = (_ResponseApiLatestAdminPermissionsGroupsNone) o;
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestAdminPermissionsGroupsNone {");
