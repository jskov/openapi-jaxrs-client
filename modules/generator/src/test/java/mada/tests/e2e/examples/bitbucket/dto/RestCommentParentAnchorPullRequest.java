...
public class RestCommentParentAnchorPullRequest {
    ...
    private RestCommentParentAnchorPullRequestFromRef fromRef;
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentParentAnchorPullRequest.StateEnum.StateEnumAdapter.class)
    ...
    private RestCommentParentAnchorPullRequestToRef toRef;
    ...
    public RestCommentParentAnchorPullRequest closed(Boolean closed) {
        this.closed = closed;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequest closedDate(Long closedDate) {
    ...
    public RestCommentParentAnchorPullRequest createdDate(Long createdDate) {
    ...
    public RestCommentParentAnchorPullRequest description(String description) {
    ...
    public RestCommentParentAnchorPullRequest draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequest fromRef(RestCommentParentAnchorPullRequestFromRef fromRef) {
     ...
     * @return fromRef
     **/
    @Valid public RestCommentParentAnchorPullRequestFromRef getFromRef() {
        return fromRef;
    }

    public void setFromRef(RestCommentParentAnchorPullRequestFromRef fromRef) {
        this.fromRef = fromRef;
    }

    public RestCommentParentAnchorPullRequest htmlDescription(String htmlDescription) {
    ...
    public RestCommentParentAnchorPullRequest id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequest links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequest locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequest open(Boolean open) {
        this.open = open;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequest participants(List<RestPullRequestParticipant> participants) {
        this.participants = participants;
        return this;
    }

    public RestCommentParentAnchorPullRequest addParticipantsItem(RestPullRequestParticipant participantsItem) {
    ...
    public RestCommentParentAnchorPullRequest reviewers(List<RestPullRequestParticipant> reviewers) {
        this.reviewers = reviewers;
        return this;
    }

    public RestCommentParentAnchorPullRequest addReviewersItem(RestPullRequestParticipant reviewersItem) {
    ...
    public RestCommentParentAnchorPullRequest state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequest title(String title) {
        this.title = title;
        return this;
    }
    ...
    public RestCommentParentAnchorPullRequest toRef(RestCommentParentAnchorPullRequestToRef toRef) {
        this.toRef = toRef;
        return this;
    }
     ...
     * @return toRef
     **/
    @Valid public RestCommentParentAnchorPullRequestToRef getToRef() {
        return toRef;
    }

    public void setToRef(RestCommentParentAnchorPullRequestToRef toRef) {
        this.toRef = toRef;
    }

    public RestCommentParentAnchorPullRequest updatedDate(Long updatedDate) {
    ...
    public RestCommentParentAnchorPullRequest version(Integer version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentParentAnchorPullRequest)) {
            return false;
        }
        RestCommentParentAnchorPullRequest other = (RestCommentParentAnchorPullRequest) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentParentAnchorPullRequest {");
