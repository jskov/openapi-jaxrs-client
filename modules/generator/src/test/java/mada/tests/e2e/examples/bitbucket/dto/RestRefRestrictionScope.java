...
public class RestRefRestrictionScope {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRefRestrictionScope.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestRefRestrictionScope resourceId(Integer resourceId) {
    ...
    public RestRefRestrictionScope type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestRefRestrictionScope {");
