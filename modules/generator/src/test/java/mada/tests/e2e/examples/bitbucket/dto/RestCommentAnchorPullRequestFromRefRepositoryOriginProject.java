...
public class RestCommentAnchorPullRequestFromRefRepositoryOriginProject {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestCommentAnchorPullRequestFromRefRepositoryOriginProject.TypeEnum.TypeEnumAdapter.class)
    @Schema(readOnly = true)
    private TypeEnum type;

    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject avatar(String avatar) {
        this.avatar = avatar;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject avatarUrl(String avatarUrl) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject description(String description) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject key(String key) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject links(Object links) {
        this.links = links;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject namespace(String namespace) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject public_(Boolean public_) {
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject scope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public RestCommentAnchorPullRequestFromRefRepositoryOriginProject type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestCommentAnchorPullRequestFromRefRepositoryOriginProject)) {
            return false;
        }
        RestCommentAnchorPullRequestFromRefRepositoryOriginProject other = (RestCommentAnchorPullRequestFromRefRepositoryOriginProject) o;
    ...
    public String toString() {
        ...
        sb.append("class RestCommentAnchorPullRequestFromRefRepositoryOriginProject {");
