...
/**
 * _ResponseApiLatestAdminUsersMoreNonMembers
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestAdminUsersMoreNonMembers {
    ...
    public _ResponseApiLatestAdminUsersMoreNonMembers isLastPage(Boolean isLastPage) {
    ...
    public _ResponseApiLatestAdminUsersMoreNonMembers limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestAdminUsersMoreNonMembers nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseApiLatestAdminUsersMoreNonMembers size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestAdminUsersMoreNonMembers start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseApiLatestAdminUsersMoreNonMembers values(List<RestDetailedGroup> values) {
        this.values = values;
        return this;
    }

    public _ResponseApiLatestAdminUsersMoreNonMembers addValuesItem(RestDetailedGroup valuesItem) {
        if (this.values == null) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseApiLatestAdminUsersMoreNonMembers)) {
            return false;
        }
        _ResponseApiLatestAdminUsersMoreNonMembers other = (_ResponseApiLatestAdminUsersMoreNonMembers) o;
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestAdminUsersMoreNonMembers {");
