...
public class RestRefChange {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRefChange.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestRefChange fromHash(String fromHash) {
    ...
    public RestRefChange ref(RestRefChangeRef ref) {
        this.ref = ref;
        return this;
    }
     ...
     **/
    @Valid
    public RestRefChangeRef getRef() {
        return ref;
    }

    public void setRef(RestRefChangeRef ref) {
        this.ref = ref;
    }

    public RestRefChange refId(String refId) {
        this.refId = refId;
        return this;
    }
    ...
    public RestRefChange toHash(String toHash) {
        this.toHash = toHash;
        return this;
    }
    ...
    public RestRefChange type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestRefChange)) {
            return false;
        }
        RestRefChange other = (RestRefChange) o;
