...
public class RestNode {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestNode.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestNode id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestNode name(String name) {
        this.name = name;
        return this;
    }
    ...
    public RestNode type(TypeEnum type) {
        this.type = type;
        return this;
    }
