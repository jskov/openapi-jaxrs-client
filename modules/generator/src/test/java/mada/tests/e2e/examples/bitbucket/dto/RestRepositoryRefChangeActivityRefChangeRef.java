...
public class RestRepositoryRefChangeActivityRefChangeRef {
    ...
    @JsonbTypeAdapter(mada.tests.e2e.examples.bitbucket.dto.RestRepositoryRefChangeActivityRefChangeRef.TypeEnum.TypeEnumAdapter.class)
    private TypeEnum type;

    public RestRepositoryRefChangeActivityRefChangeRef displayId(String displayId) {
    ...
    public RestRepositoryRefChangeActivityRefChangeRef id(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestRepositoryRefChangeActivityRefChangeRef type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class RestRepositoryRefChangeActivityRefChangeRef {");
