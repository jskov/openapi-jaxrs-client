...
/**
 * _ResponseApiLatestLabels
 */
@javax.annotation.processing.Generated(value = "dk.mada.jaxrs.Generator")
public class _ResponseApiLatestLabels {
    ...
    private List<RestLabel> values;

    public _ResponseApiLatestLabels isLastPage(Boolean isLastPage) {
    ...
    public _ResponseApiLatestLabels limit(BigDecimal limit) {
        this.limit = limit;
        return this;
    }
    ...
    public _ResponseApiLatestLabels nextPageStart(Integer nextPageStart) {
    ...
    public _ResponseApiLatestLabels size(BigDecimal size) {
        this.size = size;
        return this;
    }
    ...
    public _ResponseApiLatestLabels start(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public _ResponseApiLatestLabels values(List<RestLabel> values) {
        this.values = values;
        return this;
    }

    public _ResponseApiLatestLabels addValuesItem(RestLabel valuesItem) {
        if (this.values == null) {
     ...
     * @return values
     **/
    public @Valid List<RestLabel> getValues() {
        return values;
    }

    public void setValues(List<RestLabel> values) {
        this.values = values;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _ResponseApiLatestLabels)) {
            return false;
        }
        _ResponseApiLatestLabels other = (_ResponseApiLatestLabels) o;
    ...
    public String toString() {
        ...
        sb.append("class _ResponseApiLatestLabels {");
